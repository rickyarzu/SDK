unit unitTestDatasnapHttp;

interface

uses
  IdHTTPWebBrokerBridge, DUnitX.TestFramework;
...
uses System.SysUtils, System.IOUtils, System.Classes, Web.HTTPApp, Datasnap.DSSession, Janua.Cloud.Http.Impl,
  Janua.Cloud.Http.Intf;
...
begin
  ...
  Assert.IsTrue(FileExists(vFileNamePath), 'file non creato: ' + vFileNamePath);
  Assert.AreNotEqual('', aCloudDownloader.ResponseString, 'response is nil');
end;
