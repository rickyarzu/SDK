inherited dmTestHealthBooking: TdmTestHealthBooking
  Height = 677
  Width = 965
  ...
  inherited cdsTowns: TClientDataSet
    Left = 64
    Top = 496
  end
  inherited dspTowns: TDataSetProvider
    Left = 64
    Top = 440
  end
  ...
  object JanuaApplicationProfile1: TJanuaApplicationProfile
    ...
    TestMode = True
    JanuaOS = JanuaVCLOS1
    ApplicationFramework = jafServerWebBroker
    ServerUrl = 'www.dico33.com:8081'
    AppName = 'Dico33'
    Protocol = jptHttp
    ProtocolAsets = jtpHttps
    AssetsUrl = 'app.ergomercator.com'
    Left = 472
    Top = 29
  end
  object JanuaPostgresTemplateRepository1: TJanuaPostgresTemplateRepository
    LogToFile = False
    JanuaLogger = JanuaCoreLogger1
    ApplicationType = jatDefault
    Language = jlaNone
  ...
  object JanuaHealthPgWebSession1: TJanuaHealthPgWebSession
    LogToFile = False
    JanuaLogger = JanuaCoreLogger1
    ApplicationType = jatDefault
    Language = jlaNone
    ...
    JanuaSystem = JanuaPostgresSystem
    AppUrl = 'Dico33.com'
    JanuaApplicationProfile = JanuaApplicationProfile1
    Persistent = False
    Left = 312
    Top = 136
  end
  ...
  object dsInstitutes: TUniDataSource
    Left = 168
    Top = 96
  end
  object JanuaFiscalCode1: TJanuaFiscalCode
    ...
    TestMode = False
    JanuaOS = JanuaVCLOS1
    VatCode = 'RDNRCR70P05I480I'
    isoCountry = jicItalia
    isOK = False
    Error = 'Attenzione Codice fiscale formalmente errato'
    FiscalCodeName = 'Riccardo'
    FiscalCodeSurname = 'Arduino'
    BirthDate = 25816.000000000000000000
    TownName = 'Savona'
    TownCode = 'I480'
    FiscalCode = 'RDNRCR70P05I480O'
    Left = 472
    Top = 352
  end
  object JanuaVCLOS1: TJanuaVCLOS
    Directory = 'c:\januaproject\www'
    AppName = 'Dico33'
    HasErrors = False
    CustomServer = True
    ResolveToFile = False
  ...
  object dsPrescription: TUniDataSource
    Left = 168
    Top = 288
  end
  object dsPerson: TUniDataSource
    Left = 168
    Top = 352
  end
  object dsBookingInstitutes: TUniDataSource
    Left = 168
    Top = 416
  end
