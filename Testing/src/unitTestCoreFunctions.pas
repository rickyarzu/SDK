...
{$ENDIF}
    ...
    [Test]
    [TestCase('True1', 'true,riccardoarduino@me.com')]
    [TestCase('True2', 'true,riccardo.arduino@me.com')]
    [TestCase('True3', 'true,riccardo.arduino@cloud.milano.com')]
    [TestCase('True4', 'true,riccardo.arduino@cloud-milano.com')]
    [TestCase('True5', 'true,riccardo-arduino@cloud-milano.com')]
    [TestCase('True6', 'true,riccardo_arduino@ciao-cloud-milano.com')]
    [TestCase('False1', 'False,riccardoarduino_me.com')]
    [TestCase('False2', 'False,riccardo.arduino@mecom')]
    [TestCase('False3', 'False,riccardo;arduino@cloud.milano.com')]
    [TestCase('False4', 'False,riccardo arduino@cloud-milano.com')]
    [TestCase('True7', 'True,riccardo*arduino@cloud-milano.com')]
    [TestCase('True8', 'True,riccardoàrduino@ciao-cloud-milano.com')]
    {[TestCase('True8', 'True,медведь@с-балалайкой.рф')]}
    procedure ValidEmail(const expected: boolean; const aValue: string);
  end;
...
procedure TFunctionsTest.ValidEmail(const expected: boolean; const aValue: string);
begin
  Assert.AreEqual(expected, IsValidEmail(aValue), aValue);
end;
