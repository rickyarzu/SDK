unit uframeVclTestOrmDatasetSync;

interface

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, vcl.wwbutton, vcl.wwdbigrd, vcl.wwdbgrid,
  System.Classes, vcl.Graphics, vcl.Controls, vcl.Forms, vcl.Dialogs, vcl.Samples.Spin, MoneyEdit, vcl.StdCtrls,
  Data.DB, vcl.Grids, vcl.DBGrids, Janua.vcl.EnhDBGrid, vcl.ToolWin, vcl.ComCtrls, System.ImageList, vcl.ImgList,
  SVGIconImageListBase, SVGIconImageList, System.Actions, vcl.ActnList, vcl.ExtCtrls, vcl.DBCtrls, JvExStdCtrls, JvEdit,
  JvValidateEdit,
  // Januaproject
  ...
  uframeTestRecordSetOrmSyncNavigator, Janua.vcl.MVVM.frameNavigator, Vcl.Mask, Janua.Core.Commons,
  Vcl.Buttons;
...
begin
  ...
  try
    ...
    if not Supports(FTestViewModel, IJanuaDBViewModel, lViewModel) then
      raise Exception.Create('TfrmVCLTestViewModel.FormCreate FDocumentsViewModel no support IJanuaDBViewModel');
  ...
  try
    ...
    begin
      ...
      begin
        ...
        (* grdDetail2.DataSource := FTestViewModel.DetailViewModel2; *)
      end;
