object dmTestPgFrameworks: TdmTestPgFrameworks
  ...
  object JanuaServerPgAds1: TJanuaServerPgAds
    Verbose = False
    LogToFile = False
    JanuaLogger = JanuaDBLogger1
    Language = jlaItalian
  ...
  object JanuaServerPgUniversity1: TJanuaServerPgUniversity
    Verbose = False
    LogToFile = False
    JanuaLogger = JanuaDBLogger1
    Language = jlaItalian
    ...
    CountryID = 0
    JanuaServerSystem = JanuaPostgresSystem
    JanuaServerJPublic = JanuaServerJPublic
    JanuaSystem = JanuaPostgresSystem
    Left = 328
    Top = 384
  end
  object JanuaPgServerSwap1: TJanuaPgServerSwap
    Verbose = False
    LogToFile = False
    JanuaLogger = JanuaDBLogger1
    Language = jlaItalian
  ...
  object JanuaServerSocial1: TJanuaServerSocial
    Verbose = False
    LogToFile = False
    JanuaLogger = JanuaDBLogger1
    Language = jlaItalian
  ...
  object JanuaServerPgUniBooks1: TJanuaServerPgUniBooks
    Verbose = False
    LogToFile = False
    JanuaLogger = JanuaDBLogger1
    Language = jlaItalian
  ...
  object JanuaPgServerForms1: TJanuaPgServerForms
    Verbose = False
    LogToFile = False
    JanuaLogger = JanuaDBLogger1
    Language = jlaItalian
  ...
  object dsBDLogs: TUniDataSource
    DataSet = vrtDBLogs
    Left = 592
    Top = 312
  end
