...
// (DO NOT EDIT: machine generated header) 'vcl.wwprprx.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TCustomForm.CreateScaledNew */ inline __fastcall virtual TwwEditRegexForm(System::Classes::TComponent* AOwner, int ADPI, int Dummy) : Vcl::Forms::TForm(AOwner, ADPI, Dummy) { }
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TwwEditRegexForm() { }
