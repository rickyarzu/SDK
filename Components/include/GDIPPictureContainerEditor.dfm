object GDIPPictureContainerEditor: TGDIPPictureContainerEditor
  ...
  object PopupMenu1: TPopupMenu
    ...
    Left = 432
    Top = 304
    object Savetofle1: TMenuItem
      Caption = 'Save to file'
      OnClick = Savetofle1Click
    end
  end
  object SaveDialog1: TSaveDialog
    Filter = 
      'All (*.svg;*.svg;*.gif;*.png;*.jpg;*.jpeg;*.bmp;*.jpg;*.jpeg;*.g' +
      'if;*.png;*.ico;*.emf;*.wmf;*.tif;*.tiff)|*.svg;*.svg;*.gif;*.png' +
      ';*.jpg;*.jpeg;*.bmp;*.jpg;*.jpeg;*.gif;*.png;*.ico;*.emf;*.wmf;*' +
      '.tif;*.tiff|Scalable Vector Graphics (FNC) (*.svg)|*.svg|Scalabl' +
      'e Vector Graphics (VCL) (*.svg)|*.svg|GIF Image (*.gif)|*.gif|Po' +
      'rtable Network Graphics (*.png)|*.png|JPEG Image File (*.jpg)|*.' +
      'jpg|JPEG Image File (*.jpeg)|*.jpeg|Bitmaps (*.bmp)|*.bmp|JPEG I' +
      'mages (*.jpg)|*.jpg|JPEG Images (*.jpeg)|*.jpeg|GIF Images (*.gi' +
      'f)|*.gif|PNG Images (*.png)|*.png|Icons (*.ico)|*.ico|Enhanced M' +
      'etafiles (*.emf)|*.emf|Metafiles (*.wmf)|*.wmf|TIFF Images (*.ti' +
