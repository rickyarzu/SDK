...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCPDFLib.General.Default.pas' rev: 35.00 (Android)

#ifndef Fmx_Tmsfncpdflib_General_DefaultHPP
#define Fmx_Tmsfncpdflib_General_DefaultHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCPDFLIB_GENERAL_DEFAULT)
using namespace Fmx::Tmsfncpdflib::General::Default;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_Tmsfncpdflib_General_DefaultHPP
