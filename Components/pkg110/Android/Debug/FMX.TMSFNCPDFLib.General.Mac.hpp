...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCPDFLib.General.Mac.pas' rev: 35.00 (Android)

#ifndef Fmx_Tmsfncpdflib_General_MacHPP
#define Fmx_Tmsfncpdflib_General_MacHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCPDFLIB_GENERAL_MAC)
using namespace Fmx::Tmsfncpdflib::General::Mac;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_Tmsfncpdflib_General_MacHPP
