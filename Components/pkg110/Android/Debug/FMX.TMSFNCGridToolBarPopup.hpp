...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCGridToolBarPopup.pas' rev: 35.00 (Android)

#ifndef Fmx_TmsfncgridtoolbarpopupHPP
#define Fmx_TmsfncgridtoolbarpopupHPP
...
namespace Fmx
{
namespace Tmsfncgridtoolbarpopup
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TTMSFNCGridToolBarPopup;
//-- type declarations -------------------------------------------------------
#pragma pack(push,4)
class PASCALIMPLEMENTATION TTMSFNCGridToolBarPopup : public Fmx::Tmsfnccustomgrid::TTMSFNCGridCustomToolBarPopup
{
	typedef Fmx::Tmsfnccustomgrid::TTMSFNCGridCustomToolBarPopup inherited;
...
public:
	__fastcall virtual TTMSFNCGridToolBarPopup(System::Classes::TComponent* AOwner);
...
__published:
	__property Grid;
public:
	/* TTMSFNCCustomToolBarPopup.Destroy */ inline __fastcall virtual ~TTMSFNCGridToolBarPopup() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCGRIDTOOLBARPOPUP)
using namespace Fmx::Tmsfncgridtoolbarpopup;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_TmsfncgridtoolbarpopupHPP
