...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCImage.pas' rev: 35.00 (Android)

#ifndef Fmx_TmsfncimageHPP
#define Fmx_TmsfncimageHPP
...
namespace Fmx
{
namespace Tmsfncimage
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TTMSFNCCustomImage;
class DELPHICLASS TTMSFNCImage;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TTMSFNCCustomImage : public Fmx::Tmsfnccustomcontrol::TTMSFNCCustomControl
{
...
protected:
	...
	void __fastcall BitmapMarginsChanged(System::TObject* Sender);
...
public:
	...
	__fastcall virtual TTMSFNCCustomImage(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TTMSFNCCustomImage();
...
class PASCALIMPLEMENTATION TTMSFNCImage : public TTMSFNCCustomImage
{
	typedef TTMSFNCCustomImage inherited;
...
__published:
	...
	__property Stroke;
public:
	/* TTMSFNCCustomImage.Create */ inline __fastcall virtual TTMSFNCImage(System::Classes::TComponent* AOwner) : TTMSFNCCustomImage(AOwner) { }
	/* TTMSFNCCustomImage.Destroy */ inline __fastcall virtual ~TTMSFNCImage() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCIMAGE)
using namespace Fmx::Tmsfncimage;
#endif
