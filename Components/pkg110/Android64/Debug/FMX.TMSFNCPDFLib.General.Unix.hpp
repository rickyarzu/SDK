...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCPDFLib.General.Unix.pas' rev: 35.00 (Android)

#ifndef Fmx_Tmsfncpdflib_General_UnixHPP
#define Fmx_Tmsfncpdflib_General_UnixHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCPDFLIB_GENERAL_UNIX)
using namespace Fmx::Tmsfncpdflib::General::Unix;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// Fmx_Tmsfncpdflib_General_UnixHPP
