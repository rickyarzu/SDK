...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCHere.pas' rev: 35.00 (Android)

#ifndef Fmx_TmsfnchereHPP
#define Fmx_TmsfnchereHPP
...
namespace Fmx
{
namespace Tmsfnchere
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TTMSFNCHerePolygon;
class DELPHICLASS TTMSFNCHerePolygons;
class DELPHICLASS TTMSFNCCustomHere;
class DELPHICLASS TTMSFNCHere;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TTMSFNCHerePolygon : public Fmx::Tmsfncmaps::TTMSFNCMapsPolygon
{
	typedef Fmx::Tmsfncmaps::TTMSFNCMapsPolygon inherited;
	
public:
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	__fastcall virtual TTMSFNCHerePolygon(System::Classes::TCollection* Collection);
	__fastcall virtual ~TTMSFNCHerePolygon();
...
class PASCALIMPLEMENTATION TTMSFNCHerePolygons : public Fmx::Tmsfncmaps::TTMSFNCMapsPolygons
{
	typedef Fmx::Tmsfncmaps::TTMSFNCMapsPolygons inherited;
	
public:
	TTMSFNCHerePolygon* operator[](int Index) { return this->Items[Index]; }
	
private:
	HIDESBASE TTMSFNCHerePolygon* __fastcall GetItem(int Index);
	HIDESBASE void __fastcall SetItem(int Index, TTMSFNCHerePolygon* const Value);
	
protected:
	virtual System::Classes::TCollectionItemClass __fastcall CreateItemClass();
	
public:
	__property TTMSFNCHerePolygon* Items[int Index] = {read=GetItem, write=SetItem/*, default*/};
	HIDESBASE TTMSFNCHerePolygon* __fastcall Add();
	HIDESBASE TTMSFNCHerePolygon* __fastcall Insert(int Index);
public:
	/* TTMSFNCMapsPolyElements.Create */ inline __fastcall virtual TTMSFNCHerePolygons(Fmx::Tmsfncmaps::TTMSFNCCustomMaps* AOwner) : Fmx::Tmsfncmaps::TTMSFNCMapsPolygons(AOwner) { }
	
public:
	/* TCollection.Destroy */ inline __fastcall virtual ~TTMSFNCHerePolygons() { }
	
};


class PASCALIMPLEMENTATION TTMSFNCCustomHere : public Fmx::Tmsfncmaps::TTMSFNCCustomMaps
{
	typedef Fmx::Tmsfncmaps::TTMSFNCCustomMaps inherited;
	
private:
	TTMSFNCHerePolygons* __fastcall GetPolygons();
	HIDESBASE void __fastcall SetPolygons(TTMSFNCHerePolygons* const Value);
	
protected:
	virtual System::UnicodeString __fastcall GetDocURL();
	virtual Fmx::Tmsfncmaps::TTMSFNCMapsPolygonsClass __fastcall GetPolygonsClass();
	virtual int __fastcall GetVersionNr();
	__property TTMSFNCHerePolygons* Polygons = {read=GetPolygons, write=SetPolygons};
	
public:
	__fastcall virtual TTMSFNCCustomHere(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TTMSFNCCustomHere();
	HIDESBASE virtual TTMSFNCHerePolygon* __fastcall AddPolygon(Fmx::Tmsfncmapscommontypes::TTMSFNCMapsCoordinateRecArray ACoordinates, bool AClose = false);
};


class PASCALIMPLEMENTATION TTMSFNCHere : public TTMSFNCCustomHere
{
	typedef TTMSFNCCustomHere inherited;
...
public:
	/* TTMSFNCCustomHere.Create */ inline __fastcall virtual TTMSFNCHere(System::Classes::TComponent* AOwner) : TTMSFNCCustomHere(AOwner) { }
	/* TTMSFNCCustomHere.Destroy */ inline __fastcall virtual ~TTMSFNCHere() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCHERE)
using namespace Fmx::Tmsfnchere;
#endif
