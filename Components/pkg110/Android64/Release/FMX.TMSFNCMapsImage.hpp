...
// (DO NOT EDIT: machine generated header) 'FMX.TMSFNCMapsImage.pas' rev: 35.00 (Android)

#ifndef Fmx_TmsfncmapsimageHPP
#define Fmx_TmsfncmapsimageHPP
...
namespace Fmx
{
namespace Tmsfncmapsimage
{
//-- forward type declarations -----------------------------------------------
class DELPHICLASS TTMSFNCCustomMapsImage;
class DELPHICLASS TTMSFNCMapsImage;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TTMSFNCCustomMapsImage : public Fmx::Tmsfnccustomcontrol::TTMSFNCCustomControl
{
...
public:
	...
	__fastcall virtual TTMSFNCCustomMapsImage(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TTMSFNCCustomMapsImage();
...
class PASCALIMPLEMENTATION TTMSFNCMapsImage : public TTMSFNCCustomMapsImage
{
	typedef TTMSFNCCustomMapsImage inherited;
...
public:
	/* TTMSFNCCustomMapsImage.Create */ inline __fastcall virtual TTMSFNCMapsImage(System::Classes::TComponent* AOwner) : TTMSFNCCustomMapsImage(AOwner) { }
	/* TTMSFNCCustomMapsImage.Destroy */ inline __fastcall virtual ~TTMSFNCMapsImage() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_TMSFNCMAPSIMAGE)
using namespace Fmx::Tmsfncmapsimage;
#endif
