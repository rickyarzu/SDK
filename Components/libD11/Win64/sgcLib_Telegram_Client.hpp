...
public:
	...
	void __fastcall SendVideoMessage(const System::UnicodeString aChatId, const System::UnicodeString aFilePath, int aWidth = 0x0, int aHeight = 0x0, __int64 aDuration = (__int64)(0LL), TsgcTelegramReplyMarkupInlineKeyboard* const aInlineKeyboard = (TsgcTelegramReplyMarkupInlineKeyboard*)(0x0), TsgcTelegramReplyMarkupShowKeyboard* const aShowKeyboard = (TsgcTelegramReplyMarkupShowKeyboard*)(0x0));
