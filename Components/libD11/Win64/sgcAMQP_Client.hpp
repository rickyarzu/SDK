...
private:
	void __fastcall DoWriteContentHeader(Sgcamqp_classes::TsgcAMQPChannelThreadItem* const aChannel, Sgcamqp_classes::TsgcAMQPClass aClassId, Sgcamqp_classes::TsgcAMQPBasicProperties* const aHeader, System::Classes::TStream* const aBody, System::TArray__1<System::Byte> &aBytes);
	void __fastcall DoWriteContentBody(Sgcamqp_classes::TsgcAMQPChannelThreadItem* const aChannel, System::Classes::TStream* const aData, System::TArray__1<System::Byte> &aBytes);
