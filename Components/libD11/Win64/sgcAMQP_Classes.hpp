...
public:
	...
	void __fastcall Read(const System::TArray__1<System::Byte> aBytes, int aOffset = 0x0);
...
public:
	...
	void __fastcall Read(const System::TArray__1<System::Byte> aBytes, int aOffset);
...
public:
	void __fastcall Clear();
	void __fastcall Read(const System::TArray__1<System::Byte> aBytes, int aSize, int aOffset = 0x0);
...
protected:
	...
	System::TArray__1<System::Byte> __fastcall DoWrite();
...
protected:
	virtual void __fastcall DoValidateFrame(const System::TArray__1<System::Byte> aBytes, int aOffset);
	
public:
	void __fastcall Clear();
	int __fastcall Read(const System::TArray__1<System::Byte> aBytes, int aOffset = 0x0);
