...
typedef void __fastcall (__closure *TsgcUDPRetransmissionTimeoutEvent)(System::TObject* Sender, const System::TArray__1<System::Byte> aBytes, const System::UnicodeString aIPAddress, System::Word aPort);
