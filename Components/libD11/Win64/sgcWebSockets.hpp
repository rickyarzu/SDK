...
#include <IdHMACSHA1.hpp>	// (IndyProtocols)
...
#include <IdSync.hpp>	// (IndyCore)
#include <IdLogBase.hpp>	// (IndyCore)
#include <IdLogFile.hpp>	// (IndyCore)
#include <System.Win.Crtl.hpp>	// (rtl)
#include <IdZLibHeaders.hpp>	// (IndyProtocols)
#include <IdZLibConst.hpp>	// (IndyProtocols)
#include <IdZLib.hpp>	// (IndyProtocols)
#include <IdServerInterceptLogBase.hpp>	// (IndyProtocols)
#include <IdServerInterceptLogFile.hpp>	// (IndyProtocols)
...
#include <IdConnectThroughHttpProxy.hpp>	// (IndyProtocols)
#include <IdInterceptThrottler.hpp>	// (IndyCore)
#include <IdHTTPServer.hpp>	// (IndyProtocols)
#include <IdSchedulerOfThreadPool.hpp>	// (IndyCore)
...
#include <IdUDPBase.hpp>	// (IndyCore)
#include <IdUDPServer.hpp>	// (IndyCore)
#include <IdUDPClient.hpp>	// (IndyCore)
// SO_SFX: 280
// PRG_EXT: .bpl
// BPI_DIR: ..\dcp\Win64
// OBJ_DIR: ..\libD11\Win64
// OBJ_EXT: .o
