...
public:
	...
	virtual System::TArray__1<System::Byte> __fastcall DoConnect(bool aAuthentication, System::UnicodeString aAuthUser, System::UnicodeString aAuthPass, bool aWillFlag, System::UnicodeString aWillTopic, System::UnicodeString aWillText, Sgcwebsocket_types::TmqttQoS aWillQoS, bool aWillRetain, bool aKeepAliveEnabled, int aKeepAliveInterval);
	virtual System::TArray__1<System::Byte> __fastcall DoPing();
	virtual System::TArray__1<System::Byte> __fastcall DoPublish(System::Word aPacketIdentifier, const System::UnicodeString aTopic, const System::UnicodeString aText, Sgcwebsocket_types::TmqttQoS aQoS, bool aRetain, bool aDuplicate)/* overload */;
	virtual System::TArray__1<System::Byte> __fastcall DoPublish(System::Word aPacketIdentifier, const System::UnicodeString aTopic, System::Classes::TStream* aStream, Sgcwebsocket_types::TmqttQoS aQoS, bool aRetain, bool aDuplicate)/* overload */;
	virtual System::TArray__1<System::Byte> __fastcall DoSubscribe(System::Word aPacketIdentifier, TsgcWSTopics* aTopics);
	virtual System::TArray__1<System::Byte> __fastcall DoUnSubscribe(System::Word aPacketIdentifier, TsgcWSTopics* aTopics);
	virtual System::TArray__1<System::Byte> __fastcall DoPubAck(System::Word aPacketIdentifier);
	virtual System::TArray__1<System::Byte> __fastcall DoPubRec(System::Word aPacketIdentifier);
	virtual System::TArray__1<System::Byte> __fastcall DoPubRel(System::Word aPacketIdentifier);
	virtual System::TArray__1<System::Byte> __fastcall DoPubComp(System::Word aPacketIdentifier);
	virtual System::TArray__1<System::Byte> __fastcall DoDisconnect(int aReasonCode = 0x0);
	virtual System::TArray__1<System::Byte> __fastcall DoAuth(bool aReAuthenticate);
