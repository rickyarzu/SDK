...
uses
  ...
  clMailMessage, clTcpCommandClient, clOAuth, DemoBaseFormUnit, ExtCtrls, clSocketUtils, System.ImageList;
...
begin
  ...
  try
    ...
    clOAuth1.ClientID := '1068090865511-669mojvl3f4ioiih405tlkf8jiv74rrv.apps.googleusercontent.com';
    clOAuth1.ClientSecret := 'sQD7xTwYQwkzxtMyF1I0TPjZ';
