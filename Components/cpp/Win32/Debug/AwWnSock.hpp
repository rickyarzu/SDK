...
// (DO NOT EDIT: machine generated header) 'AwWnsock.pas' rev: 35.00 (Windows)
...
{
public:
	NativeInt ServerSocket;
	NativeInt ClientSocket;
};
...
public:
	...
	__property NativeInt CommSocket = {read=FCommSocket, nodefault};
	...
	__property NativeInt SocketHandle = {read=FSocketHandle, nodefault};
public:
...
protected:
	int __fastcall DoDispMessage(NativeInt Socket, unsigned Event, int LP);
	int __fastcall DoWsMessage(NativeInt Socket, unsigned Event, int LP);
	...
	NativeInt __fastcall TweakSocket(NativeInt Socket);
...
public:
	...
	TWsConnection* __fastcall FindConnection(NativeInt Socket);
