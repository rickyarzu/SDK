...
// (DO NOT EDIT: machine generated header) 'AdFtp.pas' rev: 35.00 (Windows)
...
protected:
	...
	void __fastcall WsDataAccept(System::TObject* Sender, NativeInt Socket);
	void __fastcall WsDataDisconnect(System::TObject* Sender, NativeInt Socket);
	void __fastcall WsDataError(System::TObject* Sender, NativeInt Socket, int ErrorCode);
	void __fastcall WsDataRead(System::TObject* Sender, NativeInt Socket);
	void __fastcall WsDataWrite(System::TObject* Sender, NativeInt Socket);
