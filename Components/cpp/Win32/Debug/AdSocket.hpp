...
// (DO NOT EDIT: machine generated header) 'AdSocket.pas' rev: 35.00 (Windows)
...
typedef void __fastcall (__closure *TWsNotifyEvent)(System::TObject* Sender, NativeInt Socket);

typedef void __fastcall (__closure *TWsSocketErrorEvent)(System::TObject* Sender, NativeInt Socket, int ErrCode);
...
protected:
	...
	virtual void __fastcall DoAccept(NativeInt Socket);
	virtual void __fastcall DoConnect(NativeInt Socket);
	virtual void __fastcall DoDisconnect(NativeInt Socket);
	virtual void __fastcall DoError(NativeInt Socket, int ErrCode);
	virtual void __fastcall DoRead(NativeInt Socket);
	virtual void __fastcall DoWrite(NativeInt Socket);
...
public:
	...
	NativeInt __fastcall AcceptSocket(NativeInt Socket, Adwutil::TSockAddrIn &Address);
	int __fastcall BindSocket(NativeInt Socket, const Adwutil::TSockAddrIn &Address);
	bool __fastcall CanReadSocket(NativeInt Socket, int WaitTime);
	bool __fastcall CanWriteSocket(NativeInt Socket, int WaitTime);
	int __fastcall CloseSocket(NativeInt Socket);
	int __fastcall ConnectSocket(NativeInt Socket, const Adwutil::TSockAddrIn &Address);
	NativeInt __fastcall CreateSocket();
	int __fastcall ListenSocket(NativeInt Socket, int Backlog);
	int __fastcall ReadSocket(NativeInt Socket, void *Buf, int BufSize, int Flags);
	int __fastcall ShutdownSocket(NativeInt Socket, int How);
	int __fastcall SetSocketOptions(NativeInt Socket, unsigned Level, int OptName, void *OptVal, int OptLen);
	int __fastcall SetAsyncStyles(NativeInt Socket, int lEvent);
	int __fastcall WriteSocket(NativeInt Socket, void *Buf, int BufSize, int Flags);
