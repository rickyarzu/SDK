...
// (DO NOT EDIT: machine generated header) 'AdProtcl.pas' rev: 35.00 (Windows)
...
protected:
	...
	int __fastcall GetEofTimerRemaining();
	Awtpcl::TAsciiState __fastcall GetProtocolState();
...
public:
	...
	__property int EofTimerRemaining = {read=GetEofTimerRemaining, nodefault};
	__property Awtpcl::TAsciiState ProtocolState = {read=GetProtocolState, nodefault};
