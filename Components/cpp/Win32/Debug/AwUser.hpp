...
// (DO NOT EDIT: machine generated header) 'AwUser.pas' rev: 35.00 (Windows)
...
protected:
	...
	int __fastcall WriteComSafe(char * ABuf, int ASize);
...
extern DELPHI_PACKAGE void __fastcall (*GShowExceptionHandler)(System::TObject* ExceptObject, void * ExceptAddr);
