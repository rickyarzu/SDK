...
// (DO NOT EDIT: machine generated header) 'AdWUtil.pas' rev: 35.00 (Windows)
...
public:
	int fd_count;
	System::StaticArray<NativeInt, 64> fd_array;
};
#pragma pack(pop)
...
typedef NativeInt __stdcall (*TfnAccept)(NativeInt S, TSockAddrIn &Addr, int &Addrlen);

typedef int __stdcall (*TfnBind)(NativeInt S, TSockAddrIn &Addr, int NameLen);

typedef int __stdcall (*TfnCloseSocket)(NativeInt S);

typedef int __stdcall (*TfnConnect)(NativeInt S, TSockAddrIn &Name, int NameLen);

typedef int __stdcall (*TfnIOCtlSocket)(NativeInt S, int Cmd, int &Arg);

typedef int __stdcall (*TfnGetPeerName)(NativeInt S, TSockAddrIn &Name, int &NameLen);

typedef int __stdcall (*TfnGetSockName)(NativeInt S, TSockAddrIn &Name, int &NameLen);

typedef int __stdcall (*TfnGetSockOpt)(NativeInt S, int Level, int OptName, void *OptVal, int &OptLen);
...
typedef int __stdcall (*TfnListen)(NativeInt S, int Backlog);

typedef int __stdcall (*Tfnntohl)(int NetLong);

typedef System::Word __stdcall (*Tfnntohs)(System::Word NetShort);

typedef int __stdcall (*TfnRecv)(NativeInt S, void *Buf, int Len, int Flags);

typedef int __stdcall (*TfnRecvFrom)(NativeInt S, void *Buf, int Len, int Flags, TSockAddrIn &From, int &FromLen);

typedef int __stdcall (*TfnSelect)(int Nfds, PFDSet Readfds, PFDSet Writefds, PFDSet Exceptfds, PTimeVal Timeout);

typedef int __stdcall (*TfnSend)(NativeInt S, void *Buf, int Len, int Flags);

typedef int __stdcall (*TfnSendTo)(NativeInt S, void *Buf, int Len, int Flags, TSockAddrIn &AddrTo, int ToLen);

typedef int __stdcall (*TfnSetSockOpt)(NativeInt S, int Level, int OptName, void *OptVal, int OptLen);

typedef int __stdcall (*TfnShutdown)(NativeInt S, int How);

typedef NativeInt __stdcall (*TfnSocket)(int Af, int Struct, int Protocol);
...
typedef int __stdcall (*TfnwsaAsyncSelect)(NativeInt S, HWND HWindow, int wMsg, int lEvent);

typedef int __stdcall (*TfnwsaRecvEx)(NativeInt S, void *Buf, int Len, int &Flags);

typedef System::LongBool __stdcall (*TfnTransmitFile)(NativeInt hSocket, NativeUInt hFile, unsigned nNumberOfBytesToWrite, unsigned nNumberOfBytesPerSend, Winapi::Windows::POverlapped lpOverlapped, PTransmitFileBuffers lpTransmitBuffers, unsigned dwReserved);
...
static const NativeInt Invalid_Socket = NativeInt(-1);
