...
type
  ...
  { File formats }
  TTwainFormat = (tfTIFF, tfPict, tfBMP, tfXBM, tfJPEG, tfFPX, tfTIFFMulti, tfPNG, tfSPIFF, tfEXIF,
    tfUnknown);
  { Twain units }
  TTwainUnit = (tuInches, tuCentimeters, tuPicas, tuPoints, tuTwips, tuPixels, tuUnknown);
  ...
  { Twain pixel type }
  TTwainPixelType = (tbdBw, tbdGray, tbdRgb, tbdPalette, tbdCmy, tbdCmyk, tbdYuv, tbdYuvk, tbdCieXYZ,
    tbdUnknown, tbdUnknown1, tbdUnknown2, tbdBgr);
  ...
  TOnSourceFileTransfer = procedure(Sender: TObject; const Index: Integer; Filename: TW_STR255;
    Format: TTwainFormat; var Cancel: Boolean) of object;

  { Available twain languages }
  TTwainLanguage = ( { -1 } tlUserLocale = -1, tlDanish, tlDutch, tlInternationalEnglish, tlFrenchCanadian,
    tlFinnish, tlFrench, tlGerman, tlIcelandic, tlItalian, tlNorwegian, tlPortuguese, tlSpanish, tlSwedish,
    tlUsEnglish, tlAfrikaans, tlAlbania, tlArabic, tlArabicAlgeria, tlArabicBahrain, { 18 }
    tlArabicEgypt, tlArabicIraq, tlArabJordan, tlArabicKuwait, tlArabicLebanon, tlArabicLibya,
    tlArabicMorocco, tlArabicOman, tlArabicQatar, tlArabicSaudiarabia, tlArabicSyria, tlArabicTunisia,
    tlArabicUae, tlArabicYemen, tlBasque, tlByelorussian, tlBulgarian, { 35 }
    tlCatalan, tlChinese, tlChineseHongkong, tlChinesePeoplesRepublic, tlChineseSingapore,
    tlChineseSimplified, tlChineseTwain, { 42 }
    tlChineseTraditional, tlCroatia, tlCzech, tlDutchBelgian, { 46 }
    tlEnglishAustralian, tlEnglishCanadian, tlEnglishIreland, tlEnglishNewZealand, tlEnglishSouthAfrica,
    tlEnglishUk, { 52 }
    tlEstonian, tlFaeroese, tlFarsi, tlFrenchBelgian, tlFrenchLuxembourg, { 57 }
    tlFrenchSwiss, tlGermanAustrian, tlGermanLuxembourg, tlGermanLiechtenstein, tlGermanSwiss, tlGreek,
    tlHebrew, tlHungarian, tlIndonesian, { 66 }
    ...
    tlPortugueseBrazil, tlRomanian, tlRussian, tlSerbianLatin, tlSlovak, tlSlovenian, tlSpanishMexican,
    tlSpanishModern, tlThai, tlTurkish, tlUkranian, tlAssamese, tlBengali, tlBihari, tlBodo, tlDogri,
    tlGujarati { 92 } , tlHarayanvi, tlHindi, tlKannada, tlKashmiri, tlMalayalam, tlMarathi, tlMarwari,
    tlMeghalayan, tlMizo, tlNaga { 102 } , tlOrissi, tlPunjabi, tlPushtu, tlSerbianCyrillic, tlSikkimi,
  ...
  TCapabilityRet = (crSuccess, crUnsupported, crBadOperation, crDependencyError, crLowMemory, crInvalidState,
    crInvalidContainer);
  ...
  private
    ...
    function GetResolution(Capability: TW_UINT16; var Return: Extended; var Values: TTwainResolution;
  ...
  protected
    ...
    function PrepareMemXfer(var BitmapHandle: HBitmap; var PixelType: TW_INT16): TW_UINT16;
...
{%H-}PixelType: TW_INT16): TW_UINT16;
  ...
  protected
    ...
    { Sets a capability }
    function SetCapabilityRec(const Capability, ConType: TW_UINT16; Data: HGLOBAL): TCapabilityRet;
  public
    { Message received in the event loop }
    function ProcessMessage(const Msg: TMsg): Boolean;
    { Returns a capability strucutre }
    function GetCapabilityRec(const Capability: TW_UINT16; var Handle: HGLOBAL; Mode: TRetrieveCap;
      var Container: TW_UINT16): TCapabilityRet;
    { ************************ }
    { Returns an one value capability }
    function GetOneValue(Capability: TW_UINT16; var ItemType: TW_UINT16; var Value: string;
    ...
    function GetRangeValue(Capability: TW_UINT16; var ItemType: TW_UINT16;
      var Min, Max, Step, Default, Current: String; MemHandle: HGLOBAL{$IFDEF DEFAULTPARAM} = 0{$ENDIF})
      : TCapabilityRet;
    { Returns an enumeration capability }
    function GetEnumerationValue(Capability: TW_UINT16; var ItemType: TW_UINT16; var List: TGetCapabilityList;
      var Current, Default: Integer; Mode: TRetrieveCap{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF};
      MemHandle: HGLOBAL{$IFDEF DEFAULTPARAM} = 0{$ENDIF}): TCapabilityRet;
    { Returns an array capability }
    function GetArrayValue(Capability: TW_UINT16; var ItemType: TW_UINT16; var List: TGetCapabilityList;
      MemHandle: HGLOBAL
{$IFDEF DEFAULTPARAM} = 0{$ENDIF}): TCapabilityRet;
    { ************************ }
    { Sets an one value capability }
    function SetOneValue(Capability: TW_UINT16; ItemType: TW_UINT16; Value: pointer): TCapabilityRet;
    { Sets a range capability }
    function SetRangeValue(Capability, ItemType: TW_UINT16; Min, Max, Step, Current: TW_UINT32)
      : TCapabilityRet;
    { Sets an enumeration capability }
    function SetEnumerationValue(Capability, ItemType: TW_UINT16; CurrentIndex: TW_UINT32;
      List: TSetCapabilityList): TCapabilityRet;
    { Sets an array capability }
    function SetArrayValue(Capability, ItemType: TW_UINT16; List: TSetCapabilityList): TCapabilityRet;
  public
    { Setup file transfer }
  ...
  public
    ...
    function GetCapXferCount(var Return: SmallInt; Mode: TRetrieveCap{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF})
      : TCapabilityRet;
    { Retrieve the unit measure for all quantities }
    function GetICapUnits(var Return: TTwainUnit; var Supported: TTwainUnitSet; Mode: TRetrieveCap
{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
    ...
    function GetIPixelFlavor(var Return: TTwainPixelFlavor; var Supported: TTwainPixelFlavorSet;
      Mode: TRetrieveCap
{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
    ...
    function GetIBitDepth(var Return: Word; var Supported: TTwainBitDepth; Mode: TRetrieveCap
{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
    { Set current bitdepth value }
    function SetIBitDepth(Value: Word): TCapabilityRet;
    { Returns pixel type values }
    function GetIPixelType(var Return: TTwainPixelType; var Supported: TTwainPixelTypeSet; Mode: TRetrieveCap
{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
    { Set the pixel type value }
    function SetIPixelType(Value: TTwainPixelType): TCapabilityRet;
    { Returns X and Y resolutions }
    function GetIXResolution(var Return: Extended; var Values: TTwainResolution; Mode: TRetrieveCap
      {$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
    function GetIYResolution(var Return: Extended; var Values: TTwainResolution; Mode: TRetrieveCap
      {$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
...
{$IFDEF DEFAULTPARAM} = rcGet{$ENDIF}): TCapabilityRet;
  ...
  protected
    ...
    procedure DoTwainAcquire(Sender: TObject; const Index: Integer; Image: HBitmap; var Cancel: Boolean);
      virtual; abstract;
    procedure DoAcquireProgress(Sender: TObject; const Index: Integer; const Image: HBitmap;
      const Current, Total: Integer); virtual; abstract;
  public
  ...
  public
    ...
    { Set to true if the host application does not create any windows }
    property IsConsoleApplication: Boolean read fIsConsoleApplication write fIsConsoleApplication
      default False;
  public
    { Events }
    { Source being disabled }
    property OnSourceDisable: TOnSourceNotify read fOnSourceDisable write fOnSourceDisable;
    { Acquire cancelled }
    property OnAcquireCancel: TOnSourceNotify read fOnAcquireCancel write fOnAcquireCancel;
    { User should set information to prepare for the file transfer }
    property OnSourceSetupFileXfer: TOnSourceNotify read fOnSourceSetupFileXfer write fOnSourceSetupFileXfer;
    { File transfered }
    property OnSourceFileTransfer: TOnSourceFileTransfer read fOnSourceFileTransfer
      write fOnSourceFileTransfer;
    { Acquire error }
    property OnAcquireError: TOnTwainError read fOnAcquireError write fOnAcquireError;
    { All images transfered }
    property OnTransferComplete: TOnTransferComplete read fOnTransferComplete write fOnTransferComplete;
  public
...
begin
  ...
  if Length(Value) <= sizeof(TW_STR255) then
    ...
    CopyMemory(@Result[0], @Value[1], sizeof(TW_STR255));
end;
...
begin
  ...
  case Index of
    0:
      PropStr := @Structure.Version.Info[0];
    1:
      PropStr := @Structure.Manufacturer[0];
    2:
      PropStr := @Structure.ProductFamily[0];
  else
    PropStr := @Structure.ProductName[0];
  end { case };
...
begin
  ...
  case Index of
    0:
      Result := string(Structure.Version.Info);
    1:
      Result := string(Structure.Manufacturer);
    2:
      Result := string(Structure.ProductFamily);
  else
    Result := string(Structure.ProductName);
  end { case }
end;
...
begin
  ...
  begin
    ...
    CallRes := TwainProc(AppInfo, nil, DG_CONTROL, DAT_IDENTITY, MSG_GETFIRST, @NewSource.Structure);
    if CallRes = TWRC_SUCCESS then
      ...
      until TwainProc(AppInfo, nil, DG_CONTROL, DAT_IDENTITY, MSG_GETNEXT, @NewSource.Structure) <>
        TWRC_SUCCESS;
    ...
    Result := False; { If library and source manager aren't loaded }
end;
...
begin
  ...
  begin
    ...
    Result := (fTwainProc(AppInfo, nil, DG_CONTROL, DAT_PARENT, MSG_OPENDSM, @VirtualWindow) = TWRC_SUCCESS);
  end
  else
  begin
...
begin
  ...
  if SourceManagerLoaded and (TwainProc(AppInfo, nil, DG_CONTROL, DAT_IDENTITY, MSG_GETDEFAULT, @Identity)
    = TWRC_SUCCESS) then
...
begin
  ...
  begin
    ...
    { Call method }
    Result := (Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_USERINTERFACE, MSG_ENABLEDS,
      @twUserInterface) in [TWRC_SUCCESS, TWRC_CHECKSTATUS]);
  end
...
begin
  ...
  begin
    ...
    { Call method }
    Result := (Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_USERINTERFACE, MSG_DISABLEDS,
      @twUserInterface) = TWRC_SUCCESS);
...
begin
  ...
  if Not Loaded then
  begin
    Result := (Owner.TwainProc(AppInfo, nil, DG_CONTROL, DAT_IDENTITY, MSG_OPENDS, @Structure)
      = TWRC_SUCCESS);
    { Increase the loaded sources count variable }
    if Result then
      inc(Owner.fSourcesLoaded);
  end
  else
...
begin
  ...
  begin
    ...
    DisableSource();
    { Call method to load }
    Result := (Owner.TwainProc(AppInfo, nil, DG_CONTROL, DAT_IDENTITY, MSG_CLOSEDS, @Structure)
      = TWRC_SUCCESS);
    { Decrease the loaded sources count variable }
    if Result then
      dec(Owner.fSourcesLoaded);
  end
  else
...
begin
  ...
  Result := (Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_EVENT, MSG_PROCESSEVENT, @twEvent)
    = TWRC_DSEVENT);
...
begin
  ...
  begin
    ...
    Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_STATUS, MSG_GET, @StatusInfo);
    Result := StatusInfo.ConditionCode;
  end
  else
    Result := 0 { In case it was called while the source was not loaded }
end;

{ Converts from a result to a TCapabilityRec }
function TTwainSource.ResultToCapabilityRec(const Value: TW_UINT16): TCapabilityRet;
begin
  ...
  case Value of
    ...
    case GetReturnStatus() of
      ...
      TWCC_CAPBADOPERATION:
        Result := crBadOperation;
      TWCC_CAPSEQERROR:
        Result := crDependencyError;
      TWCC_LOWMEMORY:
        Result := crLowMemory;
      TWCC_SEQERROR:
        Result := crInvalidState;
    else
      Result := crBadOperation;
...
{ Sets a capability }
function TTwainSource.SetCapabilityRec(const Capability, ConType: TW_UINT16; Data: HGLOBAL): TCapabilityRet;
var
...
begin
  ...
  begin
    ...
    Result := ResultToCapabilityRec(Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_CAPABILITY, MSG_SET,
      @CapabilityInfo));
...
{ Returns a capability strucutre }
function TTwainSource.GetCapabilityRec(const Capability: TW_UINT16; var Handle: HGLOBAL; Mode: TRetrieveCap;
  var Container: TW_UINT16): TCapabilityRet;
const
  ModeToTwain: Array [TRetrieveCap] of TW_UINT16 = (MSG_GET, MSG_GETCURRENT, MSG_GETDEFAULT, MSG_RESET);
var
  CapabilityInfo: TW_CAPABILITY;
begin
  ...
  begin
    ...
    { Call method and store return }
    Result := ResultToCapabilityRec(Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_CAPABILITY,
      ModeToTwain[Mode], @CapabilityInfo));
...
{ Gets an item and returns it in a string }
procedure TTwainSource.GetItem(var Return: String; ItemType: TW_UINT16; Data: pointer);
begin
  { Test the item type }
  case ItemType of
    TWTY_INT8:
      Return := IntToStr(pTW_INT8(Data)^);
    TWTY_UINT8:
      Return := IntToStr(pTW_UINT8(Data)^);
    TWTY_INT16, 44 { TWTY_HANDLE } :
      Return := IntToStr(pTW_INT16(Data)^);
    TWTY_UINT16, TWTY_BOOL:
      Return := IntToStr(pTW_UINT16(Data)^);
    TWTY_INT32:
      Return := IntToStr(pTW_INT32(Data)^);
    TWTY_UINT32, 43 { TWTY_MEMREF } :
      Return := IntToStr(pTW_UINT32(Data)^);
    ...
    TWTY_FIX32:
      with pTW_FIX32(Data)^ do
        ...
        {%H-}{$IFDEF DELPHI_XE_UP}FormatSettings.{$ENDIF}DecimalSeparator + IntToStr(Frac);
    { String types, which are all ended by a null char (#0) }
    TWTY_STR32, TWTY_STR64, TWTY_STR128, TWTY_STR255:
      Return := String(PAnsiChar(Data));

  end { case ItemType }
end;

{ Returns an array capability }
function TTwainSource.GetArrayValue(Capability: TW_UINT16; var ItemType: TW_UINT16;
  var List: TGetCapabilityList; MemHandle: HGLOBAL): TCapabilityRet;
var
  ArrayV: pTW_ARRAY;
  ItemSize: Integer;
  Data: PAnsiChar; // ccc
...
{ Returns an enumeration capability }
function TTwainSource.GetEnumerationValue(Capability: TW_UINT16; var ItemType: TW_UINT16;
  var List: TGetCapabilityList; var Current, Default: Integer; Mode: TRetrieveCap; MemHandle: HGLOBAL)
  : TCapabilityRet;
var
...
function TTwainSource.GetRangeValue(Capability: TW_UINT16; var ItemType: TW_UINT16;
  var Min, Max, Step, Default, Current: String; MemHandle: HGLOBAL): TCapabilityRet;
var
  RangeV: pTW_RANGE;
  Container: TW_UINT16;
begin
...
{ Returns an one value capability }
function TTwainSource.GetOneValue(Capability: TW_UINT16; var ItemType: TW_UINT16; var Value: String;
...
{ Sets an one value capability }
function TTwainSource.SetOneValue(Capability: TW_UINT16; ItemType: TW_UINT16; Value: pointer): TCapabilityRet;
var
  Data: HGLOBAL;
  OneV: pTW_ONEVALUE;
...
begin
  ...
  if ItemSize < TWTypeSize(TWTY_UINT32) then
    ItemSize2 := TWTypeSize(TWTY_UINT32)
  else
    ItemSize2 := ItemSize;
...
const
  Transfer: array [TTwainOrientation] of TW_UINT16 = (TWOR_PORTRAIT, TWOR_LANDSCAPE);
var
  iValue: TW_UINT16;
begin
...
const
  Transfer: array [TTwainPaperSize] of TW_UINT16 = (TWSS_A4LETTER, TWSS_A5, TWSS_B4, TWSS_B5LETTER, TWSS_B6,
    TWSS_USLETTER, TWSS_USLEGAL);
var
  iValue: TW_UINT16;
begin
  iValue := Transfer[Value];
...
{ Sets a range capability }
function TTwainSource.SetRangeValue(Capability: TW_UINT16; ItemType: TW_UINT16;
  Min, Max, Step, Current: TW_UINT32): TCapabilityRet;
var
  Data: HGLOBAL;
  RangeV: pTW_RANGE;
begin
...
{ Sets an array capability }
function TTwainSource.SetArrayValue(Capability: TW_UINT16; ItemType: TW_UINT16; List: TSetCapabilityList)
  : TCapabilityRet;
var
  Data: HGLOBAL;
  EnumV: pTW_ENUMERATION;
...
{ Sets an enumeration capability }
function TTwainSource.SetEnumerationValue(Capability: TW_UINT16; ItemType: TW_UINT16; CurrentIndex: TW_UINT32;
  List: TSetCapabilityList): TCapabilityRet;
var
  Data: HGLOBAL;
  EnumV: pTW_ENUMERATION;
...
{ Transfer image memory }
function TTwainSource.TransferImageMemory(var ImageHandle: HBitmap; PixelType: TW_INT16): TW_UINT16;
var
  ...
  Ptr: PAnsiChar; // ccc
  LineLength, CurLine: Cardinal;
  LinePtr, AllocPtr: pointer;
  DataSize, Readed: Cardinal;
...
begin
  ...
  Result := Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_SETUPMEMXFER, MSG_GET, @Setup);
...
{%H-}DTNativeUInt(LinePtr) := DTNativeUInt(ImageInfo.bmBits) + LineLength * CurLine;
  ...
  begin
    repeat
      ...
      Xfer.BytesWritten := 0;
      Result := Owner.TwainProc(AppInfo, @Structure, DG_IMAGE, DAT_IMAGEMEMXFER, MSG_GET, @Xfer);
      { Test the result }
...
{%H-}DTNativeUInt(LinePtr) := {%H-}DTNativeUInt(LinePtr) - LineLength;
            ...
            { Call event }
            Owner.DoAcquireProgress(Self, Self.Index, ImageHandle, Cardinal(ImageInfo.bmHeight) - CurLine - 1,
...
const
  PixelColor: Array [TTwainPixelFlavor] of Array [0 .. 1] of Byte = ((0, $FF), ($FF, 00), (0, $FF));
var
  Handle: HGLOBAL;
  Info: TW_IMAGEINFO;
  Setup: TW_SETUPMEMXFER;
...
begin
  ...
  case (Info.PixelType) of
    ...
    begin
      ...
      if Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_PALETTE8, MSG_GET, @Pal) <> TWRC_SUCCESS then
      begin
...
begin
  ...
  repeat
    ...
    case TransferMode of
      ...
      ttmFile:
        begin
          ...
          Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_SETUPFILEXFER, MSG_GET, @Info);
          { Call method to make source acquire and create file }
          rc := Owner.TwainProc(AppInfo, @Structure, DG_IMAGE, DAT_IMAGEFILEXFER, MSG_GET, nil);
        end { case ttmFile };
      ...
      ttmMemory:
        begin
          ...
          if rc = TWRC_SUCCESS then
            rc := TransferImageMemory(ImageHandle, PixelType);
        end
    ...
    case rc of
      ...
      TWRC_XFERDONE:
        case TransferMode of
          ...
          ttmNative:
            ReadNative(hNative, Cancel);
          { File transfer sucessfull }
          ttmFile:
            ReadFile(Info.Filename, Info.Format, Cancel);
          { Memory transfer sucessfull }
          ttmMemory:
            ReadMemory(ImageHandle, Cancel);
    ...
    if not Done then
      Done := (Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_PENDINGXFERS, MSG_ENDXFER, @PendingXfers)
        <> TWRC_SUCCESS) or (PendingXfers.Count = 0);

    { If user has cancelled }
    if not Done and Cancel then
      Done := (Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_PENDINGXFERS, MSG_RESET, @PendingXfers)
        = TWRC_SUCCESS);
...
{ Reads the file image }
procedure TTwainSource.ReadFile(Name: TW_STR255; Format: TW_UINT16; var Cancel: Boolean);
begin
  { Call event, if set }
  if Assigned(Owner.OnSourceFileTransfer) then
    Owner.OnSourceFileTransfer(Self, Index, Name, TwainToTTwainFormat(Format), Cancel);
end;
...
{ Setup file transfer }
function TTwainSource.SetupFileTransfer(Filename: String; Format: TTwainFormat): Boolean;
const
  FormatToTwain: Array [TTwainFormat] of TW_UINT16 = (TWFF_TIFF, TWFF_PICT, TWFF_BMP, TWFF_XBM, TWFF_JFIF,
    TWFF_FPX, TWFF_TIFFMULTI, TWFF_PNG, TWFF_SPIFF, TWFF_EXIF, 0);
var
...
begin
  ...
  begin
    ...
    { Call method }
    Result := (Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_SETUPFILEXFER, MSG_SET, @FileTransferInfo)
      = TWRC_SUCCESS);
  end
  else
    Result := False; { Could not set file transfer with source unloaded }
end;
...
{ Returns the number of images that the source will return }
function TTwainSource.GetCapXferCount(var Return: SmallInt; Mode: TRetrieveCap): TCapabilityRet;
var
...
// on a HP driver
const
  Transfer: Array [TTwainUnit] of TW_UINT16 = (TWUN_INCHES, TWUN_CENTIMETERS, TWUN_PICAS, TWUN_POINTS,
...
{ Retrieve the unit measure for all quantities }
function TTwainSource.GetICapUnits(var Return: TTwainUnit; var Supported: TTwainUnitSet; Mode: TRetrieveCap)
  : TCapabilityRet;
var
  ItemType: TW_UINT16;
  List: TGetCapabilityList;
  Current, i, Default: Integer;
begin
  { Call method to get result }
  Result := GetEnumerationValue(ICAP_UNITS, {%H-}ItemType, {%H-}List, {%H-}Current, {%H-}Default, Mode);
  if ItemType <> TWTY_UINT16 then
    Result := crUnsupported;
...
{ Retrieve the pixel flavor values }
function TTwainSource.GetIPixelFlavor(var Return: TTwainPixelFlavor; var Supported: TTwainPixelFlavorSet;
  Mode: TRetrieveCap): TCapabilityRet;
var
  ItemType: TW_UINT16;
  List: TGetCapabilityList;
...
// on a HP driver
const
  Transfer: array [TTwainPixelFlavor] of TW_UINT16 = (TWPF_CHOCOLATE, TWPF_VANILLA, TWPF_CHOCOLATE);
var
  iValue: TW_UINT16;
begin
  iValue := Transfer[Value];
...
{ Returns pixel type values }
function TTwainSource.GetIPixelType(var Return: TTwainPixelType; var Supported: TTwainPixelTypeSet;
  Mode: TRetrieveCap): TCapabilityRet;
var
  ItemType: TW_UINT16;
  List: TGetCapabilityList;
...
{ Returns bitdepth values }
function TTwainSource.GetIBitDepth(var Return: Word; var Supported: TTwainBitDepth; Mode: TRetrieveCap)
  : TCapabilityRet;
var
  ItemType: TW_UINT16;
  List: TGetCapabilityList;
...
{%H-}Default, Mode);
  ...
  begin
    ...
    { Return values depending on the mode }
    if Mode = rcGetDefault then
      Return := StrToIntDef(List[Default], -1)
    else
      Return := StrToIntDef(List[Current], -1);
  end { if Result = crSuccess }
end;
...
function TTwainSource.GetIPhysicalWidth(var Return: Extended; Mode: TRetrieveCap): TCapabilityRet;
var
  Handle: HGLOBAL;
  OneV: pTW_ONEVALUE;
  Container: TW_UINT16;
begin
  ...
  begin
    ...
    if OneV^.ItemType <> TWTY_FIX32 then
      Result := crUnsupported
    else
      Return := Fix32ToFloat(pTW_FIX32(@OneV^.Item)^);
    { Free data }
    GlobalUnlock(Handle);
    GlobalFree(Handle);
  end;
...
function TTwainSource.GetIPhysicalHeight(var Return: Extended; Mode: TRetrieveCap): TCapabilityRet;
var
  Handle: HGLOBAL;
  OneV: pTW_ONEVALUE;
  Container: TW_UINT16;
...
{ Returns a resolution }
function TTwainSource.GetResolution(Capability: TW_UINT16; var Return: Extended; var Values: TTwainResolution;
  Mode: TRetrieveCap): TCapabilityRet;
var
  Handle: HGLOBAL;
  EnumV: pTW_ENUMERATION;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if Mode = rcGetDefault then
          Return := Values[EnumV^.DefaultIndex]
        else
          Return := Values[EnumV^.CurrentIndex];
      end
      else
        Return := 0;
    end;
...
function TTwainSource.GetIXResolution(var Return: Extended; var Values: TTwainResolution; Mode: TRetrieveCap)
  : TCapabilityRet;
begin
...
function TTwainSource.GetIYResolution(var Return: Extended; var Values: TTwainResolution; Mode: TRetrieveCap)
  : TCapabilityRet;
begin
...
const
  Transfer: array [TTwainAutoSize] of TW_UINT16 = (TWAS_NONE, TWAS_AUTO, TWAS_CURRENT);
var
  iValue: TW_UINT16;
begin
  iValue := Transfer[Value];
...
begin
  ...
  begin
    ...
    if Owner.TwainProc(AppInfo, @Structure, DG_CONTROL, DAT_PENDINGXFERS, MSG_GET, @PendingXfers) = TWRC_SUCCESS
    then
      Result := PendingXfers.Count
    else
      Result := ERROR_INT16; { Some error ocurred while calling message }
  end
  else
    Result := ERROR_INT16; { Source not loaded/enabled }
end;
...
begin
  ...
  { Call method and store return }
  Result := ResultToCapabilityRec(Owner.TwainProc(AppInfo, @Structure, DG_IMAGE, DAT_IMAGELAYOUT, MSG_SET,
    @ImageLayout));
end;
