...
type
  TCBVCLPreviewForm = class(TForm)
    ...
    procedure FButtonNormalMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer);
    procedure FButtonNormalMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
  private
...
procedure TCBVCLPreviewForm.FButtonNormalMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TCBVCLPreviewForm.FButtonNormalMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  FButtonNormal.Caption := FButtonHotCaption;
end;
...
begin
{$IFDEF VER340} Self.StyleName := FCustomStyle.Name; {$ENDIF}
  Visible := True;
end;
