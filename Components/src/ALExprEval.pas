...
{$ENDIF SUPPORTS_EXTENDED}
    ...
    function CallFloat32Func(AFunc: TALFloat32Func): TALExprNode;
      virtual; abstract;
    function CallFloat64Func(AFunc: TALFloat64Func): TALExprNode;
      virtual; abstract;
{$IFDEF SUPPORTS_EXTENDED}
    function CallFloat80Func(AFunc: TALFloat80Func): TALExprNode;
      virtual; abstract;
{$ENDIF SUPPORTS_EXTENDED}
    function CallUnaryFunc(AFunc: TALUnaryFunc; X: TALExprNode): TALExprNode;
      virtual; abstract;
    function CallUnary32Func(AFunc: TALUnary32Func; X: TALExprNode)
      : TALExprNode; virtual; abstract;
    function CallUnary64Func(AFunc: TALUnary64Func; X: TALExprNode)
      : TALExprNode; virtual; abstract;
{$IFDEF SUPPORTS_EXTENDED}
    function CallUnary80Func(AFunc: TALUnary80Func; X: TALExprNode)
      : TALExprNode; virtual; abstract;
{$ENDIF SUPPORTS_EXTENDED}
    function CallBinaryFunc(AFunc: TALBinaryFunc; X, Y: TALExprNode)
      : TALExprNode; virtual; abstract;
    function CallBinary32Func(AFunc: TALBinary32Func; X, Y: TALExprNode)
      : TALExprNode; virtual; abstract;
    function CallBinary64Func(AFunc: TALBinary64Func; X, Y: TALExprNode)
      : TALExprNode; virtual; abstract;
{$IFDEF SUPPORTS_EXTENDED}
    function CallBinary80Func(AFunc: TALBinary80Func; X, Y: TALExprNode)
      : TALExprNode; virtual; abstract;
{$ENDIF SUPPORTS_EXTENDED}
    function CallTernaryFunc(AFunc: TALTernaryFunc; X, Y, Z: TALExprNode)
      : TALExprNode; virtual; abstract;
    function CallTernary32Func(AFunc: TALTernary32Func; X, Y, Z: TALExprNode)
      : TALExprNode; virtual; abstract;
    function CallTernary64Func(AFunc: TALTernary64Func; X, Y, Z: TALExprNode)
      : TALExprNode; virtual; abstract;
{$IFDEF SUPPORTS_EXTENDED}
    function CallTernary80Func(AFunc: TALTernary80Func; X, Y, Z: TALExprNode)
      : TALExprNode; virtual; abstract;
{$ENDIF SUPPORTS_EXTENDED}
    function Add(ALeft, ARight: TALExprNode): TALExprNode; virtual; abstract;
    function Subtract(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function Multiply(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function Divide(ALeft, ARight: TALExprNode): TALExprNode; virtual; abstract;
    function IntegerDivide(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    ...
    function Compare(ALeft, ARight: TALExprNode): TALExprNode; virtual;
      abstract;
    function CompareEqual(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function CompareNotEqual(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function CompareLess(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function CompareLessEqual(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function CompareGreater(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function CompareGreaterEqual(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;

    function LogicalAnd(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function LogicalOr(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function LogicalXor(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function LogicalNot(AValue: TALExprNode): TALExprNode; virtual; abstract;
    function BitwiseAnd(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function BitwiseOr(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function BitwiseXor(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function BitwiseNot(AValue: TALExprNode): TALExprNode; virtual; abstract;
    function ShiftLeft(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
    function ShiftRight(ALeft, ARight: TALExprNode): TALExprNode;
      virtual; abstract;
...
{$ENDIF SUPPORTS_EXTENDED}
    function CallUnaryFunc(AFunc: TALUnaryFunc; X: TALExprNode)
      : TALExprNode; override;
    function CallUnary32Func(AFunc: TALUnary32Func; X: TALExprNode)
      : TALExprNode; override;
    function CallUnary64Func(AFunc: TALUnary64Func; X: TALExprNode)
      : TALExprNode; override;
...
{$ENDIF SUPPORTS_EXTENDED}
    ...
    function CompareGreaterEqual(ALeft, ARight: TALExprNode)
      : TALExprNode; override;
...
{$ENDIF SUPPORTS_EXTENDED}
    procedure AddFunc(const AName: AnsiString; AFunc: TALBinary32Func);
      overload;
    procedure AddFunc(const AName: AnsiString; AFunc: TALBinary64Func);
      overload;
{$IFDEF SUPPORTS_EXTENDED}
    procedure AddFunc(const AName: AnsiString; AFunc: TALBinary80Func);
      overload;
{$ENDIF SUPPORTS_EXTENDED}
    procedure AddFunc(const AName: AnsiString;
      AFunc: TALTernary32Func); overload;
    procedure AddFunc(const AName: AnsiString;
      AFunc: TALTernary64Func); overload;
{$IFDEF SUPPORTS_EXTENDED}
    procedure AddFunc(const AName: AnsiString;
      AFunc: TALTernary80Func); overload;
{$ENDIF SUPPORTS_EXTENDED}
    procedure Remove(const AName: AnsiString);
...
resourcestring
  ...
  RsALExprEvalFirstArg =
    'Parse error: ''('' and function''s first parameter expected';
  RsALExprEvalNextArg = 'Parse error: '','' and another parameter expected';
  RsALExprEvalEndArgs =
    'Parse error: '')'' to close function''s parameters expected';

  RsALExprEvalExprNotFound =
    'Expression compiler error: Expression ''%s'' not found';
  RsALExprEvalExprPtrNotFound =
    'Expression compiler error: Expression pointer not found';
  RsALExprEvalExprRefCountAssertion =
    'Expression compiler error: expression refcount < 0';
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        TObject(List[I]).Free;
        if (not(List is TComponentList)) and
          ((not(List is TObjectList)) or not TObjectList(List).OwnsObjects) then
          List[I] := nil;
      end;
    end;
    List.Clear;
...
begin
  ...
  aIdx := FHashMap.IndexOf(AName);
  if aIdx >= 0 then
    Result := TALExprSym(FHashMap.Objects[aIdx]);
end;
...
{ ********************************************************************************************** }
constructor TALExprCompileParser.Create(ALexer: TALExprLexer;
  ANodeFactory: TALExprNodeFactory);
begin
  inherited Create;
  FLexer := ALexer;
...
begin
  ...
  while True do
    case Lexer.CurrTok of
      ...
      etGreaterEqual: // >=
        Result := NodeFactory.CompareGreaterEqual(Result,
          CompileExprLevel1(True));
      etIdentifier: // cmp
  ...
  while True do
    case Lexer.CurrTok of
      ...
      etIdentifier: // or, xor, bor, bxor
        ...
        else if ALSameText(Lexer.TokenAsString, 'xor') then
          Result := NodeFactory.LogicalXor(Result, CompileExprLevel2(True))
        else if ALSameText(Lexer.TokenAsString, 'bor') then
          Result := NodeFactory.BitwiseOr(Result, CompileExprLevel2(True))
        else if ALSameText(Lexer.TokenAsString, 'bxor') then
  ...
  while True do
    case Lexer.CurrTok of
      ...
      etIdentifier: // div, mod, and, shl, shr, band
        ...
        else if ALSameText(Lexer.TokenAsString, 'mod') then
          Result := NodeFactory.Modulo(Result, CompileExprLevel3(True))
        else if ALSameText(Lexer.TokenAsString, 'and') then
          Result := NodeFactory.LogicalAnd(Result, CompileExprLevel3(True))
        else if ALSameText(Lexer.TokenAsString, 'shl') then
          Result := NodeFactory.ShiftLeft(Result, CompileExprLevel3(True))
        else if ALSameText(Lexer.TokenAsString, 'shr') then
          Result := NodeFactory.ShiftRight(Result, CompileExprLevel3(True))
        else if ALSameText(Lexer.TokenAsString, 'band') then
...
begin
  ...
  case Lexer.CurrTok of
    ...
    etIdentifier: // not, bnot
      ...
      else if ALSameText(Lexer.TokenAsString, 'bnot') then
...
const
  CharToTokenMap: array [AnsiChar] of TALExprToken = (
    { #0..#31 }
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
    ...
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
    etInvalid, etInvalid, etInvalid, etInvalid, etInvalid,
...
{ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ }
  ...
  begin
    ...
    P1 := ALPosExIgnoreCase(AnsiString(' in') + aOpeningBracketChar, Result);
    // (MyVar=0) or(MyVar in(1, 3, sqr(1,2), 4))
    // ^P1
    while P1 > 0 do
    begin
      ...
      // ^P2
      while (P2 > 0) and (Result[P2] in ['a' .. 'z', 'A' .. 'Z',
        '0' .. '9', '_']) do
        Dec(P2); // (MyVar=0) or(MyVar in(1, 3, sqr(1,2), 4))
      // ^^^^^^P2
      aLvalue := AlCopyStr(Result, P2 + 1, P1 - P2 - 1); // MyVar
      if aLvalue = '' then
        raise EALException.Create
          ('Wrong expression (cannot assign left value for operator IN): ' +
          AExpr);
      ...
      if aOpeningBracketChar = '(' then
        Inc(aRoundBracketCounter)
      else
        Inc(aSquareBracketCounter);
      aArguments := '';
      while P2 <= length(Result) do
      begin
        if Result[P2] = '(' then
          Inc(aRoundBracketCounter)
        ...
        begin
          ...
          if (aRoundBracketCounter + aSquareBracketCounter <= 0) then
            Break;
        end
        else if Result[P2] = ']' then
        begin
          ...
          (aRoundBracketCounter + aSquareBracketCounter = 1) then
        begin // (MyVar=0) or(MyVar in(1, 3, sqr(1,2), 4))
          // ^^P2
          if aArguments <> '' then
            aArguments := aArguments + ' or ';
          aArguments := aArguments + '(' + aLvalue + ' = ' +
            ALTrim(AlCopyStr(Result, P3, P2 - P3)) + ')';
          P3 := P2 + 1; // (MyVar=0) or(MyVar in(1, 3, sqr(1,2), 4))
          // ^P3
        end;
        Inc(P2);
      end;
      if P2 > length(Result) then
        raise EALException.Create
          ('Wrong expression (missing closing bracket): ' + AExpr);
      if aArguments <> '' then
        aArguments := aArguments + ' or ';
      aArguments := aArguments + '(' + aLvalue + '=' +
        ALTrim(AlCopyStr(Result, P3, P2 - P3)) + ')';
      ...
      // calculate again P1
      P1 := ALPosExIgnoreCase(AnsiString(' in') + aOpeningBracketChar,
        Result, P4);
...
var
  aInSingleQuote, aInDoubleQuote: Boolean;
  aCrc: LongInt;
  P1, P2: Integer;
  S1: AnsiString;
...
begin
  ...
  begin
    ...
    begin
      ...
      if aInDoubleQuote then
        P1 := P2;
      if (P2 < length(Result)) and (Result[P2 + 1] = '"') then
      begin
        Inc(P2);
        aInDoubleQuote := (not aInDoubleQuote) and (not aInSingleQuote);
      end;
    ...
    if (not aInSingleQuote) and (not aInDoubleQuote) and (P1 > 0) then
    begin
      ...
      if S1 = '' then
        ...
        aCrc := Crc32(0, PByte(S1[1]), length(S1));
  ...
  if P1 > 0 then
    raise EALException.Create
      ('Wrong expression (unterminated string): ' + AExpr);

  // Clear non-useful white spaces
  setlength(Result, length(Result));
  P1 := 0;
  for P2 := 1 to length(Result) do
  begin
    if not((ALCharIsWhiteSpace(Result[P2])) and (P2 < length(Result)) and
      ((ALCharIsWhiteSpace(Result[P2 + 1])) or (Result[P2 + 1] in ['(', '['])))
    then
    begin
      Inc(P1);
      if ALCharIsWhiteSpace(Result[P2]) then
        Result[P1] := ' '
      else
        Result[P1] := Result[P2];
    end;
...
{ ********************************************************************************* }
constructor TALExprCallBinary32VmOp.Create(AFunc: TALBinary32Func;
  X, Y: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
{ ********************************************************************************* }
constructor TALExprCallBinary64VmOp.Create(AFunc: TALBinary64Func;
  X, Y: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
{ ********************************************************************************* }
constructor TALExprCallBinary80VmOp.Create(AFunc: TALBinary80Func;
  X, Y: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
{ ********************************************************************************** }
constructor TALExprCallTernaryVmOp.Create(AFunc: TALTernaryFunc;
  X, Y, Z: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
{ ************************************************************************************** }
constructor TALExprCallTernary32VmOp.Create(AFunc: TALTernary32Func;
  X, Y, Z: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
{ ************************************************************************************** }
constructor TALExprCallTernary64VmOp.Create(AFunc: TALTernary64Func;
  X, Y, Z: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
{ ************************************************************************************** }
constructor TALExprCallTernary80VmOp.Create(AFunc: TALTernary80Func;
  X, Y, Z: PALFloat);
begin
  inherited Create;
  FFunc := AFunc;
...
type
  ...
  public
    ...
    property VmDeps[AIndex: Integer]: TALExprVirtMachNode
      read GetVmDeps; default;
  end;
...
{$ENDIF SUPPORTS_EXTENDED}
  ...
  { *********************************************************************************************************** }
constructor TALExprUnaryVmNode.Create(AUnaryClass: TALExprUnaryVmOpClass;
  const ADeps: array of TALExprNode);
begin
...
{ ************************************************************************************************************** }
constructor TALExprBinaryVmNode.Create(ABinaryClass: TALExprBinaryVmOpClass;
  const ADeps: array of TALExprNode);
begin
...
{ ******************************************************************************* }
function TALExprVirtMachNodeFactory.LoadConst32(AValue: TALFloat32)
  : TALExprNode;
begin
...
{ ******************************************************************************* }
function TALExprVirtMachNodeFactory.LoadConst64(AValue: TALFloat64)
  : TALExprNode;
begin
  Result := AddNode(TALExprConstVmNode.Create(AValue));
end;
...
function TALExprVirtMachNodeFactory.LoadConst80(AValue: TALFloat80)
  : TALExprNode;
begin
  Result := AddNode(TALExprConstVmNode.Create(AValue));
end;
...
{ ******************************************************************************* }
function TALExprVirtMachNodeFactory.Add(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprAddVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************ }
function TALExprVirtMachNodeFactory.Subtract(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprSubtractVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************ }
function TALExprVirtMachNodeFactory.Multiply(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprMultiplyVmOp,
    [ALeft, ARight]));
end;

{ ********************************************************************************** }
function TALExprVirtMachNodeFactory.Divide(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprDivideVmOp,
    [ALeft, ARight]));
end;

{ ***************************************************************************************** }
function TALExprVirtMachNodeFactory.IntegerDivide(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprIntegerDivideVmOp,
    [ALeft, ARight]));
end;

{ ********************************************************************************** }
function TALExprVirtMachNodeFactory.Modulo(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprModuloVmOp,
    [ALeft, ARight]));
end;
...
{ ********************************************************************************** }
function TALExprVirtMachNodeFactory.CallFloatFunc(AFunc: TALFloatFunc)
  : TALExprNode;
begin
...
{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.CallFloat32Func(AFunc: TALFloat32Func)
  : TALExprNode;
begin
...
{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.CallFloat64Func(AFunc: TALFloat64Func)
  : TALExprNode;
begin
...
function TALExprVirtMachNodeFactory.CallFloat80Func(AFunc: TALFloat80Func)
  : TALExprNode;
begin
...
{ ************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallUnaryFunc(AFunc: TALUnaryFunc;
  X: TALExprNode): TALExprNode;
begin
  Result := AddNode(TALExprCallUnaryVmNode.Create(AFunc, X));
end;

{ ****************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallUnary32Func(AFunc: TALUnary32Func;
  X: TALExprNode): TALExprNode;
begin
...
{ ****************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallUnary64Func(AFunc: TALUnary64Func;
  X: TALExprNode): TALExprNode;
begin
...
function TALExprVirtMachNodeFactory.CallUnary80Func(AFunc: TALUnary80Func;
  X: TALExprNode): TALExprNode;
begin
...
{ ******************************************************************************************************* }
function TALExprVirtMachNodeFactory.CallBinaryFunc(AFunc: TALBinaryFunc;
  X, Y: TALExprNode): TALExprNode;
begin
  Result := AddNode(TALExprCallBinaryVmNode.Create(AFunc, X, Y));
end;

{ *********************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallBinary32Func(AFunc: TALBinary32Func;
  X, Y: TALExprNode): TALExprNode;
begin
...
{ *********************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallBinary64Func(AFunc: TALBinary64Func;
  X, Y: TALExprNode): TALExprNode;
begin
...
function TALExprVirtMachNodeFactory.CallBinary80Func(AFunc: TALBinary80Func;
  X, Y: TALExprNode): TALExprNode;
begin
...
{ ************************************************************************************************************ }
function TALExprVirtMachNodeFactory.CallTernaryFunc(AFunc: TALTernaryFunc;
  X, Y, Z: TALExprNode): TALExprNode;
begin
  Result := AddNode(TALExprCallTernaryVmNode.Create(AFunc, X, Y, Z));
end;

{ **************************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallTernary32Func(AFunc: TALTernary32Func;
  X, Y, Z: TALExprNode): TALExprNode;
begin
...
{ **************************************************************************************************************** }
function TALExprVirtMachNodeFactory.CallTernary64Func(AFunc: TALTernary64Func;
  X, Y, Z: TALExprNode): TALExprNode;
begin
...
function TALExprVirtMachNodeFactory.CallTernary80Func(AFunc: TALTernary80Func;
  X, Y, Z: TALExprNode): TALExprNode;
begin
...
{ *********************************************************************************** }
function TALExprVirtMachNodeFactory.Compare(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprCompareVmOp,
    [ALeft, ARight]));
end;

{ **************************************************************************************** }
function TALExprVirtMachNodeFactory.CompareEqual(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprEqualVmOp,
    [ALeft, ARight]));
end;

{ ******************************************************************************************* }
function TALExprVirtMachNodeFactory.CompareNotEqual(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprNotEqualVmOp,
    [ALeft, ARight]));
end;

{ *************************************************************************************** }
function TALExprVirtMachNodeFactory.CompareLess(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprLessVmOp,
    [ALeft, ARight]));
end;

{ ******************************************************************************************** }
function TALExprVirtMachNodeFactory.CompareLessEqual(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprLessEqualVmOp,
    [ALeft, ARight]));
end;

{ ****************************************************************************************** }
function TALExprVirtMachNodeFactory.CompareGreater(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprGreaterVmOp,
    [ALeft, ARight]));
end;

{ *********************************************************************************************** }
function TALExprVirtMachNodeFactory.CompareGreaterEqual(ALeft,
  ARight: TALExprNode): TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprGreaterEqualVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.LogicalAnd(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprLogicalAndVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************* }
function TALExprVirtMachNodeFactory.LogicalOr(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprLogicalOrVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.LogicalXor(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprLogicalXorVmOp,
    [ALeft, ARight]));
end;

{ ******************************************************************************* }
function TALExprVirtMachNodeFactory.LogicalNot(AValue: TALExprNode)
  : TALExprNode;
begin
...
{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.BitwiseAnd(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprBitwiseAndVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************* }
function TALExprVirtMachNodeFactory.BitwiseOr(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprBitwiseOrVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.BitwiseXor(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprBitwiseXorVmOp,
    [ALeft, ARight]));
end;

{ ******************************************************************************* }
function TALExprVirtMachNodeFactory.BitwiseNot(AValue: TALExprNode)
  : TALExprNode;
begin
...
{ ************************************************************************************* }
function TALExprVirtMachNodeFactory.ShiftLeft(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprShiftLeftVmOp,
    [ALeft, ARight]));
end;

{ ************************************************************************************** }
function TALExprVirtMachNodeFactory.ShiftRight(ALeft, ARight: TALExprNode)
  : TALExprNode;
begin
  Result := AddNode(TALExprBinaryVmNode.Create(TALExprShiftRightVmOp,
    [ALeft, ARight]));
end;
...
begin
  FExprVmCode := TALExprCallUnaryVmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;

{ ********************************************************************************* }
constructor TALExprCallUnary32VmNode.Create(AFunc: TALUnary32Func;
  X: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X]);
...
begin
  FExprVmCode := TALExprCallUnary32VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;

{ ********************************************************************************* }
constructor TALExprCallUnary64VmNode.Create(AFunc: TALUnary64Func;
  X: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X]);
...
begin
  FExprVmCode := TALExprCallUnary64VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ ********************************************************************************* }
constructor TALExprCallUnary80VmNode.Create(AFunc: TALUnary80Func;
  X: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X]);
...
begin
  FExprVmCode := TALExprCallUnary80VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ ********************************************************************************** }
constructor TALExprCallBinaryVmNode.Create(AFunc: TALBinaryFunc;
  X, Y: TALExprNode);
begin
  FFunc := AFunc;
...
begin
  FExprVmCode := TALExprCallBinaryVmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;

{ ************************************************************************************** }
constructor TALExprCallBinary32VmNode.Create(AFunc: TALBinary32Func;
  X, Y: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X, Y]);
...
begin
  FExprVmCode := TALExprCallBinary32VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;

{ ************************************************************************************** }
constructor TALExprCallBinary64VmNode.Create(AFunc: TALBinary64Func;
  X, Y: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X, Y]);
...
begin
  FExprVmCode := TALExprCallBinary64VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ ************************************************************************************** }
constructor TALExprCallBinary80VmNode.Create(AFunc: TALBinary80Func;
  X, Y: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X, Y]);
...
begin
  FExprVmCode := TALExprCallBinary80VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ *************************************************************************************** }
constructor TALExprCallTernaryVmNode.Create(AFunc: TALTernaryFunc;
  X, Y, Z: TALExprNode);
begin
  FFunc := AFunc;
...
begin
  FExprVmCode := TALExprCallTernaryVmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc,
...
{ ******************************************************************************************* }
constructor TALExprCallTernary32VmNode.Create(AFunc: TALTernary32Func;
  X, Y, Z: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X, Y, Z]);
...
begin
  FExprVmCode := TALExprCallTernary32VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc,
    VmDeps[2].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ ******************************************************************************************* }
constructor TALExprCallTernary64VmNode.Create(AFunc: TALTernary64Func;
  X, Y, Z: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X, Y, Z]);
...
begin
  FExprVmCode := TALExprCallTernary64VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc,
    VmDeps[2].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ ******************************************************************************************* }
constructor TALExprCallTernary80VmNode.Create(AFunc: TALTernary80Func;
  X, Y, Z: TALExprNode);
begin
  FFunc := AFunc;
  inherited Create([X, Y, Z]);
...
begin
  FExprVmCode := TALExprCallTernary80VmOp.Create(FFunc,
    VmDeps[0].ExprVmCode.OutputLoc, VmDeps[1].ExprVmCode.OutputLoc,
    VmDeps[2].ExprVmCode.OutputLoc);
  AVirtMach.Add(FExprVmCode);
end;
...
{ ******************************************************************************* }
constructor TALExprFuncSym.Create(const AIdent: AnsiString;
  AFunc: TALFloatFunc);
begin
...
{ **************************************************************************************** }
constructor TALExprFloat32FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALFloat32Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ **************************************************************************************** }
constructor TALExprFloat64FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALFloat64Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ **************************************************************************************** }
constructor TALExprFloat80FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALFloat80Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ************************************************************************************ }
constructor TALExprUnaryFuncSym.Create(const AIdent: AnsiString;
  AFunc: TALUnaryFunc);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
...
{ **************************************************************************************** }
constructor TALExprUnary32FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALUnary32Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ **************************************************************************************** }
constructor TALExprUnary64FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALUnary64Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ **************************************************************************************** }
constructor TALExprUnary80FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALUnary80Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ************************************************************************************** }
constructor TALExprBinaryFuncSym.Create(const AIdent: AnsiString;
  AFunc: TALBinaryFunc);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
...
{ ****************************************************************************************** }
constructor TALExprBinary32FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALBinary32Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ****************************************************************************************** }
constructor TALExprBinary64FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALBinary64Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ****************************************************************************************** }
constructor TALExprBinary80FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALBinary80Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ **************************************************************************************** }
constructor TALExprTernaryFuncSym.Create(const AIdent: AnsiString;
  AFunc: TALTernaryFunc);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ******************************************************************************************** }
constructor TALExprTernary32FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALTernary32Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ******************************************************************************************** }
constructor TALExprTernary64FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALTernary64Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ******************************************************************************************** }
constructor TALExprTernary80FuncSym.Create(const AIdent: AnsiString;
  AFunc: TALTernary80Func);
begin
  Assert(Assigned(AFunc));
  inherited Create(AIdent);
  FFunc := AFunc;
...
{ ********************************************************************************* }
constructor TALExprConst32Sym.Create(const AIdent: AnsiString;
  AValue: TALFloat32);
begin
  inherited Create(AIdent);
  FValue := AValue;
...
{ ********************************************************************************* }
constructor TALExprConst64Sym.Create(const AIdent: AnsiString;
  AValue: TALFloat64);
begin
  inherited Create(AIdent);
  FValue := AValue;
...
{ ********************************************************************************* }
constructor TALExprConst80Sym.Create(const AIdent: AnsiString;
  AValue: TALFloat80);
begin
  inherited Create(AIdent);
  FValue := AValue;
...
procedure TALEasyEvaluator.AddConst(const AName: AnsiString;
  AConst: TALFloat80);
begin
...
{ ******************************************************************************* }
procedure TALEasyEvaluator.AddVar(const AName: AnsiString;
  var AVar: TALFloat32);
begin
...
{ ********************************************************************************* }
procedure TALEasyEvaluator.AddFunc(const AName: AnsiString;
  AFunc: TALFloat32Func);
begin
