  ...
  object pageWebRTC: TPageProducer
    HTMLDoc.Strings = (
      ...
      #9'<title>Websockets WebRTC Video Demo</title>'
        ...
        #9'<script src="https://<#host>:<#port>/sgcWebSockets.js"></script' +
        '>'#9
      
        #9'<script src="https://<#host>:<#port>/webrtc.esegece.com.js"></s' +
        'cript>'#9
      
        #9'<link rel="stylesheet" href="https://<#host>:<#port>/jquery.mob' +
        'ile.css" />'
      #9'<script src="https://<#host>:<#port>/jquery.js"></script>'
      
        #9'<script src="https://<#host>:<#port>/jquery.mobile.js"></script' +
        '>'
      '<script type="text/javascript">'
      'var socket;'
      ''
      'function wsstart() {'
      #9#9#9'socket = new sgcws_webrtc('#39'wss://<#host>:<#port>'#39'); '
      ''
      ...
      #9#9#9#9#9
        ...
        #9#9#9#9#9'setTimeout(function() {socket.webrtc_connect(document.getEl' +
        'ementById('#39'channel'#39').value);}, 3000);'
      #9#9#9#9'}'
      #9#9#9');'#9
      ...
      'function wsstop() {'
        ...
        #9#9#9'socket.webrtc_disconnect(document.getElementById('#39'channel'#39').v' +
        'alue);'
      #9#9#9'socket.close();'
      '}'
      ''
      ...
      #9#9'} else {'
        ...
        'e + '#39': </b>'#39' + document.getElementById('#39'chat'#39').value, document.g' +
        'etElementById('#39'channel'#39').value);     '
      ...
      #9#9#9'<form>'
        ...
        '="type your channel name" value="test-channel"/>'
      ...
      #9#9#9#9#9'<td>'
        ...
        '" id="localVideo" autoplay="autoplay"/></video></div>'
      #9#9#9#9#9'</td>'
      #9#9#9#9#9'<td>'
      
        #9#9#9#9#9#9'<div id="remote">RemoteVideo<video width="100%" height="10' +
        '0%" id="remoteVideo" autoplay="autoplay"></video></div>'#9#9
      #9#9#9#9#9'</td>'
      #9#9#9#9'</tr>'
      #9#9#9'</table>'
