object frmServer: TfrmServer
  Left = 0
  Top = 0
  Caption = 'RTCPeerConnection - sgcWebSockets WebSocket Server'
  ClientHeight = 288
  ClientWidth = 800
  Color = clBtnFace
  ...
  object sgcWSPServer_RTCPeerConnection1: TsgcWSPServer_RTCPeerConnection
    OnConnect = sgcWSPServer_RTCPeerConnection1Connect
    OnDisconnect = sgcWSPServer_RTCPeerConnection1Disconnect
    OnError = sgcWSPServer_RTCPeerConnection1Error
    Server = WSServer
    Left = 32
    Top = 208
  end
