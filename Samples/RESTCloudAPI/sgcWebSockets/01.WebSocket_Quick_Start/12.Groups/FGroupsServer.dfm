object Form16: TForm16
  ...
  object cboBroadcast: TComboBox
    ...
    ItemIndex = 0
    TabOrder = 9
    Text = 'All Members Groups'
    Items.Strings = (
      'All Members Groups'
      'Only Members Group/level'
      'Only Members Group/level/sub-level'
      'Only Members Group/level/sub-level-1')
  end
  ...
  object pageGroups: TPageProducer
    HTMLDoc.Strings = (
      '<!DOCTYPE html>'
      '<html>'
      '<head>'
      ...
      #9'<meta http-equiv="pragma" content="no-cache" />'
        ...
        'e=1">'
      #9'<title>Server Groups  Demo</title>'
      ...
      '</head> '
      '<body> '
      '<div data-role="page" id="wsdemo_group">'
      ''
      ...
      #9'<div data-role="content">'#9
        ...
        #9#9'<h2>Press Start to connect to Server and Join a Random Group</' +
        'h2>'
  ...
  object pageJQueryMobile: TPageProducer
    HTMLDoc.Strings = (
      ...
      ''
        ...
        #9#9'//      that we test for the Groups of the feature by looking ' +
        'for'
  ...
  object pageJQuery: TPageProducer
    HTMLDoc.Strings = (
      ...
      #9#9'// Must be an Object.'
        ...
        #9#9'// Because of IE, we also have to check the Groups of the cons' +
        'tructor property.'
      ...
      #9#9'// Align boolean attributes with corresponding properties'
        ...
        #9#9'// Fall back to attribute Groups where some booleans are not s' +
        'upported'
      #9#9'var attrNode,'
      ...
      #9'};'
      ''
      '// Always assume the Groups of duplicates if sort doesn'#39't'
      ...
      #9#9#9'// since its Groups should be enough'
