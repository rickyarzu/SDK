...
uses
  ...
  FMX.ScrollBox, FMX.Memo, FMX.Layouts, FMX.Media;
...
uses
{$IFDEF ANDROID}
  FMX.DialogService, FMX.Helpers.Android, Androidapi.Jni.Widget, Androidapi.Helpers, Androidapi.Jni.JavaTypes,
  Androidapi.Jni.Os,
{$ENDIF}
  Frame.ReportItem;
...
procedure THeaderFooterForm.ActionTakePhotoForReportCanActionExec(Sender: TCustomAction;
var CanExec: Boolean);
begin
...
procedure THeaderFooterForm.ActionTakePhotoForReportDidFinishTaking(Image: TBitmap);
begin
...
procedure THeaderFooterForm.ActivateCameraPermissionRequestResult(Sender: TObject;
const APermissions: TClassicStringDynArray; const AGrantResults: TClassicPermissionStatusDynArray);
begin
...
procedure THeaderFooterForm.DisplayRationale(Sender: TObject; const APermissions: TClassicStringDynArray;
const APostRationaleProc: TProc);
begin
