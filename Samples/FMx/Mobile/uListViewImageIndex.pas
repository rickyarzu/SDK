...
type
  TfrmListViewImageIndex = class(TForm)
    ListView1: TListView;
...
var
  frmListViewImageIndex: TfrmListViewImageIndex;

implementation

{$R *.fmx}

procedure TfrmListViewImageIndex.FormCreate(Sender: TObject);
var
  I: Integer;
begin
