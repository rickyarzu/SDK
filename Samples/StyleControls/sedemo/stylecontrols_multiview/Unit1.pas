...
begin
   if seAnimation1.IsControlFrozen(Self) or seAnimation2.IsControlFrozen(scGPPageViewer1) then
     Exit;
...
begin
  ...
  seAnimation2.FreezeControlClient(Self, Self.ClientRect);
...
begin
  seAnimation2.FreezeControlClient(scPanel1, scPanel1.ClientRect);
