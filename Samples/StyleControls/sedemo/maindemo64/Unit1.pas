...
uses
  ...
  ComCtrls, Unit4, Unit3, ShellAPI, Vcl.Imaging.pngimage;
...
type
  TForm1 = class(TForm)
    ...
    procedure seXButton1Click(Sender: TObject);
    procedure CheckBox1Click(Sender: TObject);
    procedure Frame31CheckBox1Click(Sender: TObject);
  private
...
procedure TForm1.seXButton1Click(Sender: TObject);
begin
  ShowMessage('sdfdfs');
end;
...
begin
  ...
  begin
    ...
    try
      Panel1.ParentBackground := CheckBox1.Checked;
      Execute;
    finally
      Restore;
    end;
...
procedure TForm1.Frame31CheckBox1Click(Sender: TObject);
begin
  with TestAnimation2 do
  begin
    ForceControlUpdate := True;
    ...
    try
      Frame31.ParentBackground := Frame31.CheckBox1.Checked;
      Frame41.ParentBackground := Frame31.CheckBox1.Checked;
      Execute;
    finally
      Restore;
    end;
