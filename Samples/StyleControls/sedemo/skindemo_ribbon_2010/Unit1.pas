...
type
  TForm1 = class(TForm)
    ...
    bsSelectSkinsFromFoldersDialog1: TbsSelectSkinsFromFoldersDialog;
    ...
    procedure bsRibbonGroup1DialogButtonClick(Sender: TObject);
    ...
    procedure bsRibbon1ChangingPage(Sender: TObject);
...
procedure TForm1.bsRibbonGroup1DialogButtonClick(Sender: TObject);
begin
  if bsSelectSkinsFromFoldersDialog1.Execute('', bsSelectSkinsFromFoldersDialog1.SkinName, 'skn')
  then
    bsSkinData1.LoadFromCompressedFile(bsSelectSkinsFromFoldersDialog1.FileName);
end;
...
procedure TForm1.Selectskin2Click(Sender: TObject);
begin
  if bsSelectSkinsFromFoldersDialog1.Execute('', bsSelectSkinsFromFoldersDialog1.SkinName, 'skn')
  then
    bsSkinData1.LoadFromCompressedFile(bsSelectSkinsFromFoldersDialog1.FileName);
...
procedure TForm1.bsRibbon1ChangingPage(Sender: TObject);
begin
  if seAnimation3.IsControlFrozen(bsRibbon1)
  then
    begin
      FStopExecute := True;
      Exit;
    end;
  seAnimation3.FreezeControl(bsRibbon1, Rect(0, 0, bsRibbon1.Width, bsRibbon1.Height));
  FStopExecute := False;
end;

procedure TForm1.bsRibbon1ChangePage(Sender: TObject);
begin
  if FStopExecute then Exit;
  try
