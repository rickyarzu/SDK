...
uses
  ...
  scGPPagers, scGPVertPagers, System.ImageList, scGPUtils, scGPFontControls;
...
type
  TForm1 = class(TForm)
    ...
    scGPPageControlPage14: TscGPPageControlPage;
    scGPCharImage1: TscGPCharImage;
    scLabel21: TscLabel;
    scLabel20: TscLabel;
    scGPCharImage2: TscGPCharImage;
    scGPCheckBox11: TscGPCheckBox;
    scGPCharGlyphButton1: TscGPCharGlyphButton;
    scGPCharImage3: TscGPCharImage;
    scLabel22: TscLabel;
    scLabel23: TscLabel;
    scGPCharGlyphButton2: TscGPCharGlyphButton;
    scGPCharGlyphButton3: TscGPCharGlyphButton;
    scGPCharImage4: TscGPCharImage;
    scGPCharImage5: TscGPCharImage;
    ...
    procedure scGPCheckBox11Click(Sender: TObject);
  private
...
procedure TForm1.scGPCheckBox11Click(Sender: TObject);
begin
  scGPCharImage1.RotateAnimation := scGPCheckBox11.Checked;
end;
...
begin
  ...
  scGPCharImage1.RotateAnimation := scGPCheckBox11.Checked and (scGPPageControl1.TabIndex = 7);
end;
...
begin
  scGPCircledProgressBar1.Value := TscGPTrackBar(Sender).Value;
  scGPCircledProgressBar2.Value := TscGPTrackBar(Sender).Value;
  scGPProgressBar1.Value := TscGPTrackBar(Sender).Value;
end;
