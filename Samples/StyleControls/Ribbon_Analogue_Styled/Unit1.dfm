object Form1: TForm1
  Left = 0
  Top = 0
  Caption = 'StyleControls VCL - Ribbon UI Analogue - Demo - 100%'
  ClientHeight = 337
  ClientWidth = 726
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object scToolPager1: TscToolPager
    Left = 0
    Top = 0
    Width = 726
    Height = 133
    ...
    TabOrder = 0
    TabStop = True
    OnResize = scToolPager1Resize
    TransparentBackground = False
    BorderStyle = sctpbsFrame
    ShowFocusRect = True
    TabsLeftOffset = 100
    TabsRightOffset = 180
    TabIndex = 0
    ...
    Tabs = <
      item
        Page = scToolPagerPage1
        Visible = True
        Enabled = True
        ImageIndex = 0
        Caption = 'TscToolPagerTab1'
      end
      item
        Page = scToolPagerPage2
        Visible = True
        Enabled = True
        ImageIndex = 1
        Caption = 'Settings'
      ...
      item
        Page = scToolPagerPage3
        Visible = True
        Enabled = True
        ImageIndex = 2
        Caption = 'About'
      end>
    ActivePage = scToolPagerPage1
    ...
    object scButton1: TscButton
      ...
      ColorOptions.NormalColor = 13792793
      ColorOptions.HotColor = 15241788
      ColorOptions.PressedColor = 12151307
      ColorOptions.FocusedColor = 14580763
      ColorOptions.DisabledColor = 13792793
    ...
    object scToolPagerPage3: TscToolPagerPage
      Left = 2
      Top = 42
      Width = 721
      Height = 88
    ...
    object scToolPagerPage2: TscToolPagerPage
      Left = 2
      Top = 42
      Width = 721
      Height = 88
      ...
      object scLabel6: TscLabel
        ...
        UseFontColorToStyleColor = False
        Caption = 
          'Use TscToolPagerPage.CanScroll property to enable / disable scro' +
          'lling'
      end
    end
    object scToolPagerPage1: TscToolPagerPage
      Left = 2
      Top = 42
      Width = 721
      Height = 88
