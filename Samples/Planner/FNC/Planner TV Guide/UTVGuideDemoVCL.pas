unit UTVGuideDemoVCL;

interface

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Generics.Collections, VCL.TMSFNCCloudBase,
  VCL.TMSFNCTypes, VCL.TMSFNCUtils, VCL.TMSFNCGraphics, VCL.TMSFNCGraphicsTypes,
  VCL.TMSFNCPlannerBase, VCL.TMSFNCPlannerData, VCL.TMSFNCPlanner,
  VCL.TMSFNCCustomControl, VCL.TMSFNCCustomPicker, VCL.TMSFNCComboBox, JSON, System.DateUtils;
...
begin
  ...
  TMSFNCPlanner1.PositionsAppearance.Size := TMSFNCPlanner1.ScalePaintValue(120);
  ...
  TTMSFNCUtils.SetFontSize(TMSFNCPlanner1.ItemsAppearance.TitleFont, TMSFNCPlanner1.ScalePaintValue(14));
  TTMSFNCUtils.SetFontSize(TMSFNCPlanner1.PositionsAppearance.BottomFont, TMSFNCPlanner1.ScalePaintValue(14));
  TTMSFNCUtils.SetFontSize(TMSFNCPlanner1.PositionsAppearance.TopFont, TMSFNCPlanner1.ScalePaintValue(14));
