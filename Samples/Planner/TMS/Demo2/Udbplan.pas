...
uses
  ...
  ExtCtrls, DBCtrls, Menus, ImgList, Mask, ComCtrls, Spin, XPMan, System.ImageList, FireDAC.Stan.Intf,
...
type
  TForm1 = class(TForm)
    ...
    PlannerTableCOLOR: TFloatField;
    PlannerTableIMAGE: TFloatField;
    PlannerTableCAPTION: TBooleanField;
    FDMemTable1: TFDMemTable;
    FDMemTable1PLANNERKEY: TStringField;
    FDMemTable1STARTTIME: TDateTimeField;
    FDMemTable1ENDTIME: TDateTimeField;
    FDMemTable1NOTES: TMemoField;
    FDMemTable1SUBJECT: TStringField;
    FDMemTable1COLOR: TFloatField;
    FDMemTable1IMAGE: TFloatField;
    FDMemTable1CAPTION: TBooleanField;
...
begin
  ...
  //PlannerTable.TableName := 'c:\januaproject\db\plandb.DB';

  DBDaySource1.Day := EncodeDate(2001,10,30);
  DBDaySource2.Day := EncodeDate(2001,10,30);
  MonthCalendar1.Date := EncodeDate(2001,10,30);
