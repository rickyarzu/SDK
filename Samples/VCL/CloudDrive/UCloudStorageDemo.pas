...
type
  TForm4 = class(TForm)
    ...
    procedure AdvDropBox1DownloadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
    procedure DownloadBtnClick(Sender: TObject);
    procedure AdvBoxNetDrive1DownloadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
    procedure UploadBtnClick(Sender: TObject);
    procedure AdvBoxNetDrive1UploadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
    procedure AdvDropBox1UploadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
...
procedure TForm4.AdvBoxNetDrive1DownloadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
begin
  ProgressBar1.Position := Position;
  ProgressBar1.Max := Total;
end;

procedure TForm4.AdvBoxNetDrive1UploadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
begin
  ProgressBar1.Position := Position;
  ProgressBar1.Max := Total;
end;
...
procedure TForm4.AdvDropBox1DownloadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
begin
  ProgressBar1.Position := Position;
  ProgressBar1.Max := Total;
...
procedure TForm4.AdvDropBox1UploadProgress(Sender: TObject; FileName: string; Position, Total: Int64);
begin
  ProgressBar1.Position := Position;
  ProgressBar1.Max := Total;
  if IsUploading then
...
procedure TForm4.btnSearchAndOpenClick(Sender: TObject);
var
  I: integer;
  aFile: string;
  bFound: boolean;
...
begin
  ...
  begin
    ...
    if MessageDlg('Are you sure to delete item: ' + ci.FileName, mtConfirmation, [mbYes, mbNo], 0) = mrYes
    then
    begin
      Storage.Delete(ci);
      ci.Free;
