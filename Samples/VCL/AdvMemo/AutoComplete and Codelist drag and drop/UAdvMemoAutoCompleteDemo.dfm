object Form1: TForm1
  Left = 0
  Top = 0
  Caption = 'AdvMemo AutoCompletion and Codelist Drag & Drop Demo'
  ClientHeight = 500
  ClientWidth = 982
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 147
      Height = 13
      Caption = 'List with autocompletion words'
    end
    ...
    object Label3: TLabel
      ...
      Height = 13
      Caption = 
        'Drag && drop blocks to memo or enter text and press Ctrl+Space t' +
        'o autocomplete'
    end
  end
