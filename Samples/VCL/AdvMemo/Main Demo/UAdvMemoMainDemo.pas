...
type
  TFAdvMemoDemo01 = class(TForm)
    ...
    procedure AdvMemo1BeforeAutoCompletion(Sender: TObject; AToken: string; var Show: Boolean);
    procedure AdvMemo1CancelAutoCompletion(Sender: TObject);
    procedure AdvMemo1Change(Sender: TObject);
    procedure AdvMemo1ClipboardAction(Sender: TObject; ClipboardAction: TMemoClipboardAction;
      var Allow: Boolean);
    ...
    procedure AdvMemo1FileDrop(Sender: TObject; FileName: string; var DefaultHandler: Boolean);
    procedure AdvMemo1Find(Sender: TObject);
    procedure AdvMemo1GetAutoCompletionList(Sender: TObject; AToken: string; AList: TStringList);
    procedure AdvMemo1GetAutoCompletionListIndex(Sender: TObject; AToken: string; AList: TStringList;
      var AIndex: Integer);
    procedure AdvMemo1GetParameterHint(Sender: TObject; AToken: string; var AParameterHint: string;
      var Handled: Boolean);
    ...
    procedure AdvMemo1HintForToken(Sender: TObject; X, Y: Integer; AValue: string; var AHint: string;
      var Show: Boolean);
    procedure AdvMemo1HintForWord(Sender: TObject; X, Y: Integer; AValue: string; var AHint: string;
      var Show: Boolean);
    procedure AdvMemo1InsertAutoCompletionEntry(Sender: TObject; var AEntry: string);
    ...
    procedure AdvMemo1LineBkColor(Sender: TObject; LineNo: Integer; var BkColor: TColor);
    procedure AdvMemo1MarkerAdded(LnNo: Integer; MarkerText: string);
    procedure AdvMemo1MarkerRemoved(LnNo: Integer);
    procedure AdvMemo1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure AdvMemo1MouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
    procedure AdvMemo1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure AdvMemo1OverwriteToggle(Sender: TObject; var Allow: Boolean);
    procedure AdvMemo1Replace(Sender: TObject);
    procedure AdvMemo1ScrollHint(Sender: TObject; ARow: Integer; var hintstr: string);
    ...
    procedure AdvMemo1StartDock(Sender: TObject; var DragObject: TDragDockObject);
    ...
    procedure AdvMemo1WordComplete(Sender: TObject; CurrentWord: string; var NewWord: string);
    procedure AdvCodeList1BlockClick(Sender: TObject; ACodeBlock: TCodeBlock);
    procedure AdvCodeList1BlockDblClick(Sender: TObject; ACodeBlock: TCodeBlock);
    procedure AdvCodeList1BlockDelete(Sender: TObject; ACodeBlock: TCodeBlock; var Allow: Boolean);
    ...
    procedure AdvCodeList1BlockRightClick(Sender: TObject; ACodeBlock: TCodeBlock);
    procedure AdvCodeList1Click(Sender: TObject);
    procedure AdvCodeList1ContextPopup(Sender: TObject; MousePos: TPoint; var Handled: Boolean);
    procedure AdvCodeList1DblClick(Sender: TObject);
    procedure AdvCodeList1DrawItem(Control: TWinControl; Index: Integer; Rect: TRect; State: TOwnerDrawState);
    ...
    procedure AdvCodeList1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure AdvCodeList1KeyPress(Sender: TObject; var Key: Char);
    procedure AdvCodeList1KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure AdvCodeList1MeasureItem(Control: TWinControl; Index: Integer; var Height: Integer);
    procedure AdvCodeList1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure AdvCodeList1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure AdvCodeList1StartDock(Sender: TObject; var DragObject: TDragDockObject);
    procedure AdvCodeList1StartDrag(Sender: TObject; var DragObject: TDragObject);
    ...
    procedure AdvMemo1CustomizeContextMenu(Sender: TObject; CurX, CurY: Integer; ContextMenu: TPopupMenu);
...
procedure TFAdvMemoDemo01.AdvCodeList1BlockClick(Sender: TObject; ACodeBlock: TCodeBlock);
begin
  LogEvent('TAdvCodeList.OnBlockClick');

end;

procedure TFAdvMemoDemo01.AdvCodeList1BlockDblClick(Sender: TObject; ACodeBlock: TCodeBlock);
begin
  LogEvent('TAdvCodeList.OnBlockDblClick');
end;

procedure TFAdvMemoDemo01.AdvCodeList1BlockDelete(Sender: TObject; ACodeBlock: TCodeBlock;
  var Allow: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvCodeList1BlockDropped(Sender: TObject; ACodeBlock: TCodeBlock);
begin
  LogEvent('TAdvCodeList.OnBlockDropped');
end;

procedure TFAdvMemoDemo01.AdvCodeList1BlockInsertFromClipboard(Sender: TObject; ACodeBlock: TCodeBlock);
begin
  LogEvent('TAdvCodeList.OnBlockInsertFromClipboard');
end;

procedure TFAdvMemoDemo01.AdvCodeList1BlockRightClick(Sender: TObject; ACodeBlock: TCodeBlock);
begin
...
procedure TFAdvMemoDemo01.AdvCodeList1ContextPopup(Sender: TObject; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvCodeList1DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AdvCodeList1.CodeBlocks.Add(AdvMemo1.Selection);
  AdvCodeList1.CodeBlocks[AdvCodeList1.CodeBlocks.Count - 1].ImageIndex := 0;
end;

procedure TFAdvMemoDemo01.AdvCodeList1DragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState;
  var Accept: Boolean);
begin
  Accept := (Source is TAdvMemo);
end;

procedure TFAdvMemoDemo01.AdvCodeList1DrawItem(Control: TWinControl; Index: Integer; Rect: TRect;
  State: TOwnerDrawState);
begin
  LogEvent('TAdvCodeList.OnDrawItem');
end;

procedure TFAdvMemoDemo01.AdvCodeList1EndDock(Sender, Target: TObject; X, Y: Integer);
begin
  LogEvent('TAdvCodeList.OnEndDock');
end;

procedure TFAdvMemoDemo01.AdvCodeList1EndDrag(Sender, Target: TObject; X, Y: Integer);
begin
...
procedure TFAdvMemoDemo01.AdvCodeList1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TFAdvMemoDemo01.AdvCodeList1KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  // LogEvent('TAdvCodeList.OnKeyUp');
end;

procedure TFAdvMemoDemo01.AdvCodeList1MeasureItem(Control: TWinControl; Index: Integer; var Height: Integer);
begin
  LogEvent('TAdvCodeList.OnMeasureItem');
  LogEvent('MeasureItem : ' + inttostr(Index) + 'Height : ' + inttostr(Height));
end;

procedure TFAdvMemoDemo01.AdvCodeList1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  LogEvent('TAdvCodeList.OnMouseDown');
end;

procedure TFAdvMemoDemo01.AdvCodeList1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  LogEvent('TAdvCodeList.OnMouseUp');
end;

procedure TFAdvMemoDemo01.AdvCodeList1StartDock(Sender: TObject; var DragObject: TDragDockObject);
begin
  LogEvent('TAdvCodeList.OnStartDock');
end;

procedure TFAdvMemoDemo01.AdvCodeList1StartDrag(Sender: TObject; var DragObject: TDragObject);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1BeforeAutoCompletion(Sender: TObject; AToken: string; var Show: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1ClipboardAction(Sender: TObject; ClipboardAction: TMemoClipboardAction;
  var Allow: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1CustomizeContextMenu(Sender: TObject; CurX, CurY: Integer;
...
procedure TFAdvMemoDemo01.AdvMemo1DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1DragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState;
  var Accept: Boolean);
begin
  Accept := True;
end;

procedure TFAdvMemoDemo01.AdvMemo1EndDock(Sender, Target: TObject; X, Y: Integer);
begin
  LogEvent('TAdvMemo.OnEndDock');
end;

procedure TFAdvMemoDemo01.AdvMemo1EndDrag(Sender, Target: TObject; X, Y: Integer);
begin
...
begin
  ...
  LogEvent('FindTextCount(''DropText'', [frDown]) =  ' + inttostr(AdvMemo1.FindTextCount('DropText',
    [frDown])));
  LogEvent('FindText(''DropText'', [frDown]) =  ' + inttostr(AdvMemo1.FindText('DropText', [frDown])));
  LogEvent('FindTextInMemo(''DropText'', [frDown]) =  ' + inttostr(AdvMemo1.FindTextInMemo('DropText',
    [frDown])));
  ...
  if AdvMemo1.WordIsURL('ttp://www.tmssoftware.com)') then
    showmessage('url ok'); // AdvMemo1.clear;
  if AdvMemo1.AddCodeFolding(17, 25) then
    showmessage('codefolding item created');
...
begin
  ...
  LogEvent('SelStartX, SelStartY, SelEndX, SelEndY :' + inttostr(AdvMemo1.SelStartX) + '/' +
    inttostr(AdvMemo1.SelStartY) + '/' + inttostr(AdvMemo1.SelEndX) + '/' + inttostr(AdvMemo1.SelEndY));
end;

procedure TFAdvMemoDemo01.AdvMemo1FileDrop(Sender: TObject; FileName: string; var DefaultHandler: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1GetAutoCompletionList(Sender: TObject; AToken: string; AList: TStringList);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1GetAutoCompletionListIndex(Sender: TObject; AToken: string;
  AList: TStringList; var AIndex: Integer);
begin
  LogEvent('TAdvMemo.OnGetAutoCompletionListIndex');
end;

procedure TFAdvMemoDemo01.AdvMemo1GetParameterHint(Sender: TObject; AToken: string;
...
procedure TFAdvMemoDemo01.AdvMemo1GutterDblClick(Sender: TObject; LineNo: Integer);
begin
  LogEvent('TAdvMemo.OnGutterDoubleClick');
end;

procedure TFAdvMemoDemo01.AdvMemo1GutterRightClick(Sender: TObject; LineNo: Integer);
begin
  LogEvent('TAdvMemo.OnGutterRightClick');
end;

procedure TFAdvMemoDemo01.AdvMemo1HintForToken(Sender: TObject; X, Y: Integer; AValue: string;
  var AHint: string; var Show: Boolean);
begin
  LogEvent('TAdvMemo.OnHintForToken');
end;

procedure TFAdvMemoDemo01.AdvMemo1HintForWord(Sender: TObject; X, Y: Integer; AValue: string;
  var AHint: string; var Show: Boolean);
begin
  LogEvent('TAdvMemo.OnHintForWord');
end;

procedure TFAdvMemoDemo01.AdvMemo1InsertAutoCompletionEntry(Sender: TObject; var AEntry: string);
begin
  LogEvent('TAdvMemo.OnInsertAutoCompletionEntry');
end;

procedure TFAdvMemoDemo01.AdvMemo1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  // LogEvent('TAdvMemo.OnKeyUp');
end;

procedure TFAdvMemoDemo01.AdvMemo1LineBkColor(Sender: TObject; LineNo: Integer; var BkColor: TColor);
begin
  // LogEvent('TAdvMemo.OnLineBkColor');
end;

procedure TFAdvMemoDemo01.AdvMemo1MarkerAdded(LnNo: Integer; MarkerText: string);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  LogEvent('TAdvMemo.OnMouseDown');
end;

procedure TFAdvMemoDemo01.AdvMemo1MouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
begin
  // LogEvent('TAdvMemo.OnMousMove');
end;

procedure TFAdvMemoDemo01.AdvMemo1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Integer);
begin
  LogEvent('TAdvMemo.OnMouseUp');
end;

procedure TFAdvMemoDemo01.AdvMemo1OverwriteToggle(Sender: TObject; var Allow: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1ScrollHint(Sender: TObject; ARow: Integer; var hintstr: string);
begin
  LogEvent('TAdvMemo.OnScrollHint');
end;

function TFAdvMemoDemo01.AdvMemo1SortAutoCompletionList(Sender: TObject; List: TStringList;
  Index1, Index2: Integer): Integer;
begin
...
procedure TFAdvMemoDemo01.AdvMemo1StartDock(Sender: TObject; var DragObject: TDragDockObject);
begin
  LogEvent('TAdvMemo.OnStartDock');
end;

procedure TFAdvMemoDemo01.AdvMemo1StartDrag(Sender: TObject; var DragObject: TDragObject);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1UndoChange(Sender: TObject; CanUndo, CanRedo: Boolean);
begin
...
procedure TFAdvMemoDemo01.AdvMemo1WordComplete(Sender: TObject; CurrentWord: string; var NewWord: string);
begin
...
begin
  ...
  AdvMemo1.AutoCorrect.OldValue.Add('teh');
  AdvMemo1.AutoCorrect.NewValue.Add('the');
  AdvMemo1.AutoCorrect.OldValue.Add('qiuck');
  AdvMemo1.AutoCorrect.NewValue.Add('quick');
  AdvMemo1.AutoCorrect.OldValue.Add('brovn');
  AdvMemo1.AutoCorrect.NewValue.Add('brown');
  AdvMemo1.AutoCorrect.OldValue.Add('ox');
  AdvMemo1.AutoCorrect.NewValue.Add('fox');
  AdvMemo1.AutoCorrect.OldValue.Add('jumbs');
  AdvMemo1.AutoCorrect.NewValue.Add('jumps');
  AdvMemo1.AutoCorrect.OldValue.Add('ovr');
  AdvMemo1.AutoCorrect.NewValue.Add('over');
  AdvMemo1.AutoCorrect.OldValue.Add('eth');
  AdvMemo1.AutoCorrect.NewValue.Add('the');
  AdvMemo1.AutoCorrect.OldValue.Add('lazie');
  AdvMemo1.AutoCorrect.NewValue.Add('lazy');
  AdvMemo1.AutoCorrect.OldValue.Add('frog');
  AdvMemo1.AutoCorrect.NewValue.Add('dog');
end;
...
procedure TFAdvMemoDemo01.Label4Click(Sender: TObject);
begin
