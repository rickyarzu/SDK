...
uses
  ...
  ioutils,
  Types,
  uMain in '..\..\..\..\lib\vcl-styles-utils\Demos\Vcl Styles Hooks Colors (Demo App)\uMain.pas' {FrmMain},
  Vcl.Themes,
  Vcl.Styles,
  Janua.Vcl.Styles.ControlColor in '..\..\..\src\VCL\Commons\Janua.Vcl.Styles.ControlColor.pas';
