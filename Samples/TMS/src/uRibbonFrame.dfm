object ribbonframe: Tribbonframe
  Left = 0
  Top = 0
  Width = 1054
  Height = 862
  ...
  object AdvToolBarPager1: TAdvToolBarPager
    ...
    Height = 149
    ActivePage = AdvPage1
    Caption.Caption = 'Dynamic ribbon/toolbar selection'
  ...
  inline TMSFrame11: TTMSFrame1
    ...
    inherited AdvVerticalPolyList2: TAdvPolyMenu
      List.Appearance.Down.Color = 16316664
      List.Appearance.Down.Opacity = 40
      List.Appearance.Down.BorderColor = clBtnFace
      List.Appearance.Down.Glow = gmNone
      List.Appearance.Disabled.Glow = gmNone
      List.Appearance.Hovered.Color = 16316664
      List.Appearance.Hovered.Opacity = 40
      List.Appearance.Hovered.BorderColor = clBtnFace
      List.Appearance.Hovered.Glow = gmNone
      List.Appearance.Selected.Color = 16119285
      List.Appearance.Selected.BorderColor = clBtnFace
      List.Appearance.Selected.GlowGradientColor = 14737632
