...
procedure TForm1.AdvGCalendar1ReceivedAccessToken(Sender: TObject);
begin
...
procedure TForm1.btUpdateCalendarClick(Sender: TObject);
var
  gcal: TGCalendar;
begin
...
procedure TForm1.btAddCalendarClick(Sender: TObject);
var
  gcal: TGCalendar;
  grem: TGReminder;
begin
...
procedure TForm1.btAddRemClick(Sender: TObject);
var
  li: TGCalendarItem;
  rem: TGReminder;
begin
...
procedure TForm1.btDeleteCalendarClick(Sender: TObject);
var
  buttonSelected: integer;
begin
  if ComboBox1.ItemIndex >= 0 then
...
procedure TForm1.btDelRemClick(Sender: TObject);
var
  li: TGCalendarItem;
  rem: TGReminder;
begin
...
procedure TForm1.cbColorsChange(Sender: TObject);
begin
  SetColor;
end;

procedure TForm1.cbRemClick(Sender: TObject);
var
  li: TGCalendarItem;
begin
  if ListView1.ItemIndex >= 0 then
...
begin
  ...
  AdvGCalendar1.PersistTokens.Key := '.\google.ini';
  AdvGCalendar1.PersistTokens.Section := 'tokens';
...
procedure TForm1.ListReminders(Item: TGCalendarItem);
var
  rem: string;
  I: Integer;
  li: TListItem;
...
procedure TForm1.ToggleReminders;
begin
