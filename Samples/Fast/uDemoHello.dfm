object Form1: TForm1
  ...
  OnShow = FormShow
  TextHeight = 15
  object pgcStatino: TscPageControl
    Left = 0
    Top = 49
    Width = 955
    Height = 704
    ...
    object tabReport: TscTabSheet
      Caption = 'tabReport'
      StyleKind = sctsTabSheet
      WallpaperIndex = -1
      CustomBackgroundImageIndex = -1
      DrawTabsWallpaper = False
      object frxprvwHello: TfrxPreview
        Left = 0
        Top = 0
        Width = 947
        Height = 674
  ...
  object frxpdfHello: TfrxPDFExport
    UseFileCache = True
    ShowProgress = True
  ...
  object frxrptHello: TfrxReport
    ...
    ReportOptions.CreateDate = 45000.369773402780000000
    ReportOptions.LastChange = 45000.369773402780000000
  ...
  object jsonStatino: TAdvJSONMemoStyler
