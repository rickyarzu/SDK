...
type
  TWebModuleGetMail = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TWebModuleGetMail;
...
procedure TWebModuleGetMail.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TGetMailController);
...
procedure TWebModuleGetMail.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
