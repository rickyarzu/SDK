...
uses
  ...
  PublicControllerU in '..\commons\PublicControllerU.pas',
  PrivateControllerU in '..\commons\PrivateControllerU.pas',
  AuthCriteriaU in '..\commons\AuthCriteriaU.pas';
