...
lConfigClaims:
  ...
  FMVC.AddMiddleware(TMVCJWTAuthenticationMiddleware.Create(TAuthCriteria.Create, 'this_is_my_secret',
    '/api/login', lConfigClaims, [TJWTCheckableClaim.ExpirationTime, TJWTCheckableClaim.NotBefore]));
end;
