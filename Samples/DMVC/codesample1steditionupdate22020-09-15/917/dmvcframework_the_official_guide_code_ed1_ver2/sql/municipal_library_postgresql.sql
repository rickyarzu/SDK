...
ALTER TABLE ONLY public.lendings DROP CONSTRAINT lendings_users_fk CASCADE;
ALTER TABLE ONLY public.lendings DROP CONSTRAINT lendings_customers_fk CASCADE;
ALTER TABLE ONLY public.lendings DROP CONSTRAINT lendings_books_fk CASCADE;
ALTER TABLE ONLY public.books DROP CONSTRAINT books_authors_fk CASCADE;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey CASCADE;
ALTER TABLE ONLY public.lendings DROP CONSTRAINT lendings_pkey CASCADE;
ALTER TABLE ONLY public.customers DROP CONSTRAINT customers_pkey CASCADE;
ALTER TABLE ONLY public.books DROP CONSTRAINT books_pkey CASCADE;
ALTER TABLE ONLY public.authors DROP CONSTRAINT authors_pkey CASCADE;
...
INSERT INTO public.authors (id, full_name, dob) VALUES (2, 'Charlotte Brontë', '1816-04-21');
