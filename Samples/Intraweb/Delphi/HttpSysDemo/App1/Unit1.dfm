object IWForm1: TIWForm1
  ...
  object IWLabel1: TIWLabel
    ...
    Caption = 
      'HttpSysDemo1 - This application requires IntraWeb 15 (recommende' +
  ...
  object IWMemo1: TIWMemo
    ...
    Lines.Strings = (
      ...
      ''
        ...
        ':'
      ''
      'http://127.0.0.1:8888/HSysApp1/'
      ''
      
        'Please notice that UrlBase is set to /HSysApp1/ (check your Serv' +
      ...
      ''
        ...
        'a different UrlBase (in that case, HSysApp2), which allows you t' +
