unit Janua.DMVC.SampleController;
...
type
  ...
  [MVCPath('/api')]
  TPhoenixReportController = class(TMVCController) 
  public
    [MVCPath]
...
function TPhoenixReportController.Index: String;
begin
  //use Context property to access to the HTTP request and response 
  Result := 'Hello DelphiMVCFramework World';
end;

function TPhoenixReportController.GetReversedString(const Value: String): String;
begin
  Result := System.StrUtils.ReverseString(Value.Trim);
end;

procedure TPhoenixReportController.OnAfterAction(Context: TWebContext; const AActionName: string); 
begin
  { Executed after each action }
  inherited;
end;

procedure TPhoenixReportController.OnBeforeAction(Context: TWebContext; const AActionName: string; var Handled: Boolean);
begin
...
//Sample CRUD Actions for a "People" entity
function TPhoenixReportController.GetPeople: TObjectList<TPerson>;
var
...
function TPhoenixReportController.GetPerson(ID: Integer): TPerson;
var
  lPeople: TObjectList<TPerson>;
begin
  lPeople := GetPeople;
...
function TPhoenixReportController.CreatePerson([MVCFromBody] Person: TPerson): IMVCResponse;
begin
...
function TPhoenixReportController.UpdatePerson(ID: Integer; [MVCFromBody] Person: TPerson): IMVCResponse;
begin
...
function TPhoenixReportController.DeletePerson(ID: Integer): IMVCResponse;
begin
