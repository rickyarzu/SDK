...
uses
  Janua.TMS.HtmlHelpDialog;

{$R *.DFM}

procedure TForm1.SpinEditScaleChange(Sender: TObject);
begin
  DayPlanner.Display.Displayscale := SpinEditScale.Value;
end;
...
begin
  ...
  begin
    planner2.Skin.LoadFromFile(OpenDialog1.FileName);
  end;
