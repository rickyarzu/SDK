object frmVCLJanuaNeonTest: TfrmVCLJanuaNeonTest
  Left = 0
  Top = 0
  Caption = 'Test Neon Library'
  ClientHeight = 669
  ClientWidth = 859
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    Width = 859
    Height = 620
    ActivePage = tbFNCMemo
    Align = alClient
    TabOrder = 1
    object tabJsonMemo: TTabSheet
      Caption = 'Memo Json'
    ...
    object tbFNCMemo: TTabSheet
      ...
      object TMSFNCWXJSONFormatter1: TTMSFNCWXJSONFormatter
        ...
        JSON.Strings = (
          '{"age":24}')
        Theme = ftLight
        OpenAtDepth = 10.000000000000000000
        Appearance.FontName = 'Arial'
      end
    end
    object tabSynEdit: TTabSheet
      Caption = 'Syn Edit'
      ImageIndex = 2
    end
    object tabFNCJson: TTabSheet
      Caption = 'FNC Json'
      ImageIndex = 3
    end
  end
