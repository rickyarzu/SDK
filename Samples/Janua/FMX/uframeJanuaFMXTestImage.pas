...
procedure TframFMXImageDraw.btnPgImageClick(Sender: TObject);
begin
...
procedure TframFMXImageDraw.imgCarMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
  X, Y: Single);
var
  MyRect: TRectF;
  Point: TPointF;
