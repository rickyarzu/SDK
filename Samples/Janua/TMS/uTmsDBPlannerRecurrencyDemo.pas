...
{*************************************************************************}
unit uTmsDBPlannerRecurrencyDemo;
...
type
  TfrmTMSDemosDBPlannerRecurrencyDemo = class(TForm)
...
var
  frmTMSDemosDBPlannerRecurrencyDemo: TfrmTMSDemosDBPlannerRecurrencyDemo;

implementation

{$R *.dfm}

procedure TfrmTMSDemosDBPlannerRecurrencyDemo.FormCreate(Sender: TObject);
begin
...
procedure TfrmTMSDemosDBPlannerRecurrencyDemo.RecurrEditClick(Sender: TObject);
begin
...
procedure TfrmTMSDemosDBPlannerRecurrencyDemo.DBDaySource1GetResourceName(Sender: TObject;
  ResourceIndex: Integer; var ResourceName: String);
begin
  ResourceName := 'Resource ' + IntToStr(ResourceIndex);
end;

procedure TfrmTMSDemosDBPlannerRecurrencyDemo.DBPlanner1PlannerPrev(Sender: TObject);
var
  dt: TDateTime;
begin
  UpdateLabel;
...
procedure TfrmTMSDemosDBPlannerRecurrencyDemo.DBPlanner1PlannerNext(Sender: TObject);
var
  dt: tdatetime;
begin
  UpdateLabel;
...
procedure TfrmTMSDemosDBPlannerRecurrencyDemo.ComboBox1Change(Sender: TObject);
begin
...
procedure TfrmTMSDemosDBPlannerRecurrencyDemo.UpdateLabel;
begin
  case combobox1.itemindex of
...
procedure TfrmTMSDemosDBPlannerRecurrencyDemo.DBPeriodSource1GetResourceName(Sender: TObject;
  ResourceIndex: Integer; var ResourceName: String);
begin
  ResourceName := 'Resource ' + IntToStr(ResourceIndex);
end;

procedure TfrmTMSDemosDBPlannerRecurrencyDemo.DBDaySource2FieldsToItem(Sender: TObject; Fields: TFields;
  Item: TPlannerItem);
begin
