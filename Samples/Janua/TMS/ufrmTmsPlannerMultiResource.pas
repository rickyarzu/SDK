...
uses
  ...
  ComCtrls, ToolWin, XPMan, System.ImageList;
...
procedure TfrmTmsDemosPlannerMultiResource.DBTimeLineSource1ItemToFields(Sender: TObject;
  Fields: TFields; Item: TPlannerItem);
begin
...
procedure TfrmTmsDemosPlannerMultiResource.DBPlanner1ItemInsert(Sender: TObject; Position, FromSel,
  FromSelPrecise, ToSel, ToSelPrecise: Integer);
begin
...
procedure TfrmTmsDemosPlannerMultiResource.DBPeriodSource1ItemToFields(Sender: TObject;
  Fields: TFields; Item: TPlannerItem);
begin
  Fields.FieldByName('COLOR').AsInteger := Integer(Item.Color);
  Fields.FieldByName('CAPTION').AsBoolean := Item.CaptionType = ctTime;
...
procedure TfrmTmsDemosPlannerMultiResource.DBPeriodSource1FieldsToItem(Sender: TObject;
  Fields: TFields; Item: TPlannerItem);
begin
