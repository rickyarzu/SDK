...
{*************************************************************************}
unit ufrmTmsPlannerWaitListMontly;
...
type
  TfrmTmsDemosPlannerWaitListMontly = class(TForm)
...
var
  frmTmsDemosPlannerWaitListMontly: TfrmTmsDemosPlannerWaitListMontly;

implementation

{$R *.dfm}

procedure TfrmTmsDemosPlannerWaitListMontly.PlannerMonthView1DragDrop(Sender, Source: TObject; X,
  Y: Integer);
var
  dt: TDateTime;
  plIt: TPlannerItem;
...
procedure TfrmTmsDemosPlannerWaitListMontly.PlannerMonthView1DragOver(Sender, Source: TObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := (Source is TPlannerWaitList);
end;

procedure TfrmTmsDemosPlannerWaitListMontly.PlannerWaitList1DragOver(Sender, Source: TObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := (Source is TPlannerMonthView);
end;

procedure TfrmTmsDemosPlannerWaitListMontly.PlannerWaitList1DragDrop(Sender, Source: TObject; X,
  Y: Integer);
begin
...
procedure TfrmTmsDemosPlannerWaitListMontly.Button1Click(Sender: TObject);
begin
