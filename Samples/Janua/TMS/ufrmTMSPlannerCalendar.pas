...
uses
  ...
  AdvEdit, AdvEdBtn, PlannerDatePicker, DBPlannerDatePicker;

type
  TfrmTMSDemosPlannerCalendar = class(TForm)
    ...
    DBPlannerDatePicker1: TDBPlannerDatePicker;
...
var
  frmTMSDemosPlannerCalendar: TfrmTMSDemosPlannerCalendar;

implementation

{$R *.dfm}

procedure TfrmTMSDemosPlannerCalendar.PlannerCalendar1DaySelect(Sender: TObject;
  SelDate: TDateTime);
begin
  Edit1.Text := DateTimeToStr(SelDate);
end;

procedure TfrmTMSDemosPlannerCalendar.FormCreate(Sender: TObject);
begin
