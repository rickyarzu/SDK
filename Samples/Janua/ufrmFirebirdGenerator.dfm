object frmVCLFirebirdGenerator: TfrmVCLFirebirdGenerator
  ...
  object pnlMain: TPanel
    ...
    Align = alTop
    TabOrder = 1
    object adeSourceDirectory: TAdvDirectoryEdit
      Left = 343
      Top = 19
      Width = 370
      Height = 23
      ...
      ShortCut = 0
      TabOrder = 0
      Text = 'D:\GitHub\SDK\src\januacore\orm'
      Visible = True
      Version = '1.7.1.3'
    ...
    object ckbOnlyCustom: TCheckBox
      Left = 719
      Top = 22
      Width = 201
      Height = 17
      Caption = 'Save Only Customs'
      TabOrder = 1
    end
