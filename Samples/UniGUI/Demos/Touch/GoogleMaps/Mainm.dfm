object MainmForm: TMainmForm
  ...
  object UnimHTMLFrame1: TUnimHTMLFrame
    ...
    ClientEvents.ExtEvents.Strings = (
        ...
        'afterupdatehtml=function afterupdatehtml(sender, eOpts)'#13#10'{     '#13 +
        #10'   var latlng = new google.maps.LatLng(0.0, 0.0);'#13#10'   var myOpt' +
        'ions = {'#13#10'      zoom: 1,  '#13#10'      center: latlng,'#13#10'      mapType' +
        'Id: google.maps.MapTypeId.ROADMAP'#13#10'    };'#13#10'    '#13#10'    var umap = ' +
        'document.getElementById("uni_map_canvas");'#13#10'    var map = new go' +
        'ogle.maps.Map(umap, myOptions);'#13#10'    googleMap = map;'#13#10#13#10'    goo' +
        'gle.maps.event.addListener(map, '#39'zoom_changed'#39', '#13#10'       functio' +
        'n() {'#13#10'         MainmForm.UnimSlider1.setValue(this.getZoom()); ' +
        #13#10'       }'#13#10'    );'#13#10#13#10'    google.maps.event.addListener(map, '#39'ti' +
        'lesloaded'#39', '#13#10'       function(e) {'#13#10'         ajaxRequest(MainmFo' +
        'rm.UnimHTMLFrame1, '#13#10'                     '#39'loaded'#39', []);'#13#10'      ' +
        ' }'#13#10'    );'#13#10'}'
      
        'resize=function resize(sender, eOpts)'#13#10'{     '#13#10' if (typeof googl' +
        'eMap != '#39'undefined'#39') {'#13#10'      google.maps.event.trigger(googleMa' +
        'p, '#39'resize'#39');'#13#10'  }'#13#10'}'
