//AllFeatures: FastReport,FastReport - HTML to Image,icon-framed-panels
unit Main;
...
uses
  ...
  uniThreadTimer, Menus, uniMainMenu, uniMemo, uniHTMLMemo;
...
begin
  ...
  begin
    ...
    UniForm1.HTMLTemplate := UniHTMLMemo1.Text;
    UniForm1.ShowModal;
  end
  else
  begin
