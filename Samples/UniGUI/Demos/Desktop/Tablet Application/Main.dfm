    ...
    object UniTabSheet1: TUniTabSheet
      ...
      object UniMemo1: TUniMemo
        ...
        Lines.Strings = (
            ...
            'This application is a uniGUI desktop app which can also be used ' +
            'in table devices.'
          ''
          
            'To optimize a desktop app for tablet devices, in MainModule->Des' +
            'ktopViewport properties are set as following:'
          ''
          'InitialScale = 1'
          'MaximumScale = 1'
          'UserScalable = False')
