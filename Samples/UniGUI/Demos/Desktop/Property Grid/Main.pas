//AllFeatures: Property Grid,Basic Demo,icon-tabular-pivot-grid
unit Main;
...
uses
  ...
  Menus, uniMainMenu, uniMultiItem, uniComboBox, uniPanel, uniPropertyGrid,
  uniLabel, uniListBox, uniProgressBar, uniPageControl;
...
uses
  uniGUIVars, MainModule, uniGUIApplication, uniButton, uniEdit, uniMemo,
  UniRadioGroup, UniTreeView, uniStringGrid;
...
procedure TMainForm.UniContainerPanel1MouseDown(Sender: TObject;
