//AllFeatures: Maps,Google Map,icon-gmap-panel
unit Main;
...
uses
  ...
  uniSpinEdit, uniTrackBar, uniLabel, uniButton, uniBitBtn, uniSpeedButton, DB,
  DBClient, uniBasicGrid, uniDBGrid, uniEdit, uniDBEdit;
