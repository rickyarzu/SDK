...
uses
  uniGUIMainModule, SysUtils, Classes, DB, DBClient, ADODB, uniGUITypes;
...
var
  //for ADOConnection
  S1, S2, S3, S4, sPath, SrcFile, CacheFile1, CacheFile2, CacheFile3, CacheFile4:string;
  //for CompanyClientDataSet
  I: Integer;
  IndexnameAsc : string;
  IndexnameDes : string;
begin
