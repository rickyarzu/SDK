// Row Grouping & Summary = Grids
unit GridsRowGroupingSummary;
{$I uniCompilers.inc}
...
uses
  ...
  uniGUIClasses, uniGUIFrame, uniDBNavigator, DB, uniGUIBaseClasses,
  uniBasicGrid, uniDBGrid, MainModule, uniPanel, ServerModule,
  DBClient;

type
  TUniGridsRowGroupingSummary = class(TUniFrame)
...
procedure TUniGridsRowGroupingSummary.ClientDataSet1NewRecord(DataSet: TDataSet);
begin
 DataSet.FieldByName('unitprice').AsFloat:=5.0;
end;

procedure TUniGridsRowGroupingSummary.UniDBGrid1ColumnSort(Column: TUniDBGridColumn;
  Direction: Boolean);
begin
...
procedure TUniGridsRowGroupingSummary.UniDBGrid1ColumnSummary(
...
procedure TUniGridsRowGroupingSummary.UniDBGrid1ColumnSummaryResult(
...
procedure TUniGridsRowGroupingSummary.UniFrameCreate(Sender: TObject);
var
  I : Integer;
begin
...
initialization
   RegisterClass(TUniGridsRowGroupingSummary);
end.
