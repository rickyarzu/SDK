...
type
  ...
  public
    { Public declarations }
    procedure ApplyRange(const Range1, Range2: Integer);
  end;
...
procedure TDetailFrame.ApplyRange(const Range1, Range2: Integer);
begin
  ClientDataSet2.SetRangeStart;
  ClientDataSet2.FieldByName('custno').AsInteger := Range1;
  ClientDataSet2.FieldByName('SaleDate').AsDateTime := 0;
  ClientDataSet2.SetRangeEnd;
  ClientDataSet2.FieldByName('custno').AsInteger := Range2;
