...
uses
  ...
  uniHTMLFrame, UniFSGoogleChart, uniButton, uniBitBtn, uniBasicGrid, uniDBGrid,
  Data.DB, Datasnap.DBClient, uniMemo, uniSplitter,
  uniPageControl, uniLabel, UniFSButton, uniImage;

type
  TMainForm = class(TUniForm)
    pgcMaster: TUniPageControl;
    pnlMenu: TUniPanel;
    btnGeoChart: TUniFSButton;
    btnPieChart: TUniFSButton;
    btnGauge: TUniFSButton;
    btnAreaChart: TUniFSButton;
    btnBarChart: TUniFSButton;
    btnBubbleChart: TUniFSButton;
    btnLineChart: TUniFSButton;
    btnLineChartValuesCurrency: TUniFSButton;
    lbl1: TUniLabel;
    imgFalconSistemas: TUniImage;
    lblVersion: TUniLabel;
    procedure btnGeoChartClick(Sender: TObject);
...
procedure TMainForm.btnGeoChartClick(Sender: TObject);
begin
...
begin
  lblVersion.Caption := 'Component Version: '+UniFSGoogleChart.PackageVersion;
end;
