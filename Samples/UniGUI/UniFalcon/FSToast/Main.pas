...
uses
  ...
  uniGUIClasses, uniGUIRegClasses, uniGUIForm, uniGUIBaseClasses, UniFSToast,
  uniButton, uniLabel, uniPanel, Vcl.Imaging.pngimage, uniImage, uniBitBtn;
