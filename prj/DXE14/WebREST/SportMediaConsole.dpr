...
uses
  ...
  Web.WebReq,
  Web.WebBroker,
  Janua.Web.ServerConst in '..\..\..\src\januawebrest\Janua.Web.ServerConst.pas',
  Janua.Web.dmWebBrokerSession in '..\..\..\src\januawebrest\Janua.Web.dmWebBrokerSession.pas' {dmJanuaWebBrokerSession: TDataModule},
  Janua.Web.WebModuleFactory in '..\..\..\src\januawebrest\Janua.Web.WebModuleFactory.pas' {WebModuleFactory: TWebModule},
  SMEConf in '..\..\..\src\januacore\custom\SMEConf.pas';
...
begin
  ...
  begin
    ...
    begin
      ...
      udmJanuaWebBrokerSession.InitializeCloud;
    end
    else
