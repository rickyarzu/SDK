...
uses
  ...
  Janua.CarService.UniGUI.LoginForm
    in '..\..\..\src\UniGUI\CarService\Janua.CarService.UniGUI.LoginForm.pas' {frmCarServiceUniGUILogin: TUniLoginForm} ,
  Janua.CarService.UniGUIApplication
    in '..\..\..\src\UniGUI\CarService\Janua.Carservice.UniGUIApplication.pas',
  Janua.UniGUI.BackofficeMainForm
    in '..\..\..\src\UniGUI\CarService\Janua.UniGUI.BackofficeMainForm.pas' {frmUniGUIMainBackoffice: TUniForm};
