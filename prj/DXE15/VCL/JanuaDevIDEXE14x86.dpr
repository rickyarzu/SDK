...
uses
  ...
  Janua.CarService.Vcl.frmSettings
    in '..\..\..\src\VCL\CarService\Janua.CarService.VCL.frmSettings.pas' {frmVCLCarServiceSettings} ,
  ...
  Janua.Vcl.Cloud.FrameLandingMessageConfig
    in '..\..\..\src\VCL\Cloud\Janua.VCL.Cloud.FrameLandingMessageConfig.pas' {FrameVCLLandingMessageConfig: TFrame} ,
  Janua.Vcl.Cloud.frameMailMessageConfig
    in '..\..\..\src\VCL\Cloud\Janua.VCL.Cloud.frameMailMessageConfig.pas' {frameVCLMailMessageConfig: TFrame} ,
  ...
  Janua.Vcl.frameHtmlEditor
    in '..\..\..\src\VCL\Commons\Janua.VCL.frameHtmlEditor.pas' {frameHTMLEditor: TFrame} ,
  ...
  Janua.Framework.JormGenerator.Postgres
    in '..\..\..\src\januaunidac\datamodules\Janua.Framework.JormGenerator.Postgres.pas' {dmPgFrameworkJormGenerator: TDataModule} ,
  Janua.Framework.JormGenerator.Firebird
    in '..\..\..\src\januaunidac\datamodules\Janua.Framework.JormGenerator.Firebird.pas' {dmPgFrameworkJormGenerator1: TDataModule};
