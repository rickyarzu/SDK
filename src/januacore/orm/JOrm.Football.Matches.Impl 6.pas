...
begin
  ...
  // Campi Calcolati e Campi Read Only
  FHomeTeamName := TJanuaOrmFactory.CreateSmallintField('home_team', 'home_team');
  FHomeTeamNameIndex := AddField(FHomeTeamName);
  FVisitorsTeamName := TJanuaOrmFactory.CreateSmallintField('visitors_team', 'visitors_team');
  FVisitorsTeamNameIndex := AddField(FVisitorsTeamName);
  FHomeTeamLogo := TJanuaOrmFactory.CreateSmallintField('home_team_logo', 'home_team_logo');
  FHomeTeamLogoIndex := AddField(FHomeTeamLogo);
  FVisitorsTeamLogo := TJanuaOrmFactory.CreateSmallintField('visitors_team_logo', 'visitors_team_logo');
