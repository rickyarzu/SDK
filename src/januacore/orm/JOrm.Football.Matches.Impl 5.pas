...
begin
  ...
  // Campi Calcolati e Campi Read Only
  FHomeTeamName := TJanuaOrmFactory.CreateSmallintField('home_team_Name', 'home_team_Name');
  FHomeTeamNameIndex := AddField(FHomeTeamName);
  FVisitorsTeamName := TJanuaOrmFactory.CreateSmallintField('visitors_team_Name', 'visitors_team_Name');
