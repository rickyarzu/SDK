unit JOrm.Items.Definitions.Custom.Intf;
...
type
  ...
  ICustomItemDefinition = interface(IJanuaRecord)
    ['{0126E3D4-9BC2-48C9-8942-CA3A526BE79E}']
  ...
  ICustomItemDefinitions = interface(IJanuaRecordSet)
    ['{346C56C9-4A31-437C-832D-D6B87661F617}']
    function GetDbSchemaId: IJanuaField;
    procedure SetDbSchemaId(const Value: IJanuaField);
    property DbSchemaId: IJanuaField read GetDbSchemaId write SetDbSchemaId;
    function GetId: IJanuaField;
