...
uses Janua.Orm.Intf, Janua.Orm.Impl, Janua.Core.Types, JOrm.Cloud.GoogleCalendarEvents.Custom.Intf;
...
type
  ...
  private
    ...
    FAttendees: IJanuaField;
    FReminders: IJanuaField;
  protected
...
begin
  ...
  FUsedefaultreminders := AddCreateField(TJanuaFieldType.jptString, 'usedefaultreminders',
    'usedefaultreminders');
  FSendnotifications := AddCreateField(TJanuaFieldType.jptString, 'sendnotifications', 'sendnotifications');
  FIsallday := AddCreateField(TJanuaFieldType.jptString, 'isallday', 'isallday');
  FAttendees := AddCreateField(TJanuaFieldType.jptText, 'attendees', 'attendees');
  FReminders := AddCreateField(TJanuaFieldType.jptText, 'reminders', 'reminders');
end;
...
function TCustomGoogleCalendarEvent.GetAttendees: IJanuaField;
begin
  Result := FAttendees;
end;

function TCustomGoogleCalendarEvent.GetReminders: IJanuaField;
begin
  Result := FReminders;
end;
...
function TCustomGoogleCalendarEvents.GetAttendees: IJanuaField;
begin
  Result := self.CustomGoogleCalendarEvent.Attendees;
end;

function TCustomGoogleCalendarEvents.GetReminders: IJanuaField;
begin
  Result := self.CustomGoogleCalendarEvent.Reminders;
end;
