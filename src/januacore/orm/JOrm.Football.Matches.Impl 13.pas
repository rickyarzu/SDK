...
begin
  ...
  begin
    ...
    FButtons.AsString := '<a style="color:#fff;" class="m-badge  m-badge--info m-badge--wide">Tab</a>' +
      sLineBreak + '<a style="color:#fff;" class="m-badge  m-badge--danger m-badge--wide">Video</a>';
...
begin
  inherited;
  SetEntity(TJanuaEntity.FtMatches);
  self.FPrefix := 'fcld';
