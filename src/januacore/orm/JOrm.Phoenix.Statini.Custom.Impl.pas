...
{TCustomStatino}
  ...
  begin
    ...
    FOrarioAperturaDal1:= AddCreateField(TJanuaFieldType.jptDateTime, 'orario_apertura_dal1', 'orario_apertura_dal1');
    FOrarioAperturaDal2:= AddCreateField(TJanuaFieldType.jptDateTime, 'orario_apertura_dal2', 'orario_apertura_dal2');
    FOrarioAperturaAl1:= AddCreateField(TJanuaFieldType.jptDateTime, 'orario_apertura_al1', 'orario_apertura_al1');
    FOrarioAperturaAl2:= AddCreateField(TJanuaFieldType.jptDateTime, 'orario_apertura_al2', 'orario_apertura_al2');
    ...
    FGenerazioneAutomatica:= AddCreateField(TJanuaFieldType.jptInteger, 'generazione_automatica', 'generazione_automatica');
    FTecnicoIntervento:= AddCreateField(TJanuaFieldType.jptInteger, 'tecnico_intervento', 'tecnico_intervento');
    ...
    FEsportatoSuMobile:= AddCreateField(TJanuaFieldType.jptString, 'esportato_su_mobile', 'esportato_su_mobile');
    ...
    FVerbaleProvaDinamica:= AddCreateField(TJanuaFieldType.jptBlob, 'verbale_prova_dinamica', 'verbale_prova_dinamica');
    ...
    FIgnoraEvidenziazione:= AddCreateField(TJanuaFieldType.jptString, 'ignora_evidenziazione', 'ignora_evidenziazione');
    FAnnullatoDaTablet:= AddCreateField(TJanuaFieldType.jptString, 'annullato_da_tablet', 'annullato_da_tablet');
    FMobilewarnNuovaAttrezzatura:= AddCreateField(TJanuaFieldType.jptString, 'mobilewarn_nuova_attrezzatura', 'mobilewarn_nuova_attrezzatura');
    FMobilewarnOrdinariaRitirata:= AddCreateField(TJanuaFieldType.jptString, 'mobilewarn_ordinaria_ritirata', 'mobilewarn_ordinaria_ritirata');
    FMobilewarnNOrdinControllata:= AddCreateField(TJanuaFieldType.jptString, 'mobilewarn_n_ordin_controllata', 'mobilewarn_n_ordin_controllata');
    FMobilewarnSmaltimento:= AddCreateField(TJanuaFieldType.jptString, 'mobilewarn_smaltimento', 'mobilewarn_smaltimento');
    FStatoLavorazione:= AddCreateField(TJanuaFieldType.jptString, 'stato_lavorazione', 'stato_lavorazione');
    FDataChiusuraDaServer:= AddCreateField(TJanuaFieldType.jptDate, 'data_chiusura_da_server', 'data_chiusura_da_server');
    ...
    FMobilewarnNonEseguiti:= AddCreateField(TJanuaFieldType.jptString, 'mobilewarn_non_eseguiti', 'mobilewarn_non_eseguiti');
