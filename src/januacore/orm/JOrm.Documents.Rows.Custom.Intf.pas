unit JOrm.Documents.Rows.Custom.Intf;
...
type
  ...
  ICustomDocRow = interface(IJanuaRecord)
    ['{BD378329-4AF7-4BA2-8A94-7E615106819F}']
  ...
  ICustomDocRows = interface(IJanuaRecordSet)
    ['{F46FC12B-2DEF-4581-AABD-B70A719E353C}']
    function GetId: IJanuaField;
    procedure SetId(const Value: IJanuaField);
    property Id: IJanuaField read GetId write SetId;
    function GetDocId: IJanuaField;
