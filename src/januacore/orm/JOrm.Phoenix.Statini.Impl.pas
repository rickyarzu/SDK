...
uses Janua.Orm.Intf, Janua.Orm.Impl, Janua.Core.Types, JOrm.Phoenix.Statini.Intf,
  JOrm.Phoenix.Statini.Custom.Impl;
...
type
  ...
  TStatinoFactory = class
    ...
    class function CreateRecordset(const aName: string;
      const aLocalStorage, aRemoteStorage: IJanuaRecordSetStorage): IStatini; overload;
...
class function TStatinoFactory.CreateRecordset(const aName: string;
  const aLocalStorage, aRemoteStorage: IJanuaRecordSetStorage): IStatini;
begin
