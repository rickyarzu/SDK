...
type
  ...
  private
    ...
    procedure SetWhereDestination(const Value: string);
  public
  ...
  public
    ...
    property WhereDestination: string read FWhereDestination write SetWhereDestination;
  end;
...
begin
  ...
  FWhereDestination := aWhereDestination;
end;
...
procedure TJanuaPageRecord.SetWhereClause(const Value: string);
begin
  FWhereClause := Value;
end;

procedure TJanuaPageRecord.SetWhereDestination(const Value: string);
begin
  FWhereDestination := Value;
end;
