...
function get_statustext(lp: THandle; statuscode: integer): PAnsiChar; stdcall; external LPSOLVELIB name 'get_statustext';
...
function set_lp_name(lp: THandle; lpname: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'set_lp_name';
function get_lp_name(lp: THandle): PAnsiChar; stdcall; external LPSOLVELIB name 'get_lp_name';
...
function set_BFP(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'set_BFP';
function read_XLI(xliname, modelname, dataname, options: PAnsiChar; verbose: integer): THandle; stdcall; external LPSOLVELIB name 'read_XLI';
function write_XLI(lp: THandle; filename, options: PAnsiChar; results: boolean): boolean; stdcall; external LPSOLVELIB name 'write_XLI';
...
function set_XLI(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'set_XLI';
...
function str_set_obj_fn(lp: THandle; row_string: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'str_set_obj_fn';
...
function str_add_lag_con(lp: THandle; row_string: PAnsiChar; con_type: integer; rhs: double): boolean; stdcall; external LPSOLVELIB name 'str_add_lag_con';
...
function str_set_rh_vec(lp: THandle; rh_string: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'str_set_rh_vec';
...
function str_add_column(lp: THandle; col_string: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'str_add_column';
...
function add_SOS(lp: THandle; name: PAnsiChar; sostype: integer; priority: integer; count: integer; sosvars: PIntArray; weights: PFloatArray): integer; stdcall; external LPSOLVELIB name 'add_SOS';
function is_SOS_var(lp: THandle; column: integer): boolean; stdcall; external LPSOLVELIB name 'is_SOS_var';
function set_row_name(lp: THandle; row: integer; new_name: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'set_row_name';
function get_row_name(lp: THandle; row: integer): PAnsiChar; stdcall; external LPSOLVELIB name 'get_row_name';
function get_origrow_name(lp: THandle; row: integer): PAnsiChar; stdcall; external LPSOLVELIB name 'get_origrow_name';
function set_col_name(lp: THandle; column: integer; new_name: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'set_col_name';
function get_col_name(lp: THandle; column: integer): PAnsiChar; stdcall; external LPSOLVELIB name 'get_col_name';
function get_origcol_name(lp: THandle; column: integer): PAnsiChar; stdcall; external LPSOLVELIB name 'get_origcol_name';
...
function read_MPS(filename: PAnsiChar; options: integer): THandle; stdcall; external LPSOLVELIB name 'read_MPS';
function read_mps(stream: PInteger; options: integer): THandle; stdcall; external LPSOLVELIB name 'read_mps';
function read_freeMPS(filename: PAnsiChar; options: Integer): THandle; stdcall; external LPSOLVELIB name 'read_freeMPS';
function read_freemps(filename: Pinteger; options: Integer): THandle; stdcall; external LPSOLVELIB name 'read_freemps';
function write_freemps(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'write_freemps';
...
function read_basis(lp: THandle; filename, info: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'read_basis';
function write_basis(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'write_basis';
function write_mps(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'write_mps';
function write_MPS(lp: THandle; output: PInteger): boolean; stdcall; external LPSOLVELIB name 'write_MPS';
function write_lp(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'write_lp';
function write_LP(lp: THandle; filename: PInteger): boolean; stdcall; external LPSOLVELIB name 'write_LP';
function read_lp(filename: PInteger; verbose: integer; lp_name: PAnsiChar): THandle; stdcall; external LPSOLVELIB name 'read_lp';
function read_LP(filename: PAnsiChar; verbose: integer; lp_name: PAnsiChar): THandle; stdcall; external LPSOLVELIB name 'read_LP';
...
procedure print_str(lp: THandle; str: PAnsiChar); stdcall; external LPSOLVELIB name 'print_str';
procedure set_outputstream(lp: THandle; stream: Pointer); stdcall; external LPSOLVELIB name 'set_outputstream';
function set_outputfile(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'set_outputfile';
...
function print_debugdump(lp: THandle; filename: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'print_debugdump';
...
function get_nameindex(lp: THandle; varname: PAnsiChar; isrow: boolean): Integer; stdcall; external LPSOLVELIB name 'get_nameindex';
...
function write_params(lp: THandle; filename, options: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'write_params';
function read_params(lp: THandle; filename, options: PAnsiChar): boolean; stdcall; external LPSOLVELIB name 'read_params';
