...
TJanuaApplication.ReleaseDate := '2022-09-05';
TJanuaApplication.AppName := 'Dilettantissimo TV';
...
begin
  TJanuaApplication.AppName := 'Dil Manager';
...
begin
  TJanuaApplication.AppName := 'Dilettantissimo Manager';
