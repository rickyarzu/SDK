...
type
  ...
  Async = class sealed
  public
    class function Run<T>(Task: TAsyncBackgroundTask<T>; Success: TAsyncSuccessCallback<T>;
...
class function Async.Run<T>(Task: TAsyncBackgroundTask<T>; Success: TAsyncSuccessCallback<T>;
