unit JanuaDocumentRow;

interface

uses
  SysUtils, Classes, Janua.Core.Classes, Janua.Core.Functions, JanuaDBRow;

type
  TJanuaDocumentRow = class(TComponent)
  private
    FFuel: Double;
    FPort_Dues: Double;
...
procedure Register;
begin
  RegisterComponents('Januaproject', [TJanuaDocumentRow]);
end;
...
begin
   ...
   FNetAmount := FPrice * qtyPrice * ((100-FPriceDiscount)/100)
                     * ((100-FDocDiscount)/100) * ((100-FExtraDiscount)/100);
