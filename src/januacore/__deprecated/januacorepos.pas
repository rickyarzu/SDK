...
uses
{$ifndef fpc}
  System.Classes, System.SysUtils, Janua.core.Functions, Janua.core.CustomControls
{$else}
  Classes, SysUtils, JanuaCoreFunctions, JanuaCoreCustomControls
{$endif}
...
type
  ...
  private
    ...
    FPromoItemID: int64;
    FToday: TDateTime;
    FJanuaDialog: TJanuaCustomDialog;
    ...
    procedure SetJanuaDialog(const Value: TJanuaCustomDialog);
  ...
  published
    ...
    property MinimumExpenseRequired: Double read FMinimumExpenseRequired
      write SetMinimumExpenseRequired;
    ...
    property JanuaDialog: TJanuaCustomDialog read FJanuaDialog write SetJanuaDialog;
  end;
...
begin
  ...
  FOutputMessage := StringReplace(FOutputMessage, '<MINIMUMEXPENSE>',
...
procedure TJanuaPromo.SetJanuaDialog(const Value: TJanuaCustomDialog);
begin
  FJanuaDialog := Value;
end;
...
begin
  if Assigned(FJanuaDialog) and FDiscountEnabled then
    FJanuaDialog.JShowMessage(FPromoOutputMessage, '', '')
  else
    FJanuaDialog.JShowMessage(FOutputMessage, '', '');
end;
