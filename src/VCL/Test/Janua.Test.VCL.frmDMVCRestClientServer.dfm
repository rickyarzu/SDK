object frmTestRestClientServer: TfrmTestRestClientServer
  Left = 0
  Top = 0
  Caption = 'REST Client Server'
  ClientHeight = 607
  ClientWidth = 1230
  Color = clBtnFace
  ...
  object pnlHead: TPanel
    ...
    DesignSize = (
      1230
      57)
    object lbConnectionSettings: TLabel
      Left = 4
      Top = 7
      Width = 107
      Height = 15
    ...
    object cboRestUrl: TJvDBLookupCombo
      Left = 4
      Top = 28
      Width = 373
      Height = 22
      ...
      LookupField = 'jguid'
      LookupDisplay = 'ConnectionUrl'
      LookupSource = dsConnections
      TabOrder = 4
    end
    object edListeningPort: TSpinEdit
      Left = 463
      Top = 27
      Width = 67
      Height = 24
  ...
  object PageControl1: TPageControl
    ...
    object tabJson: TTabSheet
      Caption = 'Json JWT Log'
      object MemJWTJsonLog: TAdvMemo
        Left = 0
        Top = 0
        Width = 1222
        Height = 520
