unit Janua.AnagraphPlanner.dlgVCLLogin;
...
type
  TdlgVCLAnagraphPlannerLogin = class(TdlgVCLCustomLogin, IJanuaLoginForm, IJanuaForm, IJanuaControl)
...
var
  dlgVCLAnagraphPlannerLogin: TdlgVCLAnagraphPlannerLogin;

implementation

{$R *.dfm}

procedure TdlgVCLAnagraphPlannerLogin.FormClose(Sender: TObject; var Action: TCloseAction);
begin
