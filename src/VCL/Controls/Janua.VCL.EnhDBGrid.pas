...
type
  ...
  private
    ...
    procedure DrawField(const Value: String; const Rect: TRect; vCanvas: TCanvas; const vFont: TFont;
      vAlignment: TAlignment; const FontStyle: TFontStyles; const FontColor: TColor; const BGColor: TColor);
  protected
...
procedure TEnhDBGrid.DrawField(const Value: String; const Rect: TRect; vCanvas: TCanvas; const vFont: TFont;
  vAlignment: TAlignment; const FontStyle: TFontStyles; const FontColor: TColor; const BGColor: TColor);
var
  I: Integer;
begin
...
procedure TEnhDBGrid.DrawColumnCell(const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  ...
  if DoRowHighLight then
    DrawField(Column.Field.DisplayText, Rect, Canvas, FHighlightFont, Column.Alignment, FHighlightFont.Style,
...
begin
  ...
  begin
    ...
    self.FDBGrid.SelectedField.Value := not self.grdServiceSearch.SelectedField.AsBoolean;
