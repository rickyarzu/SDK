...
//
// **************************************************************************************************
unit Janua.Vcl.Styles.ControlColor;
...
begin
  ...
  begin
    ...
    FontColor :=  LStyle.GetStyleFontColor(sfEditBoxTextNormal); // clBlack; //
    Brush.Color :=  LStyle.GetSystemColor(clHighlight);  //clSkyBlue;
...
begin
  case Message.Msg of
    ...
    (*
      CM_ACTIVATE, CM_GOTFOCUS, CM_ENTER:
      Begin
      UpdateColors;
      SetBkColor(Message.WParam, ColorToRGB(clSkyBlue));
      Handled := True;
      End *)
  else
