object frameVCLMailMessageConfig: TframeVCLMailMessageConfig
  Left = 0
  Top = 0
  Width = 1440
  Height = 767
  ...
  object pnlCustomerMail: TPanel
    ...
    DesignSize = (
      1440
      105)
    object lblMailCustomerTo: TLabel
      Left = 688
      Top = 20
      Width = 41
      Height = 15
    ...
    object lblMaillMailCustomerBCC: TLabel
      Left = 1221
      Top = 80
      Width = 23
      Height = 15
    ...
    object lblMaillMailCustomerCC: TLabel
      Left = 1221
      Top = 51
      Width = 16
      Height = 15
    ...
    object btnGenerateMail: TButton
      Left = 248
      Top = 16
      Width = 105
      Height = 25
      ...
      TabOrder = 0
      OnClick = btnGenerateMailClick
    end
    object btnLoadMailConfig: TButton
      Left = 135
      Top = 16
      Width = 107
      Height = 25
      Caption = 'Load Mail Config'
      TabOrder = 1
      OnClick = btnLoadMailConfigClick
    end
    ...
    object edtCustomerFromMail: TEdit
      Left = 334
      Top = 76
      Width = 654
      Height = 23
    ...
    object edtCustomerTestRecipients: TEdit
      Left = 1043
      Top = 47
      Width = 172
      Height = 23
    ...
    object edtMailCustomerRecipient: TEdit
      Left = 472
      Top = 18
      Width = 210
      Height = 23
    ...
    object edtMailCustomerTo: TEdit
      Left = 744
      Top = 18
      Width = 693
      Height = 23
  ...
  object pgcCustomerMail: TPageControl
    ...
    object tabCustomerTestMail: TTabSheet
      ...
      object pnlMailTest: TPanel
        ...
        object edtTestMailFromName: TEdit
          Left = 562
          Top = 10
          Width = 674
          Height = 23
    ...
    object tabAdvanced: TTabSheet
      ...
      object pgcAdvanced: TPageControl
        ...
        object tabJsonLog: TTabSheet
          Caption = 'Log'
          ImageIndex = 2
          object memJsonLog: TAdvMemo
            Left = 0
            Top = 0
            Width = 821
            Height = 472
  ...
  object grpURL: TGroupBox
    ...
    object edtCustomerMobileUrl: TEdit
      Left = 125
      Top = 15
      Width = 476
      Height = 23
  ...
  object fdmParams: TFDMemTable
    Active = True
    BeforeDelete = fdmParamsBeforeDelete
