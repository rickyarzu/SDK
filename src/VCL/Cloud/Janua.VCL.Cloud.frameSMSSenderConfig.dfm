object frameVCLMailSmsSenderConfig: TframeVCLMailSmsSenderConfig
  Left = 0
  Top = 0
  Width = 833
  Height = 219
  ...
  object grpSettings: TGroupBox
    ...
    object lbedSecret: TLabeledEdit
      Left = 16
      Top = 88
      Width = 417
      Height = 23
    ...
    object lbedAppName: TLabeledEdit
      Left = 16
      Top = 136
      Width = 417
      Height = 23
