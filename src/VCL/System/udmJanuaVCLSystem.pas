...
begin
  ...
  begin
{$IFDEF MSWINDOWS}
    PublicRegistry.SaveToFile('c:\januaproject\conf\' + FApplicationName + 'UTF8.xml', dfXMLUTF8);
{$ENDIF}
{$IFDEF LINUX}
    PublicRegistry.SaveToFile('/home/januapro/conf/' + FApplicationName.ToLower + 'UTF8.xml', dfXMLUTF8);
{$ENDIF}
...
function TdmJanuaSystem.SetStyle(StyleNumber: Integer): string;
begin
