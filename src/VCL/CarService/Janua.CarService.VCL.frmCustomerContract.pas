unit Janua.CarService.VCL.frmCustomerContract;
...
type
  TfrmVCLCCustomerContract = class(TfrmVCLLandingMessageConfig)
    procedure FormCreate(Sender: TObject);
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
  private
    { Private declarations }
    FCSContractBuilder: IJanuaCSCustomerContractBuilder;
...
var
  frmVCLCCustomerContract: TfrmVCLCCustomerContract;
...
procedure TfrmVCLCCustomerContract.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmVCLCCustomerContract.FormCreate(Sender: TObject);
begin
  inherited;
  FDMCarserviceUniPgSettings:= TdmCarserviceUniPgSettings.Create(self);
  // ---------------------------------------------------------------------------------------------------------
  TJanuaApplicationFactory.TryGetInterface(IJanuaCSCustomerContractBuilder, FCSContractBuilder);
