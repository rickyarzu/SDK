unit Janua.CarService.VCL.frmCustomerLandingMessageNR;
...
type
  TfrmVCLCSCustomerLandingMessageNR = class(TfrmVCLLandingMessageConfig)
    procedure FormCreate(Sender: TObject);
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
  private
    { Private declarations }
    FCSCustomerLandingMsgBuilder: IJanuaCSCustomerLandingMsgNRBuilder;
...
var
  frmVCLCSCustomerLandingMessageNR: TfrmVCLCSCustomerLandingMessageNR;
...
procedure TfrmVCLCSCustomerLandingMessageNR.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmVCLCSCustomerLandingMessageNR.FormCreate(Sender: TObject);
begin
  inherited;
  FDMCarserviceUniPgSettings:= TdmCarserviceUniPgSettings.Create(self);
  // ---------------------------------------------------------------------------------------------------------
  TJanuaApplicationFactory.TryGetInterface(IJanuaCSCustomerLandingMsgNRBuilder, FCSCustomerLandingMsgBuilder);
