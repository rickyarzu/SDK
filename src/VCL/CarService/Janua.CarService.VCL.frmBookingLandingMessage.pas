unit Janua.CarService.VCL.frmBookingLandingMessage;
...
type
  TfrmVCLCSBookingLandingMessage = class(TfrmVCLLandingMessageConfig)
...
var
  frmVCLCSBookingLandingMessage: TfrmVCLCSBookingLandingMessage;
...
procedure TfrmVCLCSBookingLandingMessage.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmVCLCSBookingLandingMessage.FormCreate(Sender: TObject);
begin
  inherited;
