...
uses
  ...
  AdvOfficeTabSetStylers, Vcl.ExtDlgs, Janua.Core.Cloud, GDIPicture, System.ImageList, MemData,
  Janua.Core.Servers,
  Janua.Core.Cloud.Server, Janua.Postgres.Cloud, AdvStyleIF, Janua.Components.Dialogs, Janua.Core.Commons;
...
begin
  Result := False;
  if Assigned(FJanuaServerCloud) and (aID > 0) then
  begin
