unit udlgFootballSelectTeamLastSeason;
...
type
  TdlgFootballSelectTeamLastSeason = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
...
var
  dlgFootballSelectTeamLastSeason: TdlgFootballSelectTeamLastSeason;
...
procedure TdlgFootballSelectTeamLastSeason.btnEdiSearchClubChange(Sender: TObject);
begin
...
procedure TdlgFootballSelectTeamLastSeason.FormShow(Sender: TObject);
begin
  DataSource1.DataSet.Close;
  DataSource1.DataSet.Open;
end;

procedure TdlgFootballSelectTeamLastSeason.grdSelectedTeamsDblClick(Sender: TObject);
var
  id: integer;
begin
