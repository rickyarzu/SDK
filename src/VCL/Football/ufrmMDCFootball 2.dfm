inherited frmMdcFootballChampionship: TfrmMdcFootballChampionship
  ...
  object Splitter1: TAdvSplitter [0]
    ...
    Appearance.ColorHot = 8122111
    Appearance.ColorHotTo = 7131391
    GripStyle = sgDots
    ExplicitLeft = 1107
    ExplicitTop = 32
    ExplicitHeight = 696
  ...
  object Panel1: TShader [4]
    ...
    object DBGrid2: TDBGrid
      ...
      Height = 24
      Align = alTop
      DataSource = dmFootball.dsPlayerAlbum
    ...
    object Panel2: TPanel
      ...
      object grdMatchTeamAllPlayers: TEnhCRDBGrid
        ...
        Height = 307
        Align = alClient
        DataSource = dmFootball.dsMatchTeamAllPlayers
  ...
  object AdvOfficePager1: TAdvOfficePager [5]
    ...
    Height = 645
    Align = alClient
    ActivePage = pgChampionshipsRanking
    ...
    object pgChampionships: TAdvOfficePage
      ...
      object pnlTeamsList: TShader
        ...
        object grdTeamsChampionships: TEnhCRDBGrid
          ...
          Height = 545
          Align = alClient
          DataSource = dmFootball.dsTeamChampionships
          FixedColor = 15784647
          TabOrder = 1
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
    ...
    object pgCalendarMatches: TAdvOfficePage
      ...
      object Panel16: TShader
        ...
        object Panel17: TShader
          ...
          object DBNavigator9: TDBAdvGlowNavigator
            Left = 1
            Top = 1
            Width = 160
            Height = 22
            DataSource = dmFootball.dsMatches
        ...
        object Panel19: TShader
          ...
          object Panel20: TShader
            ...
            object Panel61: TShader
              ...
              object DBNavigator10: TDBAdvGlowNavigator
                Left = 1
                Top = 1
                Width = 80
                Height = 27
                DataSource = dmFootball.dsMatchTeamPlayers
        ...
        object pnlEvents: TShader
          ...
          object Panel21: TShader
            ...
            object DBText1: TDBText
              ...
              DataSource = dmFootball.dsMatchDays
            end
          ...
          object grdMatchEvents: TEnhCRDBGrid
            ...
            Height = 267
            Align = alClient
            DataSource = dmFootball.dsMatchEvents
            FixedColor = 15784647
            Options = [dgEditing, dgTitles, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgTitleClick, dgTitleHotTrack]
            PopupMenu = popTabellino
            TabOrder = 1
          ...
          object Panel22: TShader
            ...
            object DBNavigator7: TDBAdvGlowNavigator
              Left = 1
              Top = 1
              Width = 120
              Height = 22
        ...
        object adgPagerRankings: TAdvOfficePager
          ...
          object pgRankings: TAdvOfficePage
            ...
            object grdRanking: TCRDBGrid
              ...
              Align = alClient
              Ctl3D = True
              DataSource = dmFootball.dsChampRanking
              FixedColor = 15784647
          ...
          object pgPlayerScores: TAdvOfficePage
            ...
            object CRDBGrid6: TCRDBGrid
              ...
              Align = alClient
              Color = clWhite
              DataSource = dmFootball.dsGolRanking
              FixedColor = 15784647
              TabOrder = 0
              TitleFont.Charset = DEFAULT_CHARSET
              TitleFont.Color = clWindowText
            ...
            object Shader5: TShader
              ...
              object DBAdvGlowNavigator9: TDBAdvGlowNavigator
                Left = 101
                Top = 1
                Width = 80
                Height = 26
        ...
        object pgClubsAnagraphs: TAdvOfficePager
            ...
            object Panel48: TShader
              ...
              object Panel51: TShader
                ...
                object Panel5: TShader
                  ...
                  object grdTeamsClubsLeagues: TEnhCRDBGrid
                    ...
                    Height = 195
                    Align = alClient
                    DataSource = dmFootball.dsTeamsLeagues
                    FixedColor = 15784647
                    TabOrder = 0
                    TitleFont.Charset = DEFAULT_CHARSET
                    TitleFont.Color = clWindowText
                ...
                object Panel53: TShader
                  ...
                  object Panel54: TShader
                    ...
                    object DBNavigator6: TDBAdvGlowNavigator
                      ...
                      Width = 128
                      Height = 25
                      DataSource = dmFootball.dsClubPlayers
                      VisibleButtons = [nbFirst, nbPrior, nbNext, nbLast, nbPost]
                      Align = alLeft
                      Appearance.ColorChecked = 16111818
                      Appearance.ColorCheckedTo = 16367008
              ...
              object Panel57: TShader
                ...
                object Panel58: TShader
                  ...
                  object DBAdvGlowNavigator7: TDBAdvGlowNavigator
                    Left = 1
                    Top = 1
                    Width = 64
                    Height = 33
                ...
                object grdTeamPlayersLast: TEnhCRDBGrid
                  ...
                  Height = 300
                  Align = alClient
                  DataSource = dmFootball.dsTeamsPlayersLast
                  FixedColor = 15784647
          ...
          object pgClubsTeams: TAdvOfficePage
            ...
            object Shader24: TShader
              ...
              Direction = False
              Version = '1.4.2.0'
              object DBAdvGlowNavigator5: TDBAdvGlowNavigator
                Left = 1
                Top = 25
                Width = 255
                Height = 21
              ...
              object DBAdvGlowNavigator6: TDBAdvGlowNavigator
                Left = 1
                Top = 193
                Width = 255
                Height = 30
    ...
    object pgNavigator: TAdvOfficePage
      ...
      object Shader21: TShader
        ...
        object EnhCRDBGrid12: TEnhCRDBGrid
          ...
          Height = 547
          Align = alClient
          DataSource = dmFootball.dsPlayerHistory
          FixedColor = 15784647
          TabOrder = 1
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
  ...
  object pnlChampionshipsList: TShader [6]
    ...
    object grdChampionships: TEnhCRDBGrid
      ...
      Height = 577
      Align = alClient
      DataSource = dmFootball.dsChampionships
      FixedColor = 15784647
  ...
  object Shader1: TShader [7]
    ...
    object Shader11: TShader
      ...
      object cboSeasons: TJvDBLookupCombo
        ...
        LookupSource = dmFootball.dsSeasons
        TabOrder = 0
      end
    end
  ...
  object dsAllPlayers: TDataSource
    DataSet = dmFootball.qryAllPlayers
    Left = 282
    Top = 139
  end
  ...
  object PgQuery1: TUniQuery
    Connection = dmFootball.PgErgoConnection
    Left = 616
    Top = 208
  end
  ...
  object dsMatchTeams: TUniDataSource
    DataSet = dmFootball.qryMatchTeams
    Left = 536
    Top = 248
  end
  ...
  object dsDynamicRanking: TDataSource
    DataSet = dmFootball.qryDynamicRanking
    Left = 536
    Top = 322
  end
  object dsMatchFrom: TDataSource
    DataSet = dmFootball.lkpMatchDaysFrom
    Left = 536
    Top = 392
  end
  object dsMatchTio: TDataSource
    DataSet = dmFootball.lkpMatchDaysTo
    Left = 536
    Top = 456
  end
end
