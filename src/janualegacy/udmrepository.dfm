object dmRepository: TdmRepository
  Height = 201
  Width = 431
  object sesRepository: TJanuaUniConnection
    ProviderName = 'Oracle'
    ...
    Left = 32
    Top = 24
    EncryptedPassword = '95FFCBFF91FF8AFFCBFF8FFF8DFFCFFF95FFCCFF9CFF8BFF'
  end
  object qryGlobalVersion: TUniQuery
    SQLInsert.Strings = (
  ...
  object qryLocalVersion: TUniQuery
    SQLInsert.Strings = (
  ...
  object qryRepository: TUniTable
  ...
  object dsGruppi: TUniDataSource
    DataSet = qryGruppi
    Left = 368
    Top = 24
  end
  object dsSQL: TUniDataSource
    DataSet = qrySql
    Left = 368
    Top = 80
  end
