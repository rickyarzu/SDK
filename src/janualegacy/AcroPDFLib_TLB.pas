...
// $Rev: 52393 $
// File generated on 13/11/2017 12:22:22 from Type Library described below.
...
uses Winapi.Windows, System.Classes, System.Variants,  Vcl.OleCtrls,
...
type
  ...
  ISPOpenDocuments = interface(IDispatch)
    ...
    function ViewDocument3(const pDisp: IDispatch; const bstrDocumentLocation: WideString; OpenType: SYSINT;
      varProgID: OleVariant): WordBool; safecall;
    ...
    function CheckoutDocumentPrompt(const bstrDocumentLocationRaw: WideString; fEditAfterCheckout: WordBool;
      varProgID: OleVariant): WordBool; safecall;
    ...
    procedure ViewInExcel(const SiteUrl: WideString; const fileName: WideString; const SessionId: WideString;
      const Cmd: WideString; const Sheet: WideString; Row: SYSINT; Column: SYSINT;
  ...
  ISPOpenDocumentsDisp = dispinterface
    ...
    function ViewDocument3(const pDisp: IDispatch; const bstrDocumentLocation: WideString; OpenType: SYSINT;
      varProgID: OleVariant): WordBool; dispid 3;
    function CheckinDocument(const bstrDocumentLocation: WideString; CheckinType: SYSINT;
      const CheckinComment: WideString; bKeepCheckout: WordBool): WordBool; dispid 4;
    function CheckoutDocumentPrompt(const bstrDocumentLocationRaw: WideString; fEditAfterCheckout: WordBool;
      varProgID: OleVariant): WordBool; dispid 5;
    function CreateNewDocument(const bstrTemplateLocation: WideString;
    ...
    procedure ViewInExcel(const SiteUrl: WideString; const fileName: WideString; const SessionId: WideString;
      const Cmd: WideString; const Sheet: WideString; Row: SYSINT; Column: SYSINT; varProgID: OleVariant);
      dispid 14;
  end;
  ...
  public
    ...
    function ViewDocument2(const pDisp: IDispatch; const bstrDocumentLocation: WideString): WordBool;
      overload;
    function ViewDocument2(const pDisp: IDispatch; const bstrDocumentLocation: WideString;
    ...
    function EditDocument2(const pDisp: IDispatch; const bstrDocumentLocation: WideString): WordBool;
      overload;
    function EditDocument2(const pDisp: IDispatch; const bstrDocumentLocation: WideString;
      varProgID: OleVariant): WordBool; overload;
    function EditDocument3(const pDisp: IDispatch; const bstrDocumentLocation: WideString;
    ...
    procedure ViewInExcel(const SiteUrl: WideString; const fileName: WideString; const SessionId: WideString;
      const Cmd: WideString; const Sheet: WideString; Row: SYSINT; Column: SYSINT); overload;
    procedure ViewInExcel(const SiteUrl: WideString; const fileName: WideString; const SessionId: WideString;
      const Cmd: WideString; const Sheet: WideString; Row: SYSINT; Column: SYSINT;
...
const
  ...
  CControlData: TControlData2 = (ClassID: '{CA8A9780-280D-11CF-A24D-444553540000}';
    EventIID: '{E790E1D1-9DE8-4853-8AC6-933D4FD9C927}'; EventCount: 2; EventDispIDs: @CEventDispIDs;
    LicenseKey: nil (* HR:$80004002 *); Flags: $00000000; Version: 500);
begin
  ControlData := @CControlData;
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnError) - UIntPtr(Self);
end;
...
const
  CServerData: TServerData = (ClassID: '{24DA047B-40C0-4018-841B-6B7409F730FC}';
    IntfIID: '{7EA23D88-569E-4EFD-9851-A1528A7745F9}'; EventIID: ''; LicenseKey: nil; Version: 500);
begin
...
function TAdobeSPOpenDocuments.ViewDocument(const bstrDocumentLocation: WideString; varProgID: OleVariant)
  : WordBool;
begin
  Result := DefaultInterface.ViewDocument(bstrDocumentLocation, varProgID);
end;

function TAdobeSPOpenDocuments.ViewDocument2(const pDisp: IDispatch; const bstrDocumentLocation: WideString)
  : WordBool;
var
  EmptyParam: OleVariant;
begin
...
function TAdobeSPOpenDocuments.ViewDocument3(const pDisp: IDispatch; const bstrDocumentLocation: WideString;
...
function TAdobeSPOpenDocuments.CheckinDocument(const bstrDocumentLocation: WideString; CheckinType: SYSINT;
  const CheckinComment: WideString; bKeepCheckout: WordBool): WordBool;
begin
...
begin
  EmptyParam := System.Variants.EmptyParam;
  Result := DefaultInterface.CheckoutDocumentPrompt(bstrDocumentLocationRaw, fEditAfterCheckout, EmptyParam);
end;

function TAdobeSPOpenDocuments.CheckoutDocumentPrompt(const bstrDocumentLocationRaw: WideString;
  fEditAfterCheckout: WordBool; varProgID: OleVariant): WordBool;
begin
  Result := DefaultInterface.CheckoutDocumentPrompt(bstrDocumentLocationRaw, fEditAfterCheckout, varProgID);
end;
...
function TAdobeSPOpenDocuments.CreateNewDocument2(const pDisp: IDispatch;
  const bstrTemplateLocation: WideString; const bstrDefaultSaveLocation: WideString): WordBool;
begin
...
function TAdobeSPOpenDocuments.EditDocument(const bstrDocumentLocation: WideString; varProgID: OleVariant)
  : WordBool;
begin
  Result := DefaultInterface.EditDocument(bstrDocumentLocation, varProgID);
end;

function TAdobeSPOpenDocuments.EditDocument2(const pDisp: IDispatch; const bstrDocumentLocation: WideString)
  : WordBool;
var
  EmptyParam: OleVariant;
begin
...
function TAdobeSPOpenDocuments.EditDocument3(const pDisp: IDispatch; const bstrDocumentLocation: WideString;
...
procedure TAdobeSPOpenDocuments.NewBlogPost(const bstrProviderId: WideString; const bstrBlogUrl: WideString;
  const bstrBlogName: WideString);
begin
...
procedure TAdobeSPOpenDocuments.ViewInExcel(const SiteUrl: WideString; const fileName: WideString;
  const SessionId: WideString; const Cmd: WideString; const Sheet: WideString; Row: SYSINT; Column: SYSINT);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
