unit Janua.Legacy.Anagraph;

interface

uses
  SysUtils, Classes, Janua.Core.Functions, Janua.Core.Components, Janua.Legacy.Core, Janua.Core.Classes;

type

  TJanuaAddress = class(TJanuaCoreComponent)
  private
    FPostalCode: String;
  ...
  TJanuaAnagGroups = class(TJanuaCoreComponent)
  end;

type
  TJanuaBankAccount = class(TJanuaCoreComponent)
  strict private
  ...
  TJanuaAnagraph = class(TJanuaCoreComponent)
  strict private
  ...
  published
    ...
    property BanckAccount: TJanuaBankAccount read GetBanckAccount write SetBanckAccount;
    ...
    property Cellular: String read GetCellular write SetCellular;
    property Email: String read GetEmail write SetEmail;
    property Web: String read GetWeb write SetWeb;
    ...
    property Notes2: String read GetNotes2 write SetNotes2;
    property Notes3: String read GetNotes3 write SetNotes3;
    property Privacy: String read GetPrivacy write SetPrivacy;
    property Documents: String read GetDocuments write SetDocuments;
...
function TJanuaAnagraph.GetDistance: Double;
begin
  Result := FDistance
end;
