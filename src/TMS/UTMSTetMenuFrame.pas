...
type
  TTMSTestMenuFrame = class(TFrame)
...
constructor TTMSTestMenuFrame.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TTMSTestMenuFrame.CheckItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
...
procedure TTMSTestMenuFrame.HTMLItem1CaptionAnchorClick(Sender: TObject; Anchor: string);
begin
  ShellExecute(Handle, 'Open', PChar(Anchor), nil, nil, SW_SHOWNORMAL);
  Memo1.Lines.Add('Click on Anchor : ' + Anchor);
end;

procedure TTMSTestMenuFrame.ImageItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
end;

procedure TTMSTestMenuFrame.ImageItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
end;

procedure TTMSTestMenuFrame.ImageTextButtonItem1ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  if item.Tag = 0 then
  begin
...
procedure TTMSTestMenuFrame.ImageTextItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' clicked');
end;

procedure TTMSTestMenuFrame.ImageTextItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
  case item.Index of
    9:
...
procedure TTMSTestMenuFrame.LargeButtonedItem1ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  Memo1.Lines.Add(TLargeButtonedItem(Item).ButtonCaption + ' Clicked');
end;

procedure TTMSTestMenuFrame.LargeButtonedItem4ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  Memo1.Lines.Add(TLargeButtonedItem(Item).ButtonCaption + ' Clicked with copies : ' + inttostr(SpinEdit1.Value));
end;

procedure TTMSTestMenuFrame.RadioItem1DrawGraphic(Sender: TObject; g: TGPGraphics;
  Rect: TGPRectF; Item: TCustomItem; Checked: Boolean; State: TGraphicState;
  Kind: TGraphicKind; Enabled: Boolean; var Default: Boolean);
var
  b: TGPBrush;
...
procedure TTMSTestMenuFrame.ShowPage(Item: integer);
begin
  case Item of
    4:
    begin
...
procedure TTMSTestMenuFrame.WedgeItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  AdvVerticalPolyList2.SelectItem(Item.Index);
end;

procedure TTMSTestMenuFrame.WedgeItem10ItemSelect(Sender: TObject; Item: TCustomItem;
  var Allow: Boolean);
begin
  ShowPage(Item.Index);
