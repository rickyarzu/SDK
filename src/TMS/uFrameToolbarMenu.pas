...
type
  TframeTMSToolbarMenu = class(TFrame)
...
constructor TframeTMSToolbarMenu.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TframeTMSToolbarMenu.CheckItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
...
procedure TframeTMSToolbarMenu.HTMLItem1CaptionAnchorClick(Sender: TObject; Anchor: string);
begin
  ShellExecute(Handle, 'Open', PChar(Anchor), nil, nil, SW_SHOWNORMAL);
  Memo1.Lines.Add('Click on Anchor : ' + Anchor);
end;

procedure TframeTMSToolbarMenu.ImageItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
end;

procedure TframeTMSToolbarMenu.ImageItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
end;

procedure TframeTMSToolbarMenu.ImageTextButtonItem1ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  if item.Tag = 0 then
  begin
...
procedure TframeTMSToolbarMenu.ImageTextItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' clicked');
end;

procedure TframeTMSToolbarMenu.ImageTextItem1ItemClick(Sender: TObject; Item: TCustomItem);
begin
  Memo1.Lines.Add(TImageTextItem(Item).Caption + ' Clicked');
  case item.Index of
    9:
...
procedure TframeTMSToolbarMenu.LargeButtonedItem1ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  Memo1.Lines.Add(TLargeButtonedItem(Item).ButtonCaption + ' Clicked');
end;

procedure TframeTMSToolbarMenu.LargeButtonedItem4ItemButtonClick(Sender: TObject;
  Item: TCustomItem);
begin
  Memo1.Lines.Add(TLargeButtonedItem(Item).ButtonCaption + ' Clicked with copies : ' + inttostr(SpinEdit1.Value));
end;

procedure TframeTMSToolbarMenu.RadioItem1DrawGraphic(Sender: TObject; g: TGPGraphics;
  Rect: TGPRectF; Item: TCustomItem; Checked: Boolean; State: TGraphicState;
  Kind: TGraphicKind; Enabled: Boolean; var Default: Boolean);
var
  b: TGPBrush;
...
procedure TframeTMSToolbarMenu.ShowPage(Item: integer);
begin
  case Item of
    4:
    begin
...
procedure TframeTMSToolbarMenu.WedgeItem10ItemClick(Sender: TObject; Item: TCustomItem);
begin
  AdvVerticalPolyList2.SelectItem(Item.Index);
end;

procedure TframeTMSToolbarMenu.WedgeItem10ItemSelect(Sender: TObject; Item: TCustomItem;
  var Allow: Boolean);
begin
  ShowPage(Item.Index);
