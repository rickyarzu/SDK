...
type
  ...
  [TestFixture]
  TMVVMForms = class[Test]
    procedure FormMenuRegister;
  end;

implementation

uses Janua.VCL.Framework, System.types, Janua.Controls.Forms.Impl, Janua.TMS.NavBar, ufrmTest, ufrmTest2,
  ufrmTest3, uFrameTest,  Janua.Application.Framework;

{ TMVVMForms }

procedure TMVVMForms.FormMenuRegister;
var
...
begin
  ...
  lApplication1.AddForm(TJanuaFormRecord.Create('Form Test 2', lApplication1.Name, 10, TfrmTest, GUID_NULL));

  lApplication.AddApplication(lApplication1);

  lApplication2 := TJanuaApplicationRecord.Create('leaf2', 'Leaf 2', 4, nil);
  lApplication2.AddForm(TJanuaFormRecord.Create('Form Test 3', lApplication2.Name, 13, TfrmTest3, GUID_NULL));
  ...
  Assert.Pass('Test FormMenuRegister');
end;
