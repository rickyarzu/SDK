...
type
  TfrmAccessCameraApp = class(TForm)
...
var
  frmAccessCameraApp: TfrmAccessCameraApp;
...
procedure TfrmAccessCameraApp.DisplayRationale(Sender: TObject; const APermissions: TClassicStringDynArray;
  const APostRationaleProc: TProc);
begin
  var
    RationaleMsg: string;
...
procedure TfrmAccessCameraApp.btnTakePhotoClick(Sender: TObject);
begin
  PermissionsService.RequestPermissions([PermissionCamera, PermissionReadExternalStorage,
    PermissionWriteExternalStorage], TakePicturePermissionRequestResult, DisplayRationale)
end;

procedure TfrmAccessCameraApp.TakePicturePermissionRequestResult(Sender: TObject;
...
procedure TfrmAccessCameraApp.TakePhotoFromCameraAction1DidFinishTaking(Image: TBitmap);
begin
