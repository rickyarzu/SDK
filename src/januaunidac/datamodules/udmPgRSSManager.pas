unit udmPgRSSManager;

interface

uses
  System.SysUtils, System.Classes,  Data.DB, MemDS, DBAccess,
  Uni, Janua.Core.System, Janua.Core.Classes, Janua.Core.Cms,
  ...
  IdTCPClient, IdHTTP, System.Variants, Forms, Janua.Server.Functions, Janua.Commons.pgCountriesLocal,
  Datasnap.DBClient, Datasnap.Provider, Janua.Postgres.Functions, Janua.Core.Feeds;

type
  TdmRSSManager = class(TDataModule)
    PgConnection1: TJanuaUniConnection;
    prcNewArticle: TUniStoredProc;
    tbRSSFeeds: TUniTable;
    ...
    dsFeeds: TDataSource;
    qrySearchArticle: TUniQuery;
    qrySearchFeed: TUniQuery;
    odltbRSSArticles: TUniQuery;
    ...
    tbRSSArticlesdate: TUniDateField;
    ...
    JanuaFeedReader1: TJanuaFeedReader;
...
begin
  try
    a := TJanuaFeedReader.Create(nil);
    try
      a.ADPXMLBLOG := aUrl;
      a.Feed_ID := self.tbRSSFeedsfeed_id.AsLargeInt;
