inherited dmPgForms: TdmPgForms
  ...
  object qryFormsTranslations: TUniQuery
    SQLInsert.Strings = (
  ...
  object qryPropertiesTranslations: TUniQuery
    SQLInsert.Strings = (
  ...
  object qrySearchForms: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO system.app_forms'
      '  (form_url, form_name, db_schema_id, form_id)'
      'VALUES'
  ...
  object qryFormsObjectsTranslations: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
