inherited dmHealthBooking: TdmHealthBooking
  ...
  object qryInstitutes: TUniQuery
    KeyFields = 'anagraph_id'
    SQLInsert.Strings = (
  ...
  object qryInstitutesDisciplines: TUniQuery
    SQLInsert.Strings = (
  ...
  object qryInstitutesServices: TUniQuery
    SQLInsert.Strings = (
  ...
  object qrySearchServices: TUniQuery
    DataTypeMap = <
      item
        FieldName = 'prestazione'
        FieldType = ftWideString
  ...
  object qrySearchInstitutes: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      'select '
  ...
  object qrySearchItem: TUniQuery
    DataTypeMap = <
      item
        FieldName = 'prestazione'
        FieldType = ftWideString
  ...
  object qryLkpDisciplines: TUniQuery
    DataTypeMap = <
      item
        FieldName = 'model'
        FieldType = ftWideString
  ...
  object qryServicesNextVal: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
  ...
  object qryAnagraphNextVal: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
  ...
  object qryInstitutesItems: TUniQuery
    DataTypeMap = <
      item
        FieldName = 'an_title'
        FieldType = ftWideString
  ...
  object qryBookings: TUniQuery
    ...
    object qryBookingsclosed_date: TDateTimeField
      FieldName = 'closed_date'
    end
    object qryBookingssent: TBooleanField
      FieldName = 'sent'
    end
    object qryBookingssent_date: TDateTimeField
      FieldName = 'sent_date'
    end
    object qryBookingsreceived: TBooleanField
      FieldName = 'received'
    end
    object qryBookingsreceived_date: TDateTimeField
    ...
    object qryBookingsinsert_date: TDateTimeField
      FieldName = 'insert_date'
    end
    object qryBookingsupdate_date: TDateTimeField
    ...
    object qryBookingsinsert_date_1: TDateTimeField
    ...
    object qryBookingsemaildate: TDateTimeField
      FieldName = 'emaildate'
      ReadOnly = True
    end
    ...
    object qryBookingssmsdate: TDateTimeField
      FieldName = 'smsdate'
      ReadOnly = True
    end
  ...
  object qryBookingRows: TUniQuery
    SQLInsert.Strings = (
    ...
    object qryBookingRowsclosed_date: TDateTimeField
      FieldName = 'closed_date'
    end
    ...
    object qryBookingRowssent_date: TDateTimeField
      FieldName = 'sent_date'
    end
    object qryBookingRowsreceived: TBooleanField
      FieldName = 'received'
    end
    object qryBookingRowsreceived_date: TDateTimeField
      FieldName = 'received_date'
    end
    ...
    object qryBookingRowsinsert_date: TDateTimeField
      FieldName = 'insert_date'
    end
    object qryBookingRowsupdate_date: TDateTimeField
      FieldName = 'update_date'
    end
  ...
  object qrySearchAnagraph: TUniQuery
    KeyFields = 'anagraph_id'
    SQLInsert.Strings = (
      'INSERT INTO anagraph.anagraphs'
  ...
  object qryBookingInstitutes: TUniQuery
    ...
    object qryBookingInstitutesclosed_date: TDateTimeField
      FieldName = 'closed_date'
      ReadOnly = True
    end
    ...
    object qryBookingInstitutessent_date: TDateTimeField
      FieldName = 'sent_date'
      ReadOnly = True
    end
    ...
    object qryBookingInstitutesreceived_date: TDateTimeField
      FieldName = 'received_date'
      ReadOnly = True
    end
    ...
    object qryBookingInstitutesinsert_date: TDateTimeField
      FieldName = 'insert_date'
      ReadOnly = True
    end
    object qryBookingInstitutesupdate_date: TDateTimeField
      FieldName = 'update_date'
      ReadOnly = True
    end
  ...
  object spbookingInstitutes: TUniStoredProc
  ...
  object spBookingFinalisation: TUniStoredProc
  ...
  object qryLkpServices: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      ' SELECT * from'
      '    ('
  ...
  object qryBookingPrescription: TUniQuery
    SQLInsert.Strings = (
  ...
  object spInstituteConfirmation: TUniStoredProc
  ...
  object spUserCheckOut: TUniStoredProc
  ...
  object qryLkpServicesOld: TUniQuery
    DataTypeMap = <
      item
        FieldName = 'prestazione'
        FieldType = ftWideString
  ...
  object qryNotifications: TUniQuery
    ...
    object qryNotificationsdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  ...
  object qryBookingNotifications: TUniQuery
    SQLInsert.Strings = (
    ...
    object qryBookingNotificationsdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  ...
  object qryNotification: TUniQuery
    SQLRecCount.Strings = (
      'SELECT count(1)'
      '  FROM health.notifications'
      'where'
    ...
    object qryNotificationdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  ...
  object qryMeetings: TUniQuery
    ...
    object qryMeetingsclosed_date: TDateTimeField
      FieldName = 'closed_date'
    end
    ...
    object qryMeetingssent_date: TDateTimeField
      FieldName = 'sent_date'
    end
    object qryMeetingsreceived: TBooleanField
      FieldName = 'received'
    end
    object qryMeetingsreceived_date: TDateTimeField
      FieldName = 'received_date'
    end
    ...
    object qryMeetingsinsert_date: TDateTimeField
      FieldName = 'insert_date'
    end
    object qryMeetingsupdate_date: TDateTimeField
      FieldName = 'update_date'
    end
    ...
    object qryMeetingsclosed_date_1: TDateTimeField
    ...
    object qryMeetingssent_date_1: TDateTimeField
    ...
    object qryMeetingsreceived_date_1: TDateTimeField
    ...
    object qryMeetingsinsert_date_1: TDateTimeField
      FieldName = 'insert_date_1'
      ReadOnly = True
    end
    object qryMeetingsupdate_date_1: TDateTimeField
  ...
  object qryIndexSearc: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      '   SELECT id, discipline_name, prestazione, 0::integer as pos'
      #9'FROM health.search_index ')
    Left = 544
    Top = 512
