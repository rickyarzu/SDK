...
uses
  ...
  MemDS, DBAccess, Uni, Janua.Core.Cms,
  Janua.Core.System,
  Janua.Cms.Types,
  Janua.Core.Classes,
  Janua.Core.Exceptions, Janua.Orm.Intf, UniProvider,
  PostgreSQLUniProvider, Datasnap.Provider, Datasnap.DBClient, VirtualDataSet, Janua.Unidac.Connection;
...
type
  TdmPgCms = class(TdmJanuaPostgresModel)
    ...
    qryArticles: TUniQuery;
    qrySingleArticle: TUniQuery;
    qryStudioLegale: TUniQuery;
    qryNewsFisco: TUniQuery;
    ...
    qryArticlesdatetime: TDateTimeField;
    ...
    qrySingleArticledatetime: TDateTimeField;
    ...
    qryStudioLegaledatetime: TDateTimeField;
    ...
    qryNewsFiscodatetime: TDateTimeField;
  ...
  protected
    function GetArticle: TArticleRecord;
    function GetListSpecifications: TStringList;
    function GetListMainArguments: TStringList;
    function GetListSubArguments: TStringList;
    function GetMessageCount: integer;
    function GetListArguments: TStringList;
    function GetCms: TCms;
    function GetCmsArguments: TCmsArguments;
  ...
  published
    property Article: TArticleRecord read GetArticle write SetArticle;
    property ListMainArguments: TStringList read GetListMainArguments write SetListMainArguments;
    property ListArguments: TStringList read GetListArguments write SetListArguments;
    property ListSubArguments: TStringList read GetListSubArguments write SetListSubArguments;
    property ListSpecifications: TStringList read GetListSpecifications write SetListSpecifications;
    property MessageCount: integer read GetMessageCount write SetMessageCount;
    property Cms: TCms read GetCms write SetCms;
    property CmsArguments: TCmsArguments read GetCmsArguments write SetCmsArguments;
  end;
...
begin
  ...
  Result := MaxArticles;
  GetCustomServerFunctions.OpenDataset(qryArticles);
  qryArticles.First;
...
begin
  ...
  self.GetCustomServerFunctions.OpenDataset(qrySingleArticle);
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        GetCustomServerFunctions.OpenDataset(self.qryArticlesSeq);
...
begin
  try
    ...
    qrySingleArticle.Close;
    GetCustomServerFunctions.OpenDataset(qrySingleArticle);
...
begin
  ...
  GetCustomServerFunctions.OpenDataset(specifications);
...
begin
  ...
  GetCustomServerFunctions.OpenDataset(sub_arguments);
  sub_arguments.First;
...
begin
  try
    ...
    GetCustomServerFunctions.OpenDataset(arguments);
...
function TdmPgCms.GetArticle: TArticleRecord;
begin
  Result := self.FArticle
end;

function TdmPgCms.GetCms: TCms;
begin
   Result := self.FCms
end;

function TdmPgCms.GetCmsArguments: TCmsArguments;
begin
  Result := self.FCmsArguments
end;

function TdmPgCms.GetListArguments: TStringList;
begin
  Result := self.FListArguments
end;

function TdmPgCms.GetListMainArguments: TStringList;
begin
  Result := self.FListMainArguments
end;

function TdmPgCms.GetListSpecifications: TStringList;
begin
  Result := self.FListSpecifications
end;

function TdmPgCms.GetListSubArguments: TStringList;
begin
  Result := self.FListSubArguments
end;

function TdmPgCms.GetMessageCount: integer;
begin
   Result := self.FMessageCount
end;
