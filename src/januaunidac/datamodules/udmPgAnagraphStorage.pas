...
uses
  ...
  udmPgStorage,
  Janua.Core.Classes, Janua.Core.System,
  Datasnap.Provider, Datasnap.DBClient,  udmJanuaPostgresModel, UniProvider, PostgreSQLUniProvider;
...
begin
  ...
  begin
    sqlInsertIdentity.ParamByName('db_schema_id').Value := TJanuaApplication.DBSchemaID;
...
begin
  inherited;
  qryAnagraphs.ParamByName('db_schema_id').Value := TJanuaApplication.DBSchemaID;
end;
...
begin
  inherited;
  qrySubAnagraphs.ParamByName('db_schema_id').Value := TJanuaApplication.DBSchemaID
end;
