...
type
  TdmFbPhoenixJsonReport = class(TdmJanuaInterbaseModel)
    ...
    qryStatiniLuciRAGIONE_SOCIALE: TStringField;
    qryStatiniLuciINDIRIZZO: TStringField;
    ...
    qryInterventiLuciTIPO_ATTREZZATURA: TStringField;
    qryInterventiLuciPROGRESSIVO: TIntegerField;
    qryInterventiLuciTIPO: TStringField;
    qryInterventiLuciDATA_CONTROLLO: TDateField;
    qryInterventiLuciDATA_CONSEGNA: TDateField;
    qryInterventiLuciPERIODI_NON_ORDINARI: TStringField;
    ...
    qryInterventiLuciANOMALIA_APPROVATA: TStringField;
    qryInterventiLuciMODELLO: TStringField;
    qryInterventiLuciAUTONOMIA: TSmallintField;
    qryInterventiLuciPREC_ANOMALIA: TBlobField;
    qryInterventiLuciDES_TIPO_LUCE: TStringField;
    qryInterventiLuciDES_MARCA_LUCE: TStringField;
    ...
    qryCheckListLuciDESCRIZIONE: TStringField;
    qryCheckListLuciTIPOLOGIA: TStringField;
