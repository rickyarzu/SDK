inherited dmUniDacPgChampionships: TdmUniDacPgChampionships
  ...
  object qryMatchDays: TUniQuery
    ...
    OnNewRecord = qryMatchDaysNewRecord
    Left = 288
    Top = 128
    ParamData = <
      item
  ...
  object qryMatchAllPlayers: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO sports.match_players_view'
        ...
        ', user_insert, user_update, team_name, notes, full_name, lkpplay' +
        'ername)'
      'VALUES'
        ...
        'rt_date, :update_date, :user_insert, :user_update, :team_name, :' +
        'notes, :full_name, :lkpplayername)')
    SQLDelete.Strings = (
    ...
    SQLUpdate.Strings = (
      ...
      'SET'
        ...
        'sert, user_update = :user_update, team_name = :team_name, notes ' +
        '= :notes, full_name = :full_name, lkpplayername = :lkpplayername'
      'WHERE'
      '  jguid = :Old_jguid')
    SQLLock.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'date, user_insert, user_update, team_name, notes, full_name, lkp' +
        'playername FROM sports.match_players_view'
      'WHERE'
      '  jguid = :jguid')
    SQLRecCount.Strings = (
      'SELECT count(*) FROM ('
    ...
    object qryMatchAllPlayersdeleted: TBooleanField
      FieldName = 'deleted'
    end
    object qryMatchAllPlayersinsert_date: TDateTimeField
      FieldName = 'insert_date'
    end
    object qryMatchAllPlayersupdate_date: TDateTimeField
      FieldName = 'update_date'
    end
    object qryMatchAllPlayersuser_insert: TWideStringField
      FieldName = 'user_insert'
      Size = 128
    end
    object qryMatchAllPlayersuser_update: TWideStringField
      FieldName = 'user_update'
      Size = 128
    end
  ...
  object qryTeamChampPlayers: TUniQuery
    SQLInsert.Strings = (
      ...
      'VALUES'
        ...
        ':birth_place, :notes, :height, :weight, :role_id)')
    SQLDelete.Strings = (
    ...
    SQLRefresh.Strings = (
        ...
        'eight, role_id FROM sports.team_players_view'
      'WHERE'
      '  jguid = :jguid')
    SQLRecCount.Strings = (
      'SELECT count(*) FROM ('
    ...
    object qryTeamChampPlayersscored: TSmallintField
      FieldName = 'scored'
    end
    object qryTeamChampPlayersself_scored: TSmallintField
      FieldName = 'self_scored'
    end
    object qryTeamChampPlayersconceded: TSmallintField
      FieldName = 'conceded'
    end
    object qryTeamChampPlayersscore: TIntegerField
      FieldName = 'score'
    end
    object qryTeamChampPlayersremote_id: TIntegerField
      FieldName = 'remote_id'
    end
    object qryTeamChampPlayersdb_schema_id: TIntegerField
      FieldName = 'db_schema_id'
    end
    object qryTeamChampPlayersjguid: TGuidField
      FieldName = 'jguid'
      Size = 38
    end
    object qryTeamChampPlayersdeleted: TBooleanField
      FieldName = 'deleted'
    end
    object qryTeamChampPlayersinsert_date: TDateTimeField
      FieldName = 'insert_date'
    end
    object qryTeamChampPlayersupdate_date: TDateTimeField
      FieldName = 'update_date'
    end
    object qryTeamChampPlayersuser_insert: TWideStringField
      FieldName = 'user_insert'
      Size = 128
    end
    object qryTeamChampPlayersuser_update: TWideStringField
      FieldName = 'user_update'
      Size = 128
    end
    object qryTeamChampPlayersan_cellular: TWideStringField
      FieldName = 'an_cellular'
    end
    object qryTeamChampPlayersan_email: TWideStringField
      FieldName = 'an_email'
      Size = 256
    end
    object qryTeamChampPlayersrole_name: TWideStringField
      FieldName = 'role_name'
      Size = 30
    end
    object qryTeamChampPlayersheight: TSmallintField
      FieldName = 'height'
    end
    object qryTeamChampPlayersweight: TSmallintField
      FieldName = 'weight'
    end
    object qryTeamChampPlayersrole_id: TSmallintField
      FieldName = 'role_id'
    end
  end
  ...
  object qrySelectLeagues: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO sports.leagues_view'
      
        '  (id, league_name, country_id, league_position, league_code, db' +
        '_schema_id, remote_id, promotedcss, playoffcss, championscss, pl' +
        'ayoutcss, relegationcss, all_players, jguid, deleted)'
      'VALUES'
      
        '  (:id, :league_name, :country_id, :league_position, :league_cod' +
        'e, :db_schema_id, :remote_id, :promotedcss, :playoffcss, :champi' +
        'onscss, :playoutcss, :relegationcss, :all_players, :jguid, :dele' +
        'ted)')
    SQLDelete.Strings = (
      'DELETE FROM sports.leagues_view'
      'WHERE'
      '  id = :Old_id')
    SQLUpdate.Strings = (
      'UPDATE sports.leagues_view'
      'SET'
      
        '  id = :id, league_name = :league_name, country_id = :country_id' +
        ', league_position = :league_position, league_code = :league_code' +
        ', db_schema_id = :db_schema_id, remote_id = :remote_id, promoted' +
        'css = :promotedcss, playoffcss = :playoffcss, championscss = :ch' +
        'ampionscss, playoutcss = :playoutcss, relegationcss = :relegatio' +
        'ncss, all_players = :all_players, jguid = :jguid, deleted = :del' +
        'eted'
      'WHERE'
      '  id = :Old_id')
    SQLLock.Strings = (
      'SELECT * FROM sports.leagues_view'
      'WHERE'
      '  id = :Old_id'
      'FOR UPDATE NOWAIT')
    SQLRefresh.Strings = (
      
        'SELECT id, league_name, country_id, league_position, league_code' +
        ', db_schema_id, remote_id, promotedcss, playoffcss, championscss' +
        ', playoutcss, relegationcss, all_players, jguid, deleted FROM sp' +
        'orts.leagues_view'
      'WHERE'
      '  id = :id')
    SQLRecCount.Strings = (
    ...
    Connection = PgErgoConnection
    SQL.Strings = (
      'SELECT  l.id as league_id, l.*'
      '  FROM '
      '      sports.leagues_view l '
      
        '  WHERE not exists (select 1 from sports.championships_view f wh' +
        'ere'
    ...
    object qrySelectLeaguesid: TSmallintField
      FieldName = 'id'
    end
    ...
    object qrySelectLeaguescountry_id: TIntegerField
      FieldName = 'country_id'
    end
    object qrySelectLeaguesleague_position: TSmallintField
      FieldName = 'league_position'
    end
    object qrySelectLeaguesleague_code: TWideStringField
      FieldName = 'league_code'
      Size = 6
    end
    object qrySelectLeaguesdb_schema_id: TIntegerField
      FieldName = 'db_schema_id'
    end
    object qrySelectLeaguesremote_id: TSmallintField
      FieldName = 'remote_id'
    end
    object qrySelectLeaguespromotedcss: TWideStringField
      FieldName = 'promotedcss'
      Size = 128
    end
    object qrySelectLeaguesplayoffcss: TWideStringField
      FieldName = 'playoffcss'
      Size = 128
    end
    object qrySelectLeagueschampionscss: TWideStringField
      FieldName = 'championscss'
      Size = 128
    end
    object qrySelectLeaguesplayoutcss: TWideStringField
      FieldName = 'playoutcss'
      Size = 128
    end
    object qrySelectLeaguesrelegationcss: TWideStringField
      FieldName = 'relegationcss'
      Size = 128
    end
    object qrySelectLeaguesall_players: TBooleanField
      FieldName = 'all_players'
    end
    object qrySelectLeaguesjguid: TGuidField
      FieldName = 'jguid'
      Size = 38
    end
    object qrySelectLeaguesdeleted: TBooleanField
      FieldName = 'deleted'
    end
    object qrySelectLeaguesinsert_date: TDateTimeField
      FieldName = 'insert_date'
    end
    object qrySelectLeaguesupdate_date: TDateTimeField
      FieldName = 'update_date'
    end
    object qrySelectLeaguesuser_insert: TWideStringField
      FieldName = 'user_insert'
      Size = 128
    end
    object qrySelectLeaguesuser_update: TWideStringField
      FieldName = 'user_update'
      Size = 128
    end
  end
  ...
  object qrySelectHome: TUniQuery
    ...
    SQL.Strings = (
      ...
      '  and'
        ...
        '  t.team_id not in (select visitors_team_id from football.ft_cal' +
        'endar m where '
      ...
      '  and'
        ...
        '  t.team_id not in (select home_team_id from football.ft_calenda' +
        'r m where '
  ...
  object qryClubSeasons: TUniQuery
    ...
    SQL.Strings = (
      ...
      'from '
      '    sports.club_seasons cs, sports.seasons_view s'
      'where'
      '    cs.season_id = s.id')
    MasterSource = dsClubs
    Left = 176
  ...
  object lkpAllPlayers: TUniQuery
    KeyFields = 'anagraph_id'
    SQLInsert.Strings = (
      'INSERT INTO football.ft_players'
    ...
    object lkpAllPlayersnotes: TWideMemoField
      FieldName = 'notes'
      BlobType = ftWideMemo
    end
  ...
  object qryLkpLeagues: TUniQuery
    ...
    Connection = PgErgoConnection
    SQL.Strings = (
      'select id, league_name, league_code, league_position'
    ...
    Left = 56
    Top = 456
    object qryLkpLeaguesid: TSmallintField
      FieldName = 'id'
      Required = True
    end
  ...
  object spCloneSeasons: TUniStoredProc
    StoredProcName = 'sports.cloneseason'
    SQL.Strings = (
      'SELECT sports.cloneseason(:new_season_id, :old_season_id)')
    Connection = PgErgoConnection
    Left = 288
    Top = 72
    ParamData = <
