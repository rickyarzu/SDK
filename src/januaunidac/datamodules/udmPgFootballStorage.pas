...
uses
  ...
  PostgreSQLUniProvider, VirtualTable, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param,
...
begin
  inherited;
  qryMatchesmatch_name.AsWideString := qryMatcheshome_team.AsWideString + ' - ' + qryMatchesvisitors_team.AsWideString;
end;

procedure TdmPgFootballStorage.RefreshDetails;
begin
  inherited;
