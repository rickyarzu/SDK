inherited dmPgCmsStorage: TdmPgCmsStorage
  ...
  object dsMainArguments: TUniDataSource
  ...
  object dsArguments: TUniDataSource
    DataSet = arguments
    Left = 200
    Top = 256
  end
  ...
  object dsSubArguments: TUniDataSource
  ...
  object scMainArgumentsInsert: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'INSERT INTO cms.main_arguments'
  ...
  object scMainArgumentsDelete: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'DELETE FROM cms.main_arguments'
      'WHERE'
  ...
  object scMainArgumentsUpdate: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'UPDATE cms.main_arguments'
      'SET'
  ...
  object qryArticlesList: TUniQuery
    ...
    object qryArticlesListdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  ...
  object qryArgumentsArticles: TUniQuery
    ...
    object qryArgumentsArticlesdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  ...
  object scArticlesInsert: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'INSERT INTO cms.articles'
  ...
  object scArticlesUpdate: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'DELETE FROM cms.main_arguments'
      'WHERE'
  ...
  object scArticlesDelete: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'UPDATE cms.main_arguments'
      'SET'
  ...
  object dsArgumentsArticles: TUniDataSource
    DataSet = qryArgumentsArticles
    Left = 208
    Top = 680
  end
  object Article: TUniQuery
    KeyFields = 'article_id'
    SQLInsert.Strings = (
      'INSERT INTO cms.articles'
    ...
    object Articledatetime: TDateTimeField
      FieldName = 'datetime'
    end
  ...
  object scArgumentsInsert: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'INSERT INTO cms.arguments'
  ...
  object scArgumentsDelete: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'DELETE '
      '  FROM cms.arguments'
  ...
  object scArgumentsUpdate: TUniSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'UPDATE cms.arguments'
      'SET'
  ...
  object qryArgumentsChampionships: TUniQuery
    Connection = PgErgoConnection
    Left = 552
    Top = 144
  end
  object qryLeagues: TUniQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      'select * '
      '   from '
  ...
  object cdsArgumentsArticles: TClientDataSet
    ...
    object cdsArgumentsArticlesdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  end
  object qryArgumentsSeq: TUniQuery
    ...
    object qryArgumentsSeqsysdate: TDateTimeField
      FieldName = 'sysdate'
      ReadOnly = True
    end
  ...
  object qryMainArgumentsSeq: TUniQuery
    ...
    object qryMainArgumentsSeqsysdate: TDateTimeField
      FieldName = 'sysdate'
      ReadOnly = True
    end
  ...
  object dsArticlesList: TUniDataSource
    DataSet = qryArticlesList
    Left = 80
    Top = 176
  end
  object qryArticlesAttachments: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO cms.articles'
  ...
  object dsArticle: TUniDataSource
    DataSet = Article
    Left = 80
    Top = 528
  end
  object ArticleAttachments: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO cms.articles'
  ...
  object qryArgumentArticlesAttachments: TUniQuery
    SQLInsert.Strings = (
  ...
  object qryWarnings: TUniQuery
    ...
    object qryWarningsdatetime: TDateTimeField
      FieldName = 'datetime'
    end
  end
  object qryMainArgumentsMails: TUniQuery
    KeyFields = 'mail_id'
    SQLInsert.Strings = (
