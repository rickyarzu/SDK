...
uses
  ...
  Datasnap.DBClient, MemDS, DBAccess, Uni, Janua.Core.Cms, Janua.Core.System,
...
type
  TdmCms = class(TDataModule)
    ...
    qryArticlesdatetime: TUniTimeStampField;
    ...
    qrySingleArticledatetime: TUniTimeStampField;
    ...
    qryStudioLegaledatetime: TUniTimeStampField;
    ...
    qryNewsFiscodatetime: TUniTimeStampField;
    ...
    qryUserArticledatetime: TUniTimeStampField;
    ...
    qryArticlesSeqsysdate: TUniTimeStampField;
