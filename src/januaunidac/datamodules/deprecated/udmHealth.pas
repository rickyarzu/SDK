...
uses
  System.SysUtils, System.Classes, Janua.Core.Health, Uni,
...
type
  TdmHealth = class(TDataModule)
    ...
    tbHealthProfileassociation_date: TUniDateField;
    ...
    tbHealthProfilecouncil_date: TUniDateField;
    qrySearchDoctorcouncil_number: TWideStringField;
    qrySearchDoctorcouncil_date: TUniDateField;
