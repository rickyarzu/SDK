...
uses
  ...
  Uni, MemDS, DBAccess, Janua.Core.System, Janua.Postgres.Functions,
...
type
  TdmSystemCommand = class(TDataModule)
    ...
    qryUserProfilebirth_date: TUniDateField;
    ...
    qrySearchUserProfilebirth_date: TUniDateField;
...
begin
  ...
  begin
    ...
    begin
      ...
      self.FServerFunctions.PosTUniDataset(qryUserSession);
    end;
