...
type
  ...
  TdmPgAnagraph = class(TdmJanuaPostgresModel)
    ...
    qryAdressessdb_schema_id: TIntegerField;
    qryAdressessid: TLargeintField;
    qryAdressessaddress_name: TWideStringField;
    qryAdressesspostal_code: TWideStringField;
    qryAdressessstate_province: TWideStringField;
    qryAdressesstown_name: TWideStringField;
    qryAdressesstown_code: TWideStringField;
    qryAdressessaddress: TWideStringField;
    qryAdressessaddress_number: TWideStringField;
    qryAdressessphone: TWideStringField;
    qryAdressessfull_address: TWideStringField;
    qryAdressessinsert_date: TDateTimeField;
    qryAdressessupdate_date: TDateTimeField;
    qryAdressessupd_id: TLargeintField;
    qryAdressessins_id: TLargeintField;
    qryAdressessuser_insert: TWideStringField;
    qryAdressessuser_update: TWideStringField;
    qryAdressesslocal: TBooleanField;
    qryAdressessdeleted: TBooleanField;
    qryAdressessjguid: TGuidField;
    qryAdressesscountry_code: TWideStringField;
    qryAdressessemail: TWideStringField;
    qryAdressessanagraph_id: TIntegerField;
    qryAdressessmaps_json: TWideMemoField;
    qryAdressesspos: TSmallintField;
    qryAdressesslongitude: TFloatField;
    qryAdressesslatitude: TFloatField;
    qryAdressessmaster_jguid: TGuidField;
