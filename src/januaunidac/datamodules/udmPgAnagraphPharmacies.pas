...
uses
  ...
  Data.DB, Uni, MemDS,
  DBAccess, Datasnap.Provider, Datasnap.DBClient, UniProvider, PostgreSQLUniProvider;

type
  TdmPgAnagraphPharmacies = class(TdmJanuaPostgresModel)
    qryPharmaciesWebsites: TUniQuery;
    ...
    qrySections: TUniQuery;
    qryPharmaciesServices: TUniQuery;
    qryPharmaciesSections: TUniQuery;
