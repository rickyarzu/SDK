...
type
  TdmUniDacPgChampionships = class(TdmJanuaPostgresModel)
    ...
    lkpAllPlayersrole: TSmallintField;
    ...
    lkpAllPlayerspplr_jguid: TWideStringField;
    lkpAllPlayerspplr_deleted: TBooleanField;
    lkpAllPlayersfullname: TWideStringField;
...
begin
  try
    // self.qryMatchAllPlayers.ParamByName('season_id').AsInteger := self.qrySeasonsid.AsInteger;
    self.qryMatchTeamAllPlayers.ParamByName('season_id').AsInteger := self.qrySeasonsid.AsInteger;
    self.qryTeamsClubsLeagues.Close;
    self.qryTeamsClubsLeagues.ParamByName('season_id').AsInteger := self.qrySeasonsid.AsInteger;
    self.ServerFunctions.OpenDataset(qryTeamsClubsLeagues);
    self.qryClubPlayers.Close;
    self.qryClubPlayers.ParamByName('season_id').AsInteger := self.qrySeasonsid.AsInteger;
    self.ServerFunctions.OpenDataset(qryClubPlayers);
    // qryAllClubPlayers
    self.qryAllClubPlayers.ParamByName('season_id').AsInteger := self.qrySeasonsid.AsInteger;
  except
    on e: exception do
      raise;
