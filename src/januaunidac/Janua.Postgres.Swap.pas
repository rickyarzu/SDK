...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Janua.Core.Functions.CloneDataset(dmPgSwap.qryItemsLikes, dsItemsLikes);
        Janua.Core.Functions.CloneDataset(dmPgSwap.qryEditItem, dsSelectedItem);
      end;
    end
    else
    begin
