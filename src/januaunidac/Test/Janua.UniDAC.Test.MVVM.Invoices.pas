unit Janua.UniDAC.Test.MVVM.Invoices;
...
type
  ...
  [TestFixture]
  TTInvoicesMVVM = class
  private
    FTestCaption: string;
    FTestEnabled: boolean;
    FViewModel: IJanuaInvoicesViewModel;
    FModel: IJanuaInvoicesModel;
...
procedure TTInvoicesMVVM.AttachmentsModel;
begin
  GenerateModel;
...
procedure TTInvoicesMVVM.AttachmentsViewModel;
begin
  GenerateViewModel;
...
procedure TTInvoicesMVVM.DataModule;
var
  lDataModule: IJanuaInvoicesDataModule;
begin

  Assert.IsTrue(TJanuaApplicationFactory.TryGetInterface(IJanuaInvoicesDataModule, lDataModule),
    'IJanuaInvoicesDataModule not registered');
...
procedure TTInvoicesMVVM.DatasetFilter;
var
  lDataModule: IJanuaInvoicesDataModule;
  aParam: IJanuaField;
begin
...
procedure TTInvoicesMVVM.DocChargesModel;
var
...
procedure TTInvoicesMVVM.DocChargesViewModel;
begin
  GenerateViewModel;
  Assert.IsNotNull(FViewModel);
  FViewModel.GenerateSubModels;
...
procedure TTInvoicesMVVM.DocRecord;
var
...
procedure TTInvoicesMVVM.GenerateModel;
var
  aDocHead: IDocHeadView;
begin
  FModel := nil;
  Assert.IsTrue(TJanuaApplicationFactory.TryGetInterface(IJanuaInvoicesModel, FModel),
...
procedure TTInvoicesMVVM.GenerateViewModel;
begin
  FViewModel := nil;
  Assert.IsTrue(TJanuaApplicationFactory.TryGetInterface(IJanuaInvoicesViewModel, FViewModel),
    'IJanuaInvoicesViewModel not registered');
...
procedure TTInvoicesMVVM.LookupTypes;
var
...
procedure TTInvoicesMVVM.Model;
var
  lModel: IJanuaInvoicesModel;
begin

  lModel := nil;
  Assert.IsTrue(TJanuaApplicationFactory.TryGetInterface(IJanuaInvoicesModel, lModel),
    'IJanuaDBAnagraphModel not registered');
...
procedure TTInvoicesMVVM.ModelFilter;
var
  iTest: Integer;
begin
...
procedure TTInvoicesMVVM.RowsModel;
begin
  GenerateModel;
  Assert.IsNotNull(FModel);
  FModel.GenerateSubModels;
...
procedure TTInvoicesMVVM.RowsViewModel;
begin
  GenerateViewModel;
  Assert.IsNotNull(FViewModel);
  FViewModel.GenerateSubModels;
...
procedure TTInvoicesMVVM.Setup;
begin
...
procedure TTInvoicesMVVM.TearDown;
begin
  FModel := nil;
  FViewModel := nil;
...
procedure TTInvoicesMVVM.ViewModel;
var
  lViewModel: IJanuaInvoicesViewModel;
begin

  Assert.IsTrue(TJanuaApplicationFactory.TryGetInterface(IJanuaInvoicesViewModel, lViewModel),
...
procedure TTInvoicesMVVM.ViewModelFilter;
begin
...
TDUnitX.RegisterTestFixture(TTInvoicesMVVM);
