object dlgUniGUICarserviceTimetableCheck: TdlgUniGUICarserviceTimetableCheck
  Left = 0
  Top = 0
  ClientHeight = 249
  ClientWidth = 298
  Caption = 'Verifica Orari prenotazione'
  ...
  object CarServiceSlotSelectionController1: TCarServiceSlotSelectionController
    Enabled = False
    IsTest = True
