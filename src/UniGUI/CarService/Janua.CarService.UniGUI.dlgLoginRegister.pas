unit Janua.CarService.UniGUI.dlgLoginRegister;
...
type
  ...
  TfrmCarServiceUniGUILoginRegister = class(TUniLoginForm)
...
function frmCarServiceUniGUILoginRegister: TfrmCarServiceUniGUILoginRegister;
...
function frmCarServiceUniGUILoginRegister: TfrmCarServiceUniGUILoginRegister;
begin
  Result := TfrmCarServiceUniGUILoginRegister
    (UniMainModule.GetFormInstance(TfrmCarServiceUniGUILoginRegister));
end;

procedure TfrmCarServiceUniGUILoginRegister.btnRegisterClick(Sender: TObject);
begin
  ButtonClick(Btn2Type);
end;

procedure TfrmCarServiceUniGUILoginRegister.ButtonClick(const aBtnType: TBtnType);
begin
  case aBtnType of
    btLogin:
      InternalLogin;
...
procedure TfrmCarServiceUniGUILoginRegister.CallBackMsg(Sender: TComponent; Res: Integer);
begin
  if Res = mrAbort then
    Close;
end;

function TfrmCarServiceUniGUILoginRegister.CheckRegisterEndValues: Boolean;
var
  lError, lSpec: string;
  // A: IAnagraphView;
  U: IUser;
...
function TfrmCarServiceUniGUILoginRegister.CheckRegisterValues: Boolean;
begin
  Result := False;
...
procedure TfrmCarServiceUniGUILoginRegister.chkShowPwdRegisterClick(Sender: TObject);
begin
...
constructor TfrmCarServiceUniGUILoginRegister.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TfrmCarServiceUniGUILoginRegister.GoogleResult1(Sender: TObject);
begin
...
procedure TfrmCarServiceUniGUILoginRegister.btnGoogleSearchClick(Sender: TObject);
begin
...
procedure TfrmCarServiceUniGUILoginRegister.btnLoginClick(Sender: TObject);
begin
  ButtonClick(Btn1Type);
end;

procedure TfrmCarServiceUniGUILoginRegister.chkPasswordClick(Sender: TObject);
begin
  { ledPassword.PasswordChar := JIfThen(chkPassword.Checked, Chr(0), '*') }
end;

procedure TfrmCarServiceUniGUILoginRegister.InternalLogin;
var
  vError: string;
  aUser: IUserProfile;
begin
...
procedure TfrmCarServiceUniGUILoginRegister.JShowError(const aMessage: string; aTitle: string = '');
begin
  MessageDlg(aMessage, TMsgDlgType.mtError, [mbAbort, mbRetry], CallBackMsg);
end;

procedure TfrmCarServiceUniGUILoginRegister.ledPasswordChange(Sender: TObject);
begin
  FUserSession.LocalUserProfile.User.Password.AsString := ledPassword.Text;
...
procedure TfrmCarServiceUniGUILoginRegister.ledProfilePasswordExit(Sender: TObject);
begin
...
procedure TfrmCarServiceUniGUILoginRegister.ledProfilePasswordRepeatExit(Sender: TObject);
begin
...
procedure TfrmCarServiceUniGUILoginRegister.ledUserNameChange(Sender: TObject);
begin
  FUserSession.LocalUserProfile.User.Username.AsString := ledUserName.Text;
...
procedure TfrmCarServiceUniGUILoginRegister.RegisterAnagraphProfile;
begin
...
procedure TfrmCarServiceUniGUILoginRegister.RegisterEnd;
begin
...
procedure TfrmCarServiceUniGUILoginRegister.RegisterNext;
begin
  if CheckRegisterValues then
    SetLoginPage(TLoginPage.lpRegisterEnd);
end;

procedure TfrmCarServiceUniGUILoginRegister.RegisterPrev;
begin
...
procedure TfrmCarServiceUniGUILoginRegister.RegisterStart;
begin
...
procedure TfrmCarServiceUniGUILoginRegister.SetButtonCaptions;
begin
...
procedure TfrmCarServiceUniGUILoginRegister.SetBtn1Type(const Value: TBtnType);
begin
  FBtn1Type := Value;
  SetButtonCaptions;
end;

procedure TfrmCarServiceUniGUILoginRegister.SetBtn2Type(const Value: TBtnType);
begin
  FBtn2Type := Value;
  SetButtonCaptions;
end;

procedure TfrmCarServiceUniGUILoginRegister.SetLoginPage(const Value: TLoginPage);
begin
  FLoginPage := Value;
  Case FLoginPage of
    TLoginPage.lpLogin:
...
function TfrmCarServiceUniGUILoginRegister.TestLoginRegister: Boolean;
begin
  Result := UniMainModule.TryLoginOrRegister;
end;

procedure TfrmCarServiceUniGUILoginRegister.UniButton1Click(Sender: TObject);
begin
  // DtPicker.DateTime := Date();
end;

procedure TfrmCarServiceUniGUILoginRegister.UniImage1Click(Sender: TObject);
begin
  ShowMessage('Cliccato');
end;

procedure TfrmCarServiceUniGUILoginRegister.UniLoginFormCreate(Sender: TObject);
begin
  SetLoginPage(TLoginPage.lpLogin);
...
procedure TfrmCarServiceUniGUILoginRegister.UniLoginFormShow(Sender: TObject);
begin
  pgUserLoginRegister.ActivePage := tsLogin;
  pgUserLoginRegister.ActivePageIndex := 0;
end;
...
RegisterAppFormClass(TfrmCarServiceUniGUILoginRegister);
