...
type
  TJanuaDataset = class(TComponent)
  private
  ...
  public
    ...
    procedure Open;
    procedure SetParams(paramname: MemUtils._string; parvalue: integer); overload;
    procedure SetParams(paramname: MemUtils._string; parvalue: int64); overload;
    procedure SetParams(paramname: MemUtils._string; parvalue: widestring); overload;
    procedure SetParams(paramname: MemUtils._string; parvalue: string); overload;
    procedure SetParams(paramname: MemUtils._string; parvalue: TDateTime); overload;
  published
    ...
    property DatasetType:  TJanuaDatasetType read FDatasetType write SetDatasetType default jdtRecordSet;
...
procedure Register;
begin
  RegisterComponents('JanuaOracle', [TJanuaDataset]);
end;
}

{ TJanuaDataset }

procedure TJanuaDataset.AssignClientDataset;
var
  op: TOraProvider;
begin
...
procedure TJanuaDataset.AssignMemoryDataset;
var
  a: TStream;
begin
...
constructor TJanuaDataset.Create(AOwner: TComponent);
var
  i: integer;
begin
  inherited;
...
procedure TJanuaDataset.SetActive(const Value: Boolean);
begin
  FActive := Value;
...
procedure TJanuaDataset.SetClientDataset(const Value: TClientDataset);
begin
  FClientDataset := Value;
end;


procedure TJanuaDataset.SetDatasetProvider(const Value: TDatasetProvider);
begin
  FDatasetProvider := Value;
  if assigned(FDatasetProvider) then FDatasetProvider.DataSet := FDataset;
end;

procedure TJanuaDataset.SetDatasetType(const Value: TJanuaDatasetType);
begin
  FDatasetType := Value;
end;

procedure TJanuaDataset.SetDataSource(const Value: TDataSource);
begin
  FDataSource := Value;
  if Assigned(FDataSet) then FDataSource.DataSet := FDataSet; 
end;

procedure TJanuaDataset.SetDatset(NewDataset: TOraDataset);
begin
   FDataset := NewDataset;
...
procedure TJanuaDataset.SetInternalDataset;
begin
...
procedure TJanuaDataset.SetJanuaSessionSource(const Value: TJanuaSessionSource);
begin
  FJanuaSessionSource := Value;
end;


procedure TJanuaDataset.SetParams(paramname: MemUtils._string;
  parvalue: int64);
begin
...
procedure TJanuaDataset.SetParamType(ParamName: string;
...
procedure TJanuaDataset.SetRecordCount(const Value: integer);
begin
  FRecordCount := Value;
end;

procedure TJanuaDataset.SetUseClientDataset(const Value: boolean);
begin
...
procedure TJanuaDataset.SetUseMemoryDataset(const Value: boolean);
begin
