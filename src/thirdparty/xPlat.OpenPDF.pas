...
uses
  System.SysUtils, IdURI, FMX.Forms, System.Classes, System.IOUtils, FMX.WebBrowser, FMX.Types, FMX.StdCtrls
{$IF defined(ANDROID)}
    , Androidapi.JNI.GraphicsContentViewText, FMX.Helpers.Android, Androidapi.Helpers, AndroidSDK.Toast,
  Androidapi.JNI.Net, Androidapi.JNI.App, Androidapi.JNI.JavaTypes
{$ENDIF}
{$IF defined(IOS)}
    , iOSapi.Foundation, Macapi.Helpers, FMX.Helpers.iOS, FMX.Dialogs
{$ENDIF}
    ;
