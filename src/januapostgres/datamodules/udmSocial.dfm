inherited dmSocial: TdmSocial
  ...
  object spInsertMessage: TPgStoredProc
  ...
  object qryMessages: TPgQuery
    ...
    object qryMessagesmsg_datetime: TSQLTimeStampField
  ...
  object spDeleteMessage: TPgStoredProc
  ...
  object qryMessageCount: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
  ...
  object qryMessagesNotRead: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      'select  *'
      ' from social.messages a'
    ...
    object qryMessagesNotReadmsg_datetime: TSQLTimeStampField
      FieldName = 'msg_datetime'
    end
  ...
  object qryDeleteMessage: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      'delete'
      '  FROM social.messages a'
