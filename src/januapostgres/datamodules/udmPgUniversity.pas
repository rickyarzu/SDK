...
uses
  ...
  System.Classes,
  udmJanuaPostgresModel, Data.DB, PgAccess, MemDS, DBAccess, Datasnap.DBClient,
  Datasnap.Provider,
  Janua.Core.Classes, Janua.Postgres.Functions;

type
  TdmPgUniversity = class(TdmJanuaPostgresModel)
    qryUniversities: TPgQuery;
  ...
  public
    ...
    procedure CloneUniversities(var aTarget: TClientDataSet);
...
procedure TdmPgUniversity.CloneUniversities(var aTarget: TClientDataSet);
var
