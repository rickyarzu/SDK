inherited dmPgAnagraphPharmacies: TdmPgAnagraphPharmacies
  ...
  object qryPharmaciesWebsites: TPgQuery
    SQLInsert.Strings = (
  ...
  object qryPharmaciesServices: TPgQuery
    Connection = PgErgoConnection
    Left = 176
    Top = 88
  end
  object qryPharmaciesSections: TPgQuery
    Connection = PgErgoConnection
    Left = 176
    Top = 144
  end
