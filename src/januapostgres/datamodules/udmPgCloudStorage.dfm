inherited dmPgCloudStorage: TdmPgCloudStorage
  ...
  object qryBlobSequence: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
  ...
  object spSaveImage: TPgStoredProc
  ...
  object spSaveFile: TPgStoredProc
  ...
  object scDeleteBlobFile: TPgSQL
    Connection = PgErgoConnection
    SQL.Strings = (
      'DELETE'
      '  FROM cloud.blob_files b'
  ...
  object qryImages: TPgQuery
    KeyFields = 'external_file_id'
    KeySequence = 'cloud.images_seq'
  ...
  object qrySearchBlobFiles: TPgQuery
    SQLDelete.Strings = (
      'DELETE FROM cloud.blob_files'
      'WHERE'
      '  blob_id = :Old_blob_id')
