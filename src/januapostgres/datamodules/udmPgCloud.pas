...
uses
  System.SysUtils, System.Classes, Data.DB, MemDS, DBAccess, PgAccess, Janua.Core.Types,
  Janua.Core.Classes, Janua.Cloud.Files.Intf,
  Janua.Core.Functions, Janua.Core.Cloud, Janua.Postgres.Functions,
  System.DateUtils, MemData, Janua.Cloud.Images.Intf,
  System.ConvUtils, Janua.Core.System, DASQLMonitor, PgSQLMonitor,
  udmJanuaPostgresModel, Janua.Core.Exceptions, DAScript, PgScript;
...
procedure TdmPostgresCloud.DSServerModuleDestroy(Sender: TObject);
begin
  inherited;
end;
