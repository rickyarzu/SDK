inherited dmPgBooks: TdmPgBooks
  ...
  object qryPublicBooksDef: TPgQuery
    SQLInsert.Strings = (
    ...
    object qryPublicBooksDefrelease_date: TPgDateField
  ...
  object qryBooksOffers: TPgQuery
    SQLInsert.Strings = (
    ...
    object qryBooksOffersvalid_since: TPgDateField
      FieldName = 'valid_since'
    end
    object qryBooksOffersvalid_until: TPgDateField
    ...
    object qryBooksOffersrelease_date: TPgDateField
      FieldName = 'release_date'
    end
