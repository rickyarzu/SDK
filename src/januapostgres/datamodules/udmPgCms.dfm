inherited dmPgCms: TdmPgCms
  ...
  object qryArticles: TPgQuery
    ...
    object qryArticlesdatetime: TSQLTimeStampField
      FieldName = 'datetime'
      ReadOnly = True
    end
  ...
  object qrySingleArticle: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
    ...
    object qrySingleArticledatetime: TSQLTimeStampField
      FieldName = 'datetime'
    end
  ...
  object qryStudioLegale: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
      'select  b.*, '
    ...
    object qryStudioLegaledatetime: TSQLTimeStampField
      FieldName = 'datetime'
      ReadOnly = True
    end
  ...
  object qryNewsFisco: TPgQuery
    ...
    object qryNewsFiscodatetime: TSQLTimeStampField
      FieldName = 'datetime'
      ReadOnly = True
    end
  ...
  object prcNewArticle: TPgStoredProc
  ...
  object qryNews: TPgQuery
    KeyFields = 'id'
    KeySequence = 'cms.news_seq'
    DataTypeMap = <
      item
        FieldName = 'imagetext'
  ...
  object qryEvents: TPgQuery
    KeyFields = 'id'
    KeySequence = 'cms.events_seq'
    Connection = PgErgoConnection
    SQL.Strings = (
