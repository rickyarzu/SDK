...
uses
  System.SysUtils, System.Classes, PgAccess, Data.DB, MemDS, DBAccess,
   udmPgStorage,
  Janua.Postgres.Functions, Janua.Core.Classes, Janua.Core.System,
   Datasnap.Provider, Datasnap.DBClient,  udmJanuaPostgresModel;
...
type
  ...
  /// schema in database.
  /// </summary>
  TdmPgAnagraphStorage = class(TdmPgStorage)
    qrySearchAddress: TPgQuery;
    qryAnagraphs: TPgQuery;
    qryGroups: TPgQuery;
    ...
    sqlInsertIdentity: TPgSQL;
    qryIdentities: TPgQuery;
    ...
    qrySearchAddresssmsdate: TSQLTimeStampField;
    ...
    qryAnagraphCategoriesMView: TPgQuery;
...
var
  dmPgAnagraphStorage: TdmPgAnagraphStorage;
...
procedure TdmPgAnagraphStorage.DataModuleCreate(Sender: TObject);
begin
  inherited;
  // Verifico che sia stato creato il datamodule anagrafica .......
end;

function TdmPgAnagraphStorage.FindAddresbyID(aID: integer): boolean;
begin
...
function TdmPgAnagraphStorage.FindAddress(sSearch: string): integer;
begin
  qrySearchAddress.Close;
...
procedure TdmPgAnagraphStorage.OpenAnagraphByGroup(gID: Integer);
begin
...
procedure TdmPgAnagraphStorage.qryAnagraphsAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TdmPgAnagraphStorage.qryAnagraphsAfterPost(DataSet: TDataSet);
begin
  inherited;
  qryIdentities.Close;
  qryIdentities.Open;
  ...
  begin
    sqlInsertIdentity.ParamByName('db_schema_id').Value := JanuaApplicationGlobalProfile.DBSchemaID;
...
procedure TdmPgAnagraphStorage.qryAnagraphsAfterScroll(DataSet: TDataSet);
begin
  inherited;
...
procedure TdmPgAnagraphStorage.qryAnagraphsBeforeOpen(DataSet: TDataSet);
begin
  inherited;
  qryAnagraphs.ParamByName('db_schema_id').Value := JanuaApplicationGlobalProfile.DBSchemaID;
end;

procedure TdmPgAnagraphStorage.qryAnagraphsNewRecord(DataSet: TDataSet);
begin
  inherited;
  qryAnagraphsdb_schema_id.AsInteger := JanuaApplicationGlobalProfile.DBSchemaID;
...
procedure TdmPgAnagraphStorage.qryGroupsAfterScroll(DataSet: TDataSet);
begin
  inherited;
...
procedure TdmPgAnagraphStorage.qryIdentitiesBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TdmPgAnagraphStorage.qrySubAnagraphsAfterOpen(DataSet: TDataSet);
begin
  inherited;
  ServerFunctions.OpenDataset(qrySubIdentities);
end;

procedure TdmPgAnagraphStorage.qrySubAnagraphsAfterPost(DataSet: TDataSet);
begin
  inherited;
...
procedure TdmPgAnagraphStorage.qrySubAnagraphsBeforeOpen(DataSet: TDataSet);
begin
  inherited;
  qrySubAnagraphs.ParamByName('db_schema_id').Value := JanuaApplicationGlobalProfile.DBSchemaID
end;

function TdmPgAnagraphStorage.SearchAnagraphByID(aID: integer): boolean;
begin
...
function TdmPgAnagraphStorage.SearchAnagraphByName(aName: string): integer;
begin
...
function TdmPgAnagraphStorage.SetAnagraphGroupByID(gID: integer): boolean;
var
  aTest, bTest: boolean;
begin
...
procedure TdmPgAnagraphStorage.SetAnagraph_id(const Value: integer);
begin
  FAnagraph_id := Value;
  self.SearchAnagraphByID(Value)
end;

procedure TdmPgAnagraphStorage.Setdb_schema_id(const Value: integer);
begin
  Fdb_schema_id := Value;
end;

procedure TdmPgAnagraphStorage.SetGroup_id(const Value: integer);
begin
  FGroup_id := Value;
