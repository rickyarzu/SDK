inherited dmPgAnagraphStorage: TdmPgAnagraphStorage
  OldCreateOrder = True
  Height = 621
  Width = 642
  ...
  object qrySearchAddress: TPgQuery
    ...
    object qrySearchAddresssmsdate: TSQLTimeStampField
      FieldName = 'smsdate'
    end
  ...
  object qryAnagraphs: TPgQuery
    ...
    SQLInsert.Strings = (
      'INSERT INTO anagraph.anagraphs'
        ...
        'ain_category_id, osm_id, an_description, an_address_number)'
      'VALUES'
    ...
    SQLRefresh.Strings = (
        ...
        '4, main_category_id, osm_id, an_description, an_address_number F' +
  ...
  object sqlInsertIdentity: TPgSQL
    Connection = PgErgoConnection
    SQL.Strings = (
  ...
  object qrySubAnagraphs: TPgQuery
    KeyFields = 'anagraph_id'
    KeySequence = 'anagraph.an_anagraph_seq'
    SQLInsert.Strings = (
      'INSERT INTO anagraph.anagraphs'
  ...
  object qrySubIdentities: TPgQuery
    SQLInsert.Strings = (
      'INSERT INTO anagraph.identities'
  ...
  object qryAnagraphCategoriesMView: TPgQuery
    Connection = PgErgoConnection
    SQL.Strings = (
