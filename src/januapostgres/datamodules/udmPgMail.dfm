inherited dmMail: TdmMail
  ...
  object qryMail: TPgQuery
    ...
    object qryMailinsert_date: TPgTimeStampField
      FieldName = 'insert_date'
    end
    object qryMailupdate_date: TPgTimeStampField
