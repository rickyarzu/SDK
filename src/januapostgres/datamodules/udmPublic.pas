...
uses
  ...
  Janua.Core.Functions, Datasnap.Provider, Janua.Core.Types,
...
type
  TdmPgCountriesLocal = class(TdmJanuaPostgresModel)
    ...
    dsLkpTowns: TPgDataSource;
    qryLkpTowns: TPgQuery;
