...
uses
  ...
  // Database
  Data.DB, DBAccess, PgAccess, MemDS, Datasnap.Provider, Datasnap.DBClient, Janua.Core.Exceptions;

{$METHODINFO ON}

type
  TdmHealthBooking = class(TdmJanuaPostgresModel)
    qryCompanies: TPgQuery;
    qryInstitutes: TPgQuery;
    dsCompanies: TDataSource;
    dsInstitutes: TDataSource;
    qryInstitutesDisciplines: TPgQuery;
    ...
    qryLkpItems: TPgQuery;
    qryLkpItemsid: TLargeintField;
    qryInstitutesServices: TPgQuery;
    ...
    qrySearchServices: TPgQuery;
    qrySearchInstitutes: TPgQuery;
    dsSearchInstitutes: TDataSource;
    qrySearchItem: TPgQuery;
    ...
    qryServicesNextVal: TPgQuery;
    qryAnagraphNextVal: TPgQuery;
    ...
    qryBookings: TPgQuery;
    dsBookings: TDataSource;
    qryBookingRows: TPgQuery;
    qrySearchAnagraph: TPgQuery;
    qryInstitutesServicesspeciality: TWideStringField;
    spBooking: TPgStoredProc;
    spAssignBooking: TPgStoredProc;
    qryBookingInstitutes: TPgQuery;
    spbookingInstitutes: TPgStoredProc;
    qrySearchServicessearch: TWideStringField;
    qrySearchServicesid: TLargeintField;
    spBookingFinalisation: TPgStoredProc;
    qryInstitutesItemsselected: TBooleanField;
    qryLkpServices: TPgQuery;
    qryBookingPrescription: TPgQuery;
    qryRelative: TPgQuery;
    ...
    spInstituteConfirmation: TPgStoredProc;
    ...
    qryBookingsclosed_date: TSQLTimeStampField;
    qryBookingssent: TBooleanField;
    qryBookingssent_date: TSQLTimeStampField;
    qryBookingsreceived: TBooleanField;
    qryBookingsreceived_date: TSQLTimeStampField;
    ...
    qryBookingsinsert_date: TSQLTimeStampField;
    qryBookingsupdate_date: TSQLTimeStampField;
    ...
    qryBookingsinsert_date_1: TSQLTimeStampField;
    ...
    qryBookingsemaildate: TSQLTimeStampField;
    ...
    qryBookingssmsdate: TSQLTimeStampField;
    ...
    qryBookingRowsclosed_date: TSQLTimeStampField;
    ...
    qryBookingRowssent_date: TSQLTimeStampField;
    qryBookingRowsreceived: TBooleanField;
    qryBookingRowsreceived_date: TSQLTimeStampField;
    ...
    qryBookingRowsinsert_date: TSQLTimeStampField;
    qryBookingRowsupdate_date: TSQLTimeStampField;
    ...
    qryBookingInstitutesclosed_date: TSQLTimeStampField;
    ...
    qryBookingInstitutessent_date: TSQLTimeStampField;
    qryBookingInstitutesreceived: TBooleanField;
    qryBookingInstitutesreceived_date: TSQLTimeStampField;
    ...
    qryBookingInstitutesinsert_date: TSQLTimeStampField;
    qryBookingInstitutesupdate_date: TSQLTimeStampField;
    ...
    qryBookingNotifications: TPgQuery;
    ...
    qryBookingNotificationsdatetime: TSQLTimeStampField;
    ...
    qryNotificationdatetime: TSQLTimeStampField;
    ...
    qryMeetingsclosed_date: TSQLTimeStampField;
    ...
    qryMeetingssent_date: TSQLTimeStampField;
    qryMeetingsreceived: TBooleanField;
    qryMeetingsreceived_date: TSQLTimeStampField;
    ...
    qryMeetingsinsert_date: TSQLTimeStampField;
    qryMeetingsupdate_date: TSQLTimeStampField;
    ...
    qryMeetingsclosed_date_1: TSQLTimeStampField;
    qryMeetingssent_1: TBooleanField;
    qryMeetingssent_date_1: TSQLTimeStampField;
    qryMeetingsreceived_1: TBooleanField;
    qryMeetingsreceived_date_1: TSQLTimeStampField;
    ...
    qryMeetingsinsert_date_1: TSQLTimeStampField;
    qryMeetingsupdate_date_1: TSQLTimeStampField;
  ...
  public
    ...
    procedure SearchInstitutes(aSessionID: Int64; aUserID, aServiceID: integer; aCoordinates: TJanuaCoordinates;
      const iLimit: integer = 10; const iPage: integer = 1);
...
begin
  ...
  begin
    self.FCoordinates.Coordinates := getGeoCoding(aDataset.FieldByName('an_address').AsWideString + ' ' +
      aDataset.FieldByName('an_postal_code').AsWideString + ' ' + aDataset.FieldByName('an_town').AsWideString);
    aDataset.Edit;
...
var
  GeoCoding: Janua.Core.Cloud.TJanuaStreetMap;
begin
  GeoCoding := Janua.Core.Cloud.TJanuaStreetMap.Create(self);
  try
...
function TdmHealthBooking.InstituteConfirmation(const vBookingID: Int64; const vInstituteID: integer): boolean;
begin
...
begin
  try
    ...
    self.spBookingFinalisation.ParamByName('person_address').AsWideString := aBooking.Relative.Address.Address;
    ...
    // Health Prescription .............................................................................
    self.spBookingFinalisation.ParamByName('pr_first_code').AsWideString := aBooking.HealthPrescription.first_code;
    self.spBookingFinalisation.ParamByName('pr_second_code').AsWideString := aBooking.HealthPrescription.second_code;
    self.spBookingFinalisation.ParamByName('pr_province').AsWideString := aBooking.HealthPrescription.province;
    self.spBookingFinalisation.ParamByName('pr_first_name').AsWideString := aBooking.HealthPrescription.first_name;
    self.spBookingFinalisation.ParamByName('pr_last_name').AsWideString := aBooking.HealthPrescription.last_name;
    self.spBookingFinalisation.ParamByName('pr_fiscal_code').AsWideString := aBooking.HealthPrescription.fiscal_code;
    ...
    self.spBookingFinalisation.ParamByName('pr_priority').AsWideString := aBooking.HealthPrescription.priority;
    spBookingFinalisation.ExecProc;
    Result := spBookingFinalisation.ParamByName('result').AsBoolean;
  except
    on e: exception do
      raise exception.Create('TdmHealthBooking.BookingFinalisation Booking=' + aBooking.id.ToString + sLineBreak +
        e.Message);
  end;
end;

function TdmHealthBooking.BookingInstitutes(aInstitute1, aInstitute2, aInstitute3: integer; aBookingID: Int64): Int64;
begin
