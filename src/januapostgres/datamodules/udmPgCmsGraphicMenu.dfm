inherited dmPgCmsGraphicMenu: TdmPgCmsGraphicMenu
  ...
  object dsGMenus: TPgDataSource
    DataSet = qryGMenus
    Left = 160
    Top = 104
  end
  object qryGMenuGroups: TPgQuery
    SQLInsert.Strings = (
  ...
  object dsGMenuGroups: TPgDataSource
    DataSet = qryGMenuGroups
    Left = 160
    Top = 216
  end
  object qryGMenuRows: TPgQuery
    SQLInsert.Strings = (
  ...
  object dsGMenuRows: TPgDataSource
