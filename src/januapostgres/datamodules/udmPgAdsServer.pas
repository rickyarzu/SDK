...
uses
  ...
  System.Classes,
  udmJanuaPostgresModel, Data.DB, PgAccess, MemDS, DBAccess, Janua.Core.Ads,
  Janua.Core.Classes, Janua.Postgres.Functions, Datasnap.Provider, Datasnap.DBClient;

type
  TdmPgAdsServer = class(TdmJanuaPostgresModel)
    spAds: TPgStoredProc;
    spBanner: TPgStoredProc;
    qryBanners: TPgQuery;
