...
{$IFDEF MSWINDOWS}
  MidasLib,
{$ENDIF}
  Datasnap.DBClient, MemDS, DBAccess, PgAccess, Data.DB,
  Janua.Core.Classes, Janua.Core.Football,  Janua.football.Types,
  udlgFootballSelectTeamClubPlayers;

type
  TdmFootballModel = class(TDataModule)
    ...
    qryTeams: TPgQuery;
    dsClubs: TDataSource;
    qryTeamsChampionships: TPgQuery;
    ...
    qryMatchDaysmatch_day_date: TPgDateField;
    qryMatchDaysmatch_day_played: TPgDateField;
    qryMatchesmatch_date: TPgDateField;
    ...
    qryTeamChampPlayerssince: TPgDateField;
    qryTeamChampPlayersuntil: TPgDateField;
    ...
    qryClubsFoundation_date: TPgDateField;
    ...
    qryCloneSeason: TPgQuery;
    qryTeamPlayersanagraph_id: TIntegerField;
    qryTeamPlayersbirth_date: TPgDateField;
    ...
    qryAllPlayers: TPgQuery;
    dsTeamLastSeason: TDataSource;
    qryTeamPlayersLast: TPgQuery;
    qryTeamsClubsLeagues: TPgQuery;
    qryAllPlayersanagraph_id: TIntegerField;
    qryAllPlayersbirth_date: TPgDateField;
    ...
    qryTeamPlayersLastsince: TPgDateField;
    qryTeamPlayersLastuntil: TPgDateField;
    qryTeamPlayersLastanagraph_id: TIntegerField;
    qryTeamPlayersLastbirth_date: TPgDateField;
    ...
    qryClubPlayers: TPgQuery;
    StringField1: TStringField;
    dsClubPlayers: TDataSource;
    qryAllClubPlayers: TPgQuery;
    ...
    qryAllClubPlayerssince: TPgDateField;
    qryAllClubPlayersuntil: TPgDateField;
    qryAllClubPlayersanagraph_id: TIntegerField;
    qryAllClubPlayersbirth_date: TPgDateField;
    ...
    qryClubPlayerssince: TPgDateField;
    qryClubPlayersuntil: TPgDateField;
    qryClubPlayersanagraph_id: TIntegerField;
    qryClubPlayersbirth_date: TPgDateField;
    ...
    qryMatchTeamAllPlayers: TPgQuery;
    ...
    qryMatchTeamAllPlayerssince: TPgDateField;
    qryMatchTeamAllPlayersuntil: TPgDateField;
    qryMatchTeamAllPlayersanagraph_id: TIntegerField;
    qryMatchTeamAllPlayersbirth_date: TPgDateField;
    ...
    qryTeamChampPlayersbirth_date: TPgDateField;
    ...
    qryAllTeamPlayers: TPgQuery;
    qryAllTeamPlayersanagraph_id: TIntegerField;
    qryAllTeamPlayersbirth_date: TPgDateField;
    ...
    qryVerificaMatchesmatch_date: TPgDateField;
    ...
    qryMatchesinsert_date: TPgTimeStampField;
    qryMatchesupdate_date: TPgTimeStampField;
...
var
  dmFootballModel: TdmFootballModel;
...
procedure TdmFootballModel.CloneSeason(OldSeason, NewSeason: integer);
begin
  // procedure che clona una stagione in un'altra stagione incluso squadre iscritte?

end;

procedure TdmFootballModel.CloseTeamClubPlayers;
begin
  qryAllTeamPlayers.Close;
  qryClubAllPlayers.Close;
end;

procedure TdmFootballModel.CopyTeamPlayers(FSelectedForm: TJanuaFooballForm);
begin
...
procedure TdmFootballModel.DataModuleCreate(Sender: TObject);
begin
...
function TdmFootballModel.ExportRank2Column: string;
begin
...
function TdmFootballModel.ExportRank6Column: string;
begin
  self.qryChampRanking.First;
  while not self.qryChampRanking.Eof do
  begin
...
function TdmFootballModel.ExportRank8Column: string;
begin
  self.qryChampRanking.First;
  while not self.qryChampRanking.Eof do
  begin
...
procedure TdmFootballModel.MembershipPlayer;
begin

end;

procedure TdmFootballModel.PgConnection1BeforeConnect(Sender: TObject);
begin
...
procedure TdmFootballModel.qryAllClubPlayersBeforeOpen(DataSet: TDataSet);
begin
...
procedure TdmFootballModel.qryAllTeamPlayersBeforeOpen(DataSet: TDataSet);
begin
  { SELECT
    t.*, p.*,
...
procedure TdmFootballModel.qryClubsAfterOpen(DataSet: TDataSet);
begin
  self.qryTeams.Open;
...
procedure TdmFootballModel.qryClubsCalcFields(DataSet: TDataSet);
begin
  qryClubssearch_name.Value := UpperCase(qryClubsclub_name.AsWideString);
end;

procedure TdmFootballModel.qryMatchDaysAfterOpen(DataSet: TDataSet);
begin
  self.qryMatches.Open;
end;

procedure TdmFootballModel.qryMatchesAfterScroll(DataSet: TDataSet);
begin
...
procedure TdmFootballModel.qryMatchEventsBeforePost(DataSet: TDataSet);
begin
...
procedure TdmFootballModel.qryMatchTeamAllPlayersNewRecord(DataSet: TDataSet);
begin
...
procedure TdmFootballModel.qryMatchTeamPlayersNewRecord(DataSet: TDataSet);
begin
...
procedure TdmFootballModel.qryMatchTeamsAfterScroll(DataSet: TDataSet);
begin
  try
...
procedure TdmFootballModel.qrySeasonsAfterScroll(DataSet: TDataSet);
begin
  try
...
procedure TdmFootballModel.qrySeasonsNewRecord(DataSet: TDataSet);
begin
  qrySeasonsdb_schema_id.Value := 0;
end;

procedure TdmFootballModel.qrySelectHomeBeforeOpen(DataSet: TDataSet);
begin
  qrySelectHome.ParamByName('match_day_number').AsInteger :=
    self.qryMatchDaysmatch_day_number.AsInteger;
end;

procedure TdmFootballModel.qrySelectVisitorsBeforeOpen(DataSet: TDataSet);
begin
  qrySelectVisitors.ParamByName('match_day_number').AsInteger :=
    self.qryMatchDaysmatch_day_number.AsInteger;
end;

procedure TdmFootballModel.qryTeamChampPlayersNewRecord(DataSet: TDataSet);
begin
  qryTeamChampPlayersteam_id.AsInteger := qryTeamsChampionshipsteam_id.AsInteger;
  qryTeamChampPlayersseason_id.AsInteger := qryTeamsChampionshipsseason_id.AsInteger;
end;

procedure TdmFootballModel.qryTeamPlayersCalcFields(DataSet: TDataSet);
begin
...
procedure TdmFootballModel.qryTeamsAfterOpen(DataSet: TDataSet);
begin
  self.qryTeamHistory.Open;
end;

procedure TdmFootballModel.qryTeamsAfterScroll(DataSet: TDataSet);
begin
  try
...
procedure TdmFootballModel.qryTeamsChampionshipsAfterScroll(DataSet: TDataSet);
begin
  try
...
procedure TdmFootballModel.qryTeamsLastSeasonBeforeOpen(DataSet: TDataSet);
begin
  try
...
procedure TdmFootballModel.RefreshTeamClubPlayers(FSelectedForm: TJanuaFooballForm);
begin
...
procedure TdmFootballModel.SetFSelectedForm(const Value: TJanuaFooballForm);
begin
  FSelectedForm := Value;
end;

procedure TdmFootballModel.SetJanuaServerSession(const Value: TJanuaServerSession);
begin
...
procedure TdmFootballModel.SetLog(const Value: TStrings);
begin
  FLog := Value;
end;
