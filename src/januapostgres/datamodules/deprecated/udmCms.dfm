object dmCms: TdmCms
  ...
  object qryArticles: TPgQuery
    ...
    object qryArticlesdatetime: TPgTimeStampField
      FieldName = 'datetime'
      ReadOnly = True
    end
  ...
  object qrySingleArticle: TPgQuery
    ...
    object qrySingleArticledatetime: TPgTimeStampField
      FieldName = 'datetime'
    end
  ...
  object qryStudioLegale: TPgQuery
    ...
    object qryStudioLegaledatetime: TPgTimeStampField
      FieldName = 'datetime'
      ReadOnly = True
    end
  ...
  object qryNewsFisco: TPgQuery
    ...
    object qryNewsFiscodatetime: TPgTimeStampField
      FieldName = 'datetime'
      ReadOnly = True
    end
  ...
  object qryUserArticle: TPgQuery
    ...
    object qryUserArticledatetime: TPgTimeStampField
      FieldName = 'datetime'
    end
  ...
  object qryArticlesSeq: TPgQuery
    ...
    object qryArticlesSeqsysdate: TPgTimeStampField
      FieldName = 'sysdate'
      ReadOnly = True
    end
