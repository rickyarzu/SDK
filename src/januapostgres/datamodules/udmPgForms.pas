...
uses
  ...
  udmJanuaPostgresModel, Data.DB, PgAccess, MemDS, DBAccess, Janua.Core.Types,
...
type
  TdmPgForms = class(TdmJanuaPostgresModel)
    qryForms: TPgQuery;
    dsForms: TDataSource;
    qryFormsTranslations: TPgQuery;
    qryObjects: TPgQuery;
    dsObjects: TDataSource;
    qryProperties: TPgQuery;
    dsProperties: TDataSource;
    qryPropertiesTranslations: TPgQuery;
    qrySearchForms: TPgQuery;
    ...
    qryFormsObjectsTranslations: TPgQuery;
