inherited dmPublic: TdmPublic
  ...
  object qryLkpCountryName: TPgQuery
    DataTypeMap = <
      item
        FieldName = 'creation_date'
        FieldType = ftTimeStamp
  ...
  object dsLkpTowns: TPgDataSource
    DataSet = qryLkpTowns
    Left = 192
    Top = 376
  end
  object qryLkpTowns: TPgQuery
