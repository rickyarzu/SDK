unit Janua.DMVC.WebModulePhoenixReport;
...
type
  TDMVCPhoenixReport = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TDMVCPhoenixReport;
...
procedure TDMVCPhoenixReport.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TPhoenixReportController);
...
procedure TDMVCPhoenixReport.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
