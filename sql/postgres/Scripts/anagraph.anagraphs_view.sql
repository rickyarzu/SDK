...
CREATE OR REPLACE VIEW anagraph.anagraphs_view
 ...
 SELECT a.db_schema_id,
   ...
   FROM anagraph.anagraphs a
     ...
     LEFT OUTER JOIN anagraph.branches s ON s.anagraph_id = a.anagraph_id AND s.an_branch_id = 2
     LEFT OUTER JOIN anagraph.branches b ON s.anagraph_id = a.anagraph_id AND s.an_branch_id = 1;
