...
'AREQUIPA', 'BAR SIMONE', 3,0,3,0
'BIG MAG', 'PADEL SPORTING CUNEO', 0,3,0,3
'FISSOLOGRU PADEL TEAM', 'BUGIA NEN', 0,3,0,3
'OFFICINA DEL PADEL TEAM', 'LOS CHICHARITOS', 0,3,0,3
'DODICICENTO', 'GLI ULTIMI', 3,0,3,0
'PADEL VIS CUNEO', 'I RAGAZZI DELLA III B', 0,3,0,3
'LA MA.GI.CA', 'SPADELLATORI BRUTTI', 0,3,0,3
'ATLETICO BANDEJA', 'FC PAMPERS', 0,3,0,3
'SUMA PADEL TOR' 'AS. INTOMATICI', 0,3,0,3
*/

INSERT INTO sports.matches_VIEW --1
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'AREQUIPA', 'BAR PEANO', 0,3,0,3
FROM sports.calendar_view WHERE match_day_number = 3

INSERT INTO sports.matches_VIEW --2
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'BIG MAG', 'PADEL SPORTING CUNEO', 3,0,3,0
FROM sports.calendar_view WHERE match_day_number = 3

INSERT INTO sports.matches_VIEW --3
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'FISSOLOGRU PADEL TEAM', 'BUGIA NEN', 2,1,2,1
FROM sports.calendar_view WHERE match_day_number = 3

INSERT INTO sports.matches_VIEW --4
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'OFFICINA DEL PADEL TEAM', 'LOS CHICHARITOS', 1,2,1,2
FROM sports.calendar_view WHERE match_day_number = 3

INSERT INTO sports.matches_VIEW --5
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'DODICICENTO', 'GLI ULTIMI', 3,0,3,0
FROM sports.calendar_view WHERE match_day_number = 3

INSERT INTO sports.matches_VIEW --6
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'PADEL VIS CUNEO', 'I RAGAZZI DELLA III B', 1,2,1,2
FROM sports.calendar_view WHERE match_day_number = 3

INSERT INTO sports.matches_VIEW --7
(league_id, season_id, match_day_number, home_team_name, visitors_team_name, score_home, score_visitor, points_home, points_visitors)
select league_id, season_id, match_day_number, 'LA MA.GI.CA', 'SPADELLATORI BRUTTI', 0,3,0,3
FROM sports.calendar_view WHERE match_day_number = 3
