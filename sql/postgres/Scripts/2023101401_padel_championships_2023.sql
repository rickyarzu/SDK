...
VALUES ('GIRONE PAROLA SPORT',      1,        	   20,  	   'GLB',    false);
	
INSERT INTO sports.leagues(
		 league_name, country_id, league_position, league_code, all_players)
VALUES ( 'GIRONE GINO BMW MINI',      1,        	   20,  	   'GLB',  false);
	
INSERT INTO sports.leagues(
		 league_name, country_id, league_position, league_code, all_players)
VALUES ( 'GIRONE LAB TRAVEL',      1,        	   20,  	   'GLB',   false);
	
INSERT INTO sports.leagues(
		 league_name, country_id, league_position, league_code, 	all_players)
VALUES ( 'GIRONE CISL',       1,        	   20,  	   'GLB',    	   false);
