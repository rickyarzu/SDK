...
DROP TRIGGER shipments_view_ioi ON logistic.shipments_view;

CREATE TRIGGER shipments_view_ioi
    INSTEAD OF INSERT
    ON logistic.shipments_view
    FOR EACH ROW
    EXECUTE PROCEDURE logistic.shipments_view_ioi_trg();

COMMENT ON TRIGGER shipments_view_ioi ON logistic.shipments_view
