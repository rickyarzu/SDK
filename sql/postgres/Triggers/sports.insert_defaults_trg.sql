-- FUNCTION: sports.insert_defaults_trg()

-- DROP FUNCTION IF EXISTS sports.insert_defaults_trg();

CREATE OR REPLACE FUNCTION sports.insert_defaults_trg()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION sports.insert_defaults_trg()
    OWNER TO ergo;
