...
INSERT INTO carservice.booking_heads(
	id, office_id, branch_id , jguid, db_schema_id, user_insert, insert_date, customer_id, state_id, driver_id)
	VALUES (new.id, new.office_id /*ufficio o sede contabile*/, new.branch_id /*location di riferimento service*/,  new.jguid, new.db_schema_id, new.user_insert, 
			 new.insert_date, new.customer_id /*identificativo dell'utente del servizio */, NEW.state_id, NEW.driver_id);
