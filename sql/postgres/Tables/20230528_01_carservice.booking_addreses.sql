...
(
    ...
    -- Inherited from table anagraph.addresses: country_code character(2) COLLATE pg_catalog."default",
    -- Inherited from table anagraph.addresses: email character varying(128) COLLATE pg_catalog."default",
    ad_type "char" DEFAULT 'P'::"char",
    booking_id bigint,
	booking_jguid uuid NOT NULL,
    ...
    INHERITS (anagraph.an_addresses)
WITH (
    OIDS = FALSE
)
...
COMMENT ON COLUMN carservice.booking_addresses.booking_jguid
    IS 'Foreign Key to Booking Table using jguid instead of bigint ID';
