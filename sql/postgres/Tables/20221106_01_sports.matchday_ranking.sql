...
(
	...
	points_outside smallint NOT NULL DEFAULT 0,

	scored smallint NOT NULL DEFAULT 0,
    scored_home smallint NOT NULL DEFAULT 0,
	scored_outside smallint NOT NULL DEFAULT 0,
	
    conceded smallint NOT NULL DEFAULT 0,
	conceded_home smallint NOT NULL DEFAULT 0,
	conceded_outside smallint NOT NULL DEFAULT 0,
	
    aggregate_points smallint NOT NULL DEFAULT 0,
	aggregate_group smallint NOT NULL DEFAULT 0,
