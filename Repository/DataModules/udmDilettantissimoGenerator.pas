unit udmDilettantissimoGenerator;
...
uses Janua.Dilettantissimo.Impl, Janua.Dilettantissimo.Intf, Janua.Football.Web.Intf;
...
begin
  ...
  try
    SetupDM(ma, ar);
    avi := DMCms.GetArticlesList(aMainCategory, aCategory, aLimit, aPage, True);
    art := DMCms.GetArticlesList(aMainCategory, aCategory, aLimit, aPage, False);
